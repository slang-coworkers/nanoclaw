...
vi.mock('@clack/prompts', () => ({
  ...
  // The fork's spinner wrapper exposes error() where upstream calls stop(msg, 1).
...
beforeEach(() => {
  ...
  vi.stubEnv(
    'NANOCLAW_SKIP',
    'environment,container,onecli,mounts,service,cli-agent,timezone,channel,verify,first-chat,projects',
  );

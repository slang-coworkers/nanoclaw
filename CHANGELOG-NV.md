...
### nv-main (3 PRs)
- **#1646** `fix: stop group-init destroying a template's own skills`
- **#1683** `fix(astra): make the astra-sandbox ferry driver deliver replies`
- **#1684** `style(astra): prettier-format astra-sandbox-driver`

### nv-dashboard (1 PRs)
- **#1675** `Sync nv-dashboard with upstream/main`

### nv-slang (1 PRs)
- **#1676** `Sync nv-slang with upstream/main`

### nv-slangpy (1 PRs)
- **#1677** `Sync nv-slangpy with upstream/main`

### nv-nanoclaw (1 PRs)
- **#1678** `Sync nv-nanoclaw with upstream/main`
...
### nv-main (1 PRs)
- **#1648** `Sync nv-main with upstream/main`

### nv-dashboard (1 PRs)
- **#1650** `Sync nv-dashboard with upstream/main`

### nv-slang (1 PRs)
- **#1651** `Sync nv-slang with upstream/main`

### nv-slangpy (1 PRs)
- **#1652** `Sync nv-slangpy with upstream/main`

### nv-nanoclaw (1 PRs)
- **#1653** `Sync nv-nanoclaw with upstream/main`

## 📅 2026-09-17

### nv-main (2 PRs)
- **#1633** `Sync nv-main with upstream/main 6e5008fee (2026-09-17)`
- **#1642** `port: drive host-sweep through the reconcile workqueue (779 → 208 lines)`

### nv-dashboard (1 PRs)
- **#1635** `Sync nv-dashboard with upstream/main`

### nv-slang (1 PRs)
- **#1636** `Sync nv-slang with upstream/main`

### nv-slangpy (1 PRs)
- **#1637** `Sync nv-slangpy with upstream/main`

### nv-nanoclaw (1 PRs)
- **#1638** `Sync nv-nanoclaw with upstream/main`
...
### nv-main (3 PRs)
- **#1602** `Sync nv-main with upstream/main (f5967d3c4)`
- **#1603** `Sync nv-main with upstream/main`
- **#1604** `Sync nv-main with upstream/main`

### nv-dashboard (1 PRs)
- **#1588** `Sync nv-dashboard with upstream/main`

### nv-slang (1 PRs)
- **#1589** `Sync nv-slang with upstream/main`

### nv-slangpy (1 PRs)
- **#1590** `Sync nv-slangpy with upstream/main`

### nv-nanoclaw (1 PRs)
- **#1591** `Sync nv-nanoclaw with upstream/main`

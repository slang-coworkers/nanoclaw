...
| [docs/mcp-allowlist.md](docs/mcp-allowlist.md) | MCP tool allow-list: the four policy states, the mandatory transport floor, the six enforcement points, and why a policy change restarts the whole agent group |

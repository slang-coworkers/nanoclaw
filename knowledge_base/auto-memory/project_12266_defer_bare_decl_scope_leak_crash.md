...
- **Chain state:** HELD on maintainer convergence (csyonghe ↔ skiminki-nv on language intent). No blocker on our side; fix effort small either way. Issue verdict comment `5121153624` held as-is (PR non-draft = live public artifact carrying discussion); refresh at merge or once direction settles. RESUME on: maintainer semantics convergence / merge / fresh substantive comment / Reviewer A verdict. Canonical thread `gh-issue-shader-slang/slang-12266`. Family: [[feedback_dont_close_open_proposals]].

...
- **Open:** maintainer owns merge; approver stamps human verdict against the `5918fba3` row on a REAL merge/review-join (verifying vs live GitHub first, per the b8f1c2a0 lesson). merged→APPROVED agreement; closed-unmerged→false-safe.

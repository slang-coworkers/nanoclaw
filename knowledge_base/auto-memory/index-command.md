...
- [[command_gh_api_slurp_excludes_jq]] — "`gh api --slurp` is MUTUALLY EXCLUSIVE with --jq/--template — exits 1, empty stdout, client-side (no network). Present in every gh v2.53→v2.96."

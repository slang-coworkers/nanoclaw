...
**Status:** draft PR #12217 OPEN, review dispatched to slang-reviewer (fixer owns PR + review relay); verdict pending. Maintainer jkwak-work requested the PR ("@nv-slang-bot, make a PR" 14:15Z) — satisfied by #12217; issue verdict comment refreshed (comment 5071382226). **Next human action: review #12217, flip ready + merge — OPERATOR/maintainer-gated.**

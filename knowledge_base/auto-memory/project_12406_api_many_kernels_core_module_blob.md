...
Unit/verification lessons this chain generated: [[feedback_a_ratio_column_that_mixes_mib_and_mb]] (folded into the shared learning by me, since `/workspace/shared/` is `ro` on coworker mounts). Instrument context: [[technique_compile_perf_three_platforms_and_v_staleness]].

...
- [Approver: gh auth status reports token invalid but gh api/gh pr view reads still work](../learnings/1789462002423-gh-auth-status-invalid-token-is-a-false-alarm-for-.md)

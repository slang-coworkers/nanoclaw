...
The "IGNORED is safe on no-GPU CI" rule presumes the name already passed gate 1. For a slang test that depends on a new slang-rhi feature, the test file and the submodule pin bump are HARD-coupled — they must travel together. Verified on shader-slang/slang#11792 (abort/`shader-abort`, slang-rhi#782) ([[wiki/learnings/1782564838123-render-test-render-features-is-a-two-stage-gate-un.md]]).

---
**Source learnings (13):**
- [[wiki/learnings/1780353662163-slang-diagnostics-catalog-doc-section-digest-gap-v.md]] — slang diagnostics-catalog doc_section_digest gap; verify peer repo-state claims
- [[wiki/learnings/1780733925284-reviewer-disagreement-match-canonical-precedent-vs.md]] — Reviewer disagreement: match canonical precedent vs precedent is wrong
- [[wiki/learnings/1781223729779-routing-a-decl-through-shared-declarator-machinery.md]] — Routing a decl through shared declarator machinery broadens accepted grammar
- [[wiki/learnings/1781607246297-gpu-is-available-nvidia-l40s-don-t-assume-no-gpu-t.md]] — GPU is available (NVIDIA L40S) — don't assume no GPU
- [[wiki/learnings/1781627346796-slang-pr-review-cross-check-reviewer-c-clarity-fin.md]] — slang-pr-review: cross-check Reviewer C clarity findings before forwarding
- [[wiki/learnings/1782151905566-slang-rich-diagnostic-renderer-is-tty-color-gated-.md]] — Slang rich diagnostic renderer is tty/color-gated
...
- [[wiki/learnings/1782225149459-vk-location-on-non-varying-warning-6216-the-param-.md]] — vk::location-on-non-varying warning #6216: param-binding gate placement
- [[wiki/learnings/1782318227042-validate-slang-test-gate-if-fixes-confirm-the-macr.md]] — Validate slang test-gate #if fixes: confirm the macro is a compile-define
- [[wiki/learnings/1782442658975-slang-store-family-which-surface-syntax-hits-atomi.md]] — Slang store-family: which surface syntax hits AtomicStore/MatrixSwizzleStore
- [[wiki/learnings/1782478960515-slang-11779-precompilation-is-gated-by-isfinalcode.md]] — slang #11779: precompilation IS gated by isFinalCodegenLink
- [[wiki/learnings/1782564838123-render-test-render-features-is-a-two-stage-gate-un.md]] — render-test -render-features is a two-stage gate
- [[wiki/learnings/1780986083496-supervisor-artifact-enforcement-nudge-yields-to-th.md]] — Supervisor artifact-enforcement nudge yields to operator comment-gate

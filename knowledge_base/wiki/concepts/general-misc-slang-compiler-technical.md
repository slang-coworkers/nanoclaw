...
- [[wiki/learnings/1780769595819-approach-a-fix-for-descriptor-heap-noinline-textur.md]] — Approach-A fix for descriptor-heap [noinline] texture params
- [[wiki/learnings/1781219589907-resourcedescriptorheap-samplerdescriptorheap-input.md]] — ResourceDescriptorHeap/SamplerDescriptorHeap input syntax is front-end-only
- [[wiki/learnings/1782751325517-e31106-e31107-also-fire-on-the-synthesized-entry-p.md]] — E31106/E31107 also fire on the SYNTHESIZED entry-point uniform param group
- [[wiki/learnings/1781841056611-controlled-rebase-experiments-mislead-when-the-iso.md]] — Controlled-rebase experiments mislead when the isolated change is cross-cutting
...
- [[wiki/learnings/1781116005493-correction-test-lang-server-harness-can-t-observe-.md]] — CORRECTION: LANG_SERVER harness can't observe diagnostics in test mode
- [[wiki/learnings/1782448931140-uninit-checker-storing-an-address-isn-t-a-read-and.md]] — Uninit-checker: storing an address isn't a read
- [[wiki/learnings/1782324227290-converting-presence-value-macro-tests-can-silently.md]] — Converting presence→value macro tests can silently narrow platform coverage

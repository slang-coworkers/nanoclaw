...
A number written *about* other data goes stale the moment that data is corrected, and nothing flags it. Three instances in one session [A DERIVED FIGURE OUTLIVES THE CORRECTION OF ITS INPUTS — three instances in one session; compute at render, or drop the number and keep the qualitative claim](../learnings/1786042159569-a-derived-figure-outlives-the-correction-of-its-in.md):

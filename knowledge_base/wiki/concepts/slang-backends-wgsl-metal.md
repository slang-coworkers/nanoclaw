...
- [Coverage wave-aggregate tests — CUDA/Metal FileCheck asserting `WaveActiveCountBits` passes for the wrong reason](wiki/learnings/1780935575501-coverage-wave-aggregate-tests-cuda-metal-filecheck.md)

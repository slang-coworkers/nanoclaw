...
- [Triaging external-dependency tracking issues](wiki/learnings/1782449664675-triaging-external-dependency-tracking-issues-verif.md)
- [In maintainer design discussions, the bot should be reticent](wiki/learnings/1782480236370-in-maintainer-design-discussions-the-bot-should-be.md)
- [Latent adjacent defect found by code-reading: don't file a speculative tracking issue](wiki/learnings/1782156945737-latent-adjacent-defect-found-by-code-reading-don-t.md)

...
- [any slangc help-text edit must regenerate command-line-slangc-reference.md or CI fails](wiki/learnings/1784827777508-slangc-help-text-edits-require-regenerating-comman.md)
...
- [-dump-ir emits nothing unless slangc runs the backend — a filecheck test needs -o /dev/null or -entry/-stage](wiki/learnings/1785554892234-dump-ir-emits-nothing-unless-slangc-runs-the-backe.md)

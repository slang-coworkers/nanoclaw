...
The `4000` in a first-attempt error is not the budget — one investigator burned ~6 rounds of iterative trimming (2299 → 2233 → … → 2000) assuming the Nitro/bot ceiling. Two attempts can even return *two different limits under the same error code 50035* (4000 then 2000). Treat 2000 as the hard cap and split accordingly. See [discord_send_message caps content at 2000 chars, not 4000](wiki/learnings/1786006619395-discord-send-message-caps-content-at-2000-chars-no.md) and [Discord message limit is 2000 chars, not 4000 — the API error message lies on the first try](wiki/learnings/1786006634390-discord-message-limit-is-2000-chars-not-4000-the-a.md).

...
For symbol questions generally, **use the exact mangled name, never a loose regex** ([reading Mach-O exports with no Apple tooling; the demangle traps](wiki/learnings/1785991525886-reading-mach-o-exports-with-no-apple-tooling-two-i.md)).

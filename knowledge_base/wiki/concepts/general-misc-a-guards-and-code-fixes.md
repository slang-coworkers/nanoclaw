...
*exported* `glslang_disassembleSPIRV`. [A contract you ADD to an interface binds the implementations you did not touch](../learnings/1785934768237-a-contract-you-add-to-an-interface-binds-the-imple.md)
...
whole discipline.** [A mutation-based argument needs the mutation ATTEMPTED — and a green test run doesn't mean the binary has your edit](../learnings/1785940218212-a-mutation-based-argument-needs-the-mutation-attem.md)
...
the arithmetic is what separates them. [Use the failing assertion's arithmetic to pick between competing race explanations](../learnings/1785891610827-use-the-failing-assertion-s-arithmetic-to-pick-bet.md)
...
the assertion. [A guard can only see its own output file — check whether the work survives before accepting "re-run"](../learnings/1785939007641-a-guard-can-only-see-its-own-output-file-check-whe.md)
...
shrug. [Vulkan spec `undefined:` macro does NOT discriminate undefined-contents from undefined-behavior](../learnings/1785936587760-vulkan-spec-undefined-macro-does-not-discriminate-.md)
...
*fine*. [detector self-check: ls -1t returns the generated INDEX.md, not your newest learning](../learnings/1785872011901-detector-self-check-ls-1t-returns-the-generated-in.md)
...
handoff memo, not just the blocker. [Recall scoped to the task's subject can never surface a tooling limit — run a second cheap query keyed on your environment](../learnings/1785863868529-recall-scoped-to-the-task-s-subject-can-never-surf.md)

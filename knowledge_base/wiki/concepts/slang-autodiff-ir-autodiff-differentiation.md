...
- [slang autodiff: derivative variant purity check must accept [PreferRecompute]](../learnings/1780312221839-slang-autodiff-derivative-variant-purity-check-mus.md)
...
- [Use-site [require] propagation is AST-only, so misses transitive differentiation (#11872 review gap)](../learnings/1782882850345-slang-use-site-propagation-of-user-defined-derivat.md)

...
The single most repeated failure in this corpus: a probe returns a clean result, the author reads it as a verdict about the world, and the probe never actually addressed the question. **A passing control proves the instrument fired; it does not prove the query encoded the question.** Two tiers both choosing the same aperture is *not* two independent measurements [CORRECTION — the dedup miss was the in:body QUALIFIER, not vocabulary; drop in:body, and flip the qualifier before rewriting words](wiki/learnings/1786051343939-correction-the-dedup-miss-was-the-in-body-qualifie.md).

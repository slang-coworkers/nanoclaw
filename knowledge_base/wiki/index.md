...
Standalone wiki built from **2208 agent learnings**, synthesized into **47 concept pages**.
...
- [Slang compiler & language](topics/slang-compiler.md) (1013)
- [NanoClaw / agent operations](topics/agent-ops.md) (321)
- [CI, build & tooling](topics/ci-tooling.md) (215)
- [Review & process](topics/review-process.md) (146)
- [Uncategorized](topics/misc.md) (513)
...
- [Surface-and-defer on maintainer design forks: never merge an intermediate approach; a docs-vs-compiler triage call can be right even after a long compiler detour](learnings/1785469148746-surface-and-defer-on-maintainer-design-forks-never.md)

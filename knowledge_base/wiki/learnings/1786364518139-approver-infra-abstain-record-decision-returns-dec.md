---
title: "[approver/infra-abstain] record_decision returns 'Decision recorded' even when the host denies the ledger append — verify, don't trust the string"
type: learning
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786364518139-approver-infra-abstain-record-decision-returns-dec.md`_

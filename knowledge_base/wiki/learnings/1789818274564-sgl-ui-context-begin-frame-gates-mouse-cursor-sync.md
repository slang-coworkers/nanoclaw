---
title: "SGL ui::Context::begin_frame gates mouse-cursor sync on a non-null window arg"
type: learning
topic: agent-ops
source: learnings/1789818274564-sgl-ui-context-begin-frame-gates-mouse-cursor-sync.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789818274564-sgl-ui-context-begin-frame-gates-mouse-cursor-sync.md`_

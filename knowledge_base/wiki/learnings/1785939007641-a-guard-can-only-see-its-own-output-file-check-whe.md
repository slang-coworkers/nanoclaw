---
title: "A guard can only see its own output file — check whether the work survives before accepting 're-run'"
type: learning
topic: misc
source: learnings/1785939007641-a-guard-can-only-see-its-own-output-file-check-whe.md
---

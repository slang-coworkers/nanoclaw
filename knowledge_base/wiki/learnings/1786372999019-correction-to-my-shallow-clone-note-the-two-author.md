---
title: "CORRECTION to my shallow-clone note: the two author names are two FIELDS of one API response, not .mailmap — and the defect was edge-local, not universal"
type: learning
topic: verification
source: learnings/1786372999019-correction-to-my-shallow-clone-note-the-two-author.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1786372999019-correction-to-my-shallow-clone-note-the-two-author.md`_

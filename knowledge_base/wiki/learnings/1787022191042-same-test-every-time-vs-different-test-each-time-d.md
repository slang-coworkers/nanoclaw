---
title: "Same-test-every-time vs different-test-each-time distinguishes a new regression from a tracked xdist flake"
type: learning
topic: ci-tooling
source: learnings/1787022191042-same-test-every-time-vs-different-test-each-time-d.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1787022191042-same-test-every-time-vs-different-test-each-time-d.md`_

---
title: "SlangPy CPU dispatch: zero DeviceLimits + stale local checkout + pytest device classification"
type: learning
topic: slang-compiler
source: learnings/1788480806317-slangpy-cpu-dispatch-zero-devicelimits-stale-local.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788480806317-slangpy-cpu-dispatch-zero-devicelimits-stale-local.md`_

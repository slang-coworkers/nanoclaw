---
title: "[approver/clause-gap] ci_green_on_sha folds commits/SHA/status — GREEN over the wrong object set; every compiled build is a check-run it cannot see"
type: learning
topic: ci-tooling
source: learnings/1786437258677-approver-clause-gap-ci-green-on-sha-folds-commits-.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1786437258677-approver-clause-gap-ci-green-on-sha-folds-commits-.md`_

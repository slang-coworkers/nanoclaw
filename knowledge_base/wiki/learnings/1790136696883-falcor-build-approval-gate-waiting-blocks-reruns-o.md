---
title: "falcor-build-approval-gate WAITING blocks reruns of ANY job in the same run, not just itself"
type: learning
topic: agent-ops
source: learnings/1790136696883-falcor-build-approval-gate-waiting-blocks-reruns-o.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1790136696883-falcor-build-approval-gate-waiting-blocks-reruns-o.md`_

---
title: "A dark agent group is not a down agent group — disambiguate idle from broken with a sibling's outbound"
type: learning
topic: misc
source: learnings/1787117195283-a-dark-agent-group-is-not-a-down-agent-group-disam.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787117195283-a-dark-agent-group-is-not-a-down-agent-group-disam.md`_

---
title: "[approver/clause-gap] tier_eligible counts test churn — addressing a 'add a test' nit can push a PR OVER the size cap"
type: learning
topic: review-approval
source: learnings/1786480040703-approver-clause-gap-tier-eligible-counts-test-chur.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786480040703-approver-clause-gap-tier-eligible-counts-test-chur.md`_

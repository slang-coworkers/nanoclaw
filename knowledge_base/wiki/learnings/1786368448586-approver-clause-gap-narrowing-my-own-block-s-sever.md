---
title: "[approver/clause-gap] Narrowing my own BLOCK's severity: the version-shadowing defect cannot reach PyPI — the override is computed only under build_type=='nightly', so the blast radius is Artifactory dev wheels only, and the two defects are not severity-ranked as claimed"
type: learning
topic: review-approval
source: learnings/1786368448586-approver-clause-gap-narrowing-my-own-block-s-sever.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786368448586-approver-clause-gap-narrowing-my-own-block-s-sever.md`_

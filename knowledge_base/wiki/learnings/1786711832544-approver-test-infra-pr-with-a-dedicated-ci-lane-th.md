---
title: "[approver] test-infra PR with a dedicated CI lane that builds+runs the new target = discriminating control for WOULD_APPROVE"
type: learning
topic: ci-tooling
source: learnings/1786711832544-approver-test-infra-pr-with-a-dedicated-ci-lane-th.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1786711832544-approver-test-infra-pr-with-a-dedicated-ci-lane-th.md`_

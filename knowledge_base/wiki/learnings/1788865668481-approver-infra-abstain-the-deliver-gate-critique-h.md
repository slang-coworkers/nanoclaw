---
title: "[approver/infra-abstain] The deliver-gate critique hook is separate from the skill's 'abstain isn't critique-gated' relaxation — an armed gate still demands DECISION_REVIEW+OUTPUT_REVIEW even for ABSTAIN_POLICY; a bypass request can be admin-rejected, so just run /codex-critique"
type: learning
topic: agent-ops
source: learnings/1788865668481-approver-infra-abstain-the-deliver-gate-critique-h.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1788865668481-approver-infra-abstain-the-deliver-gate-critique-h.md`_

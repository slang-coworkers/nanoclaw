---
title: "Bindless -vk tests need -emit-spirv-directly (via-glsl CI leg)"
type: learning
topic: slang-compiler
source: learnings/1788440528410-bindless-vk-tests-need-emit-spirv-directly-via-gls.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788440528410-bindless-vk-tests-need-emit-spirv-directly-via-gls.md`_

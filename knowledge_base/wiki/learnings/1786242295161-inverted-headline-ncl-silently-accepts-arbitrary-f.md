---
title: "INVERTED HEADLINE: `ncl` silently accepts arbitrary flag names on nearly every verb and returns FULL data — `tasks list` is the lone validating exception"
type: learning
topic: agent-ops
source: learnings/1786242295161-inverted-headline-ncl-silently-accepts-arbitrary-f.md
---

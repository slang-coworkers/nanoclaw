---
title: "A build failure in a shared clone is not evidence about your patch — read the undefined symbol and ask which file generates it"
type: learning
topic: ci-tooling
source: learnings/1786041592085-a-build-failure-in-a-shared-clone-is-not-evidence-.md
---
...
---
_Topic: [CI, build & tooling](wiki/topics/ci-tooling.md) · [catalog](wiki/index.md) · source: `sources/learnings/1786041592085-a-build-failure-in-a-shared-clone-is-not-evidence-.md`_

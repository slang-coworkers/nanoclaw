---
title: "[approver/human-disagreement] A human review's commit_id is stamped to the PR head at review-processing time — it can point at a merge commit whose committedDate is seconds AFTER the approval timestamp; join to that head, and treat a merge-only re-wake as a content no-op"
type: learning
topic: review-approval
source: learnings/1788780992990-approver-human-disagreement-a-human-review-s-commi.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788780992990-approver-human-disagreement-a-human-review-s-commi.md`_

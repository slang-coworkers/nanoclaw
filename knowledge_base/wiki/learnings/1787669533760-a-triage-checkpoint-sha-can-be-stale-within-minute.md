---
title: "A triage checkpoint SHA can be stale within minutes on an active draft PR — diff checkpoint→head before fixing"
type: learning
topic: agent-ops
source: learnings/1787669533760-a-triage-checkpoint-sha-can-be-stale-within-minute.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787669533760-a-triage-checkpoint-sha-can-be-stale-within-minute.md`_

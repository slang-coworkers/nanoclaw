---
title: "[approver/clause-gap] A PR can resolve every code concern yet stay un-approvable on the size cap — 3× ABSTAIN with the reason migrating each revision"
type: learning
topic: review-approval
source: learnings/1788155800246-approver-clause-gap-a-pr-can-resolve-every-code-co.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788155800246-approver-clause-gap-a-pr-can-resolve-every-code-co.md`_

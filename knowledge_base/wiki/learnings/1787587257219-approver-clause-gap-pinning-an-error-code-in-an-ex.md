---
title: "[approver/clause-gap] Pinning an error code in an EXISTING diagnostic test is a slot-replacement, not an addition — verify the swap kept every diagnostic annotated"
type: learning
topic: review-approval
source: learnings/1787587257219-approver-clause-gap-pinning-an-error-code-in-an-ex.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787587257219-approver-clause-gap-pinning-an-error-code-in-an-ex.md`_

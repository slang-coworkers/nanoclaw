---
title: "Tessellation per-patch location numbering is split across two layers (front-end binding + IR glsl-legalize)"
type: learning
topic: slang-compiler
source: learnings/1787676067552-tessellation-per-patch-location-numbering-is-split.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787676067552-tessellation-per-patch-location-numbering-is-split.md`_

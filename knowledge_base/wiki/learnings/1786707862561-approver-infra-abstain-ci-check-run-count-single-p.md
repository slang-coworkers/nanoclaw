---
title: "[approver/infra-abstain] CI check-run count: single-page jq undercounts skips; use --paginate + name every non-success"
type: learning
topic: review-approval
source: learnings/1786707862561-approver-infra-abstain-ci-check-run-count-single-p.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786707862561-approver-infra-abstain-ci-check-run-count-single-p.md`_

---
title: "compile-perf [MEM] protocol is driver-only; target-mode memory attribution is net-new compiler work"
type: learning
topic: slang-compiler
source: learnings/1786631260810-compile-perf-mem-protocol-is-driver-only-target-mo.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786631260810-compile-perf-mem-protocol-is-driver-only-target-mo.md`_

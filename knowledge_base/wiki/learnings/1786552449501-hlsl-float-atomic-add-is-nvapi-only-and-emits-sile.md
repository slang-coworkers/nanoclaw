---
title: "HLSL float atomic-add is NVAPI-only and emits silently; the tensor producer is not the autodiff pass"
type: learning
topic: slang-compiler
source: learnings/1786552449501-hlsl-float-atomic-add-is-nvapi-only-and-emits-sile.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786552449501-hlsl-float-atomic-add-is-nvapi-only-and-emits-sile.md`_

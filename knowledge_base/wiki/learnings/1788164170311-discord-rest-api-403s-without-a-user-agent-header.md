---
title: "Discord REST API 403s without a User-Agent header"
type: learning
topic: misc
source: learnings/1788164170311-discord-rest-api-403s-without-a-user-agent-header.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788164170311-discord-rest-api-403s-without-a-user-agent-header.md`_

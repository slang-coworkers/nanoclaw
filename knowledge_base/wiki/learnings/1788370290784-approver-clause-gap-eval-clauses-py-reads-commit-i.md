---
title: "[approver/clause-gap] eval-clauses.py reads commit_id from review-doc.md — run it AFTER synthesizing the doc"
type: learning
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788370290784-approver-clause-gap-eval-clauses-py-reads-commit-i.md`_

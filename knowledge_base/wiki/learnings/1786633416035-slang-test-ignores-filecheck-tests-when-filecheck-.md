---
title: "slang-test ignores filecheck tests when FileCheck unavailable in worktree builds"
type: learning
topic: slang-compiler
source: learnings/1786633416035-slang-test-ignores-filecheck-tests-when-filecheck-.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786633416035-slang-test-ignores-filecheck-tests-when-filecheck-.md`_

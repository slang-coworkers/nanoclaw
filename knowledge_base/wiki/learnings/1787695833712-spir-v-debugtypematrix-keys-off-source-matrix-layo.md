---
title: "SPIR-V DebugTypeMatrix keys off source matrix-layout modifier (only col-major buffer members wrong)"
type: learning
topic: slang-compiler
source: learnings/1787695833712-spir-v-debugtypematrix-keys-off-source-matrix-layo.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787695833712-spir-v-debugtypematrix-keys-off-source-matrix-layo.md`_

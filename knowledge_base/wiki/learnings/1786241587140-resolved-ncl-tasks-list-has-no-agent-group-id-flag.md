---
title: "RESOLVED: `ncl tasks list` has no --agent-group-id flag (it's --group) — the flag name differs per verb and the wrong one is silently swallowed"
type: learning
topic: agent-ops
source: learnings/1786241587140-resolved-ncl-tasks-list-has-no-agent-group-id-flag.md
---

---
title: "slang-pr-review patch mode drops untracked new files (git commit -am) — Reviewer A false 'no test' gap"
type: learning
...
---
_Topic: [Review & process](../topics/review-process.md) · [catalog](../index.md) · source: `sources/learnings/1789222054102-slang-pr-review-patch-mode-drops-untracked-new-fil.md`_

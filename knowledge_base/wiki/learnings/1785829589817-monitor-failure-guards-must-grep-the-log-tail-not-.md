---
title: "Monitor failure-guards must grep the log TAIL, not the whole file"
type: learning
topic: misc
source: learnings/1785829589817-monitor-failure-guards-must-grep-the-log-tail-not-.md
---

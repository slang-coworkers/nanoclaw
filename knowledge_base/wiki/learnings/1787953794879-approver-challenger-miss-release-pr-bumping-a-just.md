---
title: "[approver/challenger-miss] Release PR bumping a just-published dep tag: check the BUILD CI, not tag existence"
type: learning
topic: ci-tooling
source: learnings/1787953794879-approver-challenger-miss-release-pr-bumping-a-just.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1787953794879-approver-challenger-miss-release-pr-bumping-a-just.md`_

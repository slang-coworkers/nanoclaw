---
title: "[approver/clause-gap] v0-shadow-wide REMOVED .github/** from protected_paths — CI-workflow PRs are now WOULD_APPROVE-eligible; the wiki/recall still surfaces the stale 'protected-path is terminal' framing"
type: learning
topic: review-approval
source: learnings/1786991606872-approver-clause-gap-v0-shadow-wide-removed-github-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786991606872-approver-clause-gap-v0-shadow-wide-removed-github-.md`_

---
title: "gh pulls?head=owner:branch is blind to fork PRs; index head.ref over the full open-PR list instead"
type: learning
topic: agent-ops
source: learnings/1786357027931-gh-pulls-head-owner-branch-is-blind-to-fork-prs-in.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786357027931-gh-pulls-head-owner-branch-is-blind-to-fork-prs-in.md`_

---
title: "printf width-from-operand-size fixes: an UNPINNED float type (half) can be misread as double via an aliased aggregate operand"
type: learning
topic: agent-ops
source: learnings/1788904081233-printf-width-from-operand-size-fixes-an-unpinned-f.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1788904081233-printf-width-from-operand-size-fixes-an-unpinned-f.md`_

---
title: "[approver/infra-abstain] record_decision can print SUCCESS while the host DENIES the ledger append — the two arrive on different channels"
type: learning
topic: review-approval
source: learnings/1786400575644-approver-infra-abstain-record-decision-can-print-s.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786400575644-approver-infra-abstain-record-decision-can-print-s.md`_

---
title: "A grep zero from the wrong pattern will publish the inverse conclusion — trace, don't match"
type: learning
topic: agent-ops
source: learnings/1786195883017-a-grep-zero-from-the-wrong-pattern-will-publish-th.md
---

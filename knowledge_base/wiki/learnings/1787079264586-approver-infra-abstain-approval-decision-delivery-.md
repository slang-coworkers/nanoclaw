---
title: "[approver/infra] ABSTAIN [Approval Decision] delivery is refused if the message text contains the literal tokens WOULD_APPROVE or BLOCK anywhere"
type: learning
topic: review-approval
source: learnings/1787079264586-approver-infra-abstain-approval-decision-delivery-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787079264586-approver-infra-abstain-approval-decision-delivery-.md`_

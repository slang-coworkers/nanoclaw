---
title: "An expired CI job log still has its run artifact — and it can invert your premise"
type: learning
topic: ci-tooling
source: learnings/1786396604746-an-expired-ci-job-log-still-has-its-run-artifact-a.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1786396604746-an-expired-ci-job-log-still-has-its-run-artifact-a.md`_

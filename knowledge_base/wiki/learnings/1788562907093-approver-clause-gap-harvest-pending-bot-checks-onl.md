---
title: "[approver/clause-gap] harvest pending_bot() checks only the pinned head — misses CodeRabbit still pending on the pre-synchronize head"
type: learning
topic: review-approval
source: learnings/1788562907093-approver-clause-gap-harvest-pending-bot-checks-onl.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788562907093-approver-clause-gap-harvest-pending-bot-checks-onl.md`_

---
title: "git stash is per-clone, not per-worktree — a bare pop can take a sibling session's work"
type: learning
topic: agent-ops
source: learnings/1786032094049-git-stash-is-per-clone-not-per-worktree-a-bare-pop.md
---

---
title: "analyzeExtractExistentialType ICE has a producer-side root (isConcreteType lacks a union case), not just the consumer gate"
type: learning
topic: agent-ops
source: learnings/1789325428139-analyzeextractexistentialtype-ice-has-a-producer-s.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789325428139-analyzeextractexistentialtype-ice-has-a-producer-s.md`_

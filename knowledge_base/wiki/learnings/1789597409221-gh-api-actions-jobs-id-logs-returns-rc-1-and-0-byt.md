---
title: "gh api .../actions/jobs/<id>/logs returns RC=1 and 0 bytes without --allow-escape-sequences — greps as 'tests absent'"
type: learning
topic: misc
source: learnings/1789597409221-gh-api-actions-jobs-id-logs-returns-rc-1-and-0-byt.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1789597409221-gh-api-actions-jobs-id-logs-returns-rc-1-and-0-byt.md`_

---
title: "Before fixing a gap on an unmerged PR, re-fetch the LIVE PR head — the author may have already done it"
type: learning
topic: misc
source: learnings/1788212329588-before-fixing-a-gap-on-an-unmerged-pr-re-fetch-the.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788212329588-before-fixing-a-gap-on-an-unmerged-pr-re-fetch-the.md`_

---
title: "[approver/clause-gap] A 'Merge branch main' PR head does not poison path/size clauses — the clause uses base...head (merge-base), so read the PR's own contribution, not last-reviewed-commit...head"
type: learning
topic: review-approval
source: learnings/1787167542059-approver-clause-gap-a-merge-branch-main-pr-head-do.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787167542059-approver-clause-gap-a-merge-branch-main-pr-head-do.md`_

---
title: "Infra-vs-code CI triage: empty steps[] + 404 logs means read check-run annotations"
type: learning
topic: agent-ops
source: learnings/1786055179491-infra-vs-code-ci-triage-empty-steps-404-logs-means.md
---

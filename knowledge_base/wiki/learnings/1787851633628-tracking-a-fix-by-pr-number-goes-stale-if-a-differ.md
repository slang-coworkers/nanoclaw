---
title: "Tracking a fix by PR number goes stale if a different PR closes the issue first"
type: learning
topic: misc
source: learnings/1787851633628-tracking-a-fix-by-pr-number-goes-stale-if-a-differ.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787851633628-tracking-a-fix-by-pr-number-goes-stale-if-a-differ.md`_

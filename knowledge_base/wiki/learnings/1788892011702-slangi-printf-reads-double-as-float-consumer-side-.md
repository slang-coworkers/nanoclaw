---
title: "slangi printf reads double as float — consumer-side variant of the VM operand-width bug family"
type: learning
topic: slang-compiler
source: learnings/1788892011702-slangi-printf-reads-double-as-float-consumer-side-.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788892011702-slangi-printf-reads-double-as-float-consumer-side-.md`_

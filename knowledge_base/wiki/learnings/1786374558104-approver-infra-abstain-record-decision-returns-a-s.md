---
title: "[approver/infra-abstain] record_decision returns a SUCCESS STRING while the host denies the write — APPROVAL_LEDGER_WRITERS unset drops every row"
type: learning
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786374558104-approver-infra-abstain-record-decision-returns-a-s.md`_

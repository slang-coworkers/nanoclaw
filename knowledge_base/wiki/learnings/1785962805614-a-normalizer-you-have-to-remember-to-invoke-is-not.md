---
title: "A normalizer you have to remember to invoke is not a normalizer - here is the script, stop hand-rolling `in` checks"
type: learning
topic: misc
source: learnings/1785962805614-a-normalizer-you-have-to-remember-to-invoke-is-not.md
---

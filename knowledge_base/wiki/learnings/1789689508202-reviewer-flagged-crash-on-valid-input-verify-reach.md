---
title: "Reviewer-flagged 'crash on valid input': verify reachability empirically (past upstream guards) before disclosing"
type: learning
topic: review-process
source: learnings/1789689508202-reviewer-flagged-crash-on-valid-input-verify-reach.md
---
...
---
_Topic: [Review & process](../topics/review-process.md) · [catalog](../index.md) · source: `sources/learnings/1789689508202-reviewer-flagged-crash-on-valid-input-verify-reach.md`_

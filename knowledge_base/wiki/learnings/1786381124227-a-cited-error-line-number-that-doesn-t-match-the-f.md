---
title: "A cited error line number that doesn't match the file is usually a format offset, not a bad citation"
type: learning
topic: ci-tooling
source: learnings/1786381124227-a-cited-error-line-number-that-doesn-t-match-the-f.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1786381124227-a-cited-error-line-number-that-doesn-t-match-the-f.md`_

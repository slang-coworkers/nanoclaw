---
title: "shader-slang/spec has no writable path from the slang-fixer container (no push, no fork, invalid GH_TOKEN)"
type: learning
topic: agent-ops
source: learnings/1787678701018-shader-slang-spec-has-no-writable-path-from-the-sl.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787678701018-shader-slang-spec-has-no-writable-path-from-the-sl.md`_

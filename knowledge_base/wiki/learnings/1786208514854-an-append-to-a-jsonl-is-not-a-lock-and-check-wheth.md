---
title: "An append to a jsonl is not a lock — and check whether both racers are your own config before blaming a host layer"
type: learning
topic: misc
source: learnings/1786208514854-an-append-to-a-jsonl-is-not-a-lock-and-check-wheth.md
---

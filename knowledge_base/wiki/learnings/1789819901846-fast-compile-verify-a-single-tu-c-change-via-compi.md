---
title: "Fast compile-verify a single-TU C++ change via compile_commands.json (no full rebuild)"
type: learning
topic: ci-tooling
source: learnings/1789819901846-fast-compile-verify-a-single-tu-c-change-via-compi.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1789819901846-fast-compile-verify-a-single-tu-c-change-via-compi.md`_

---
title: "[approver/confirmed-safe] CoopVec math-intrinsic overload = lane-wise loop over an existing scalar builtin adds NO new target intrinsic — a stale bot 'unsupported HLSL intrinsic' merge-risk is refuted by the scalar builtin's __target_switch"
type: learning
topic: slang-compiler
source: learnings/1788576772705-approver-confirmed-safe-coopvec-math-intrinsic-ove.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788576772705-approver-confirmed-safe-coopvec-math-intrinsic-ove.md`_

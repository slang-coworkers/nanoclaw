---
title: "Classifier .mjs edits silently drift from the live deployed scheduled task — check ncl tasks get after every fix"
type: learning
topic: agent-ops
source: learnings/1789777475607-classifier-mjs-edits-silently-drift-from-the-live-.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789777475607-classifier-mjs-edits-silently-drift-from-the-live-.md`_

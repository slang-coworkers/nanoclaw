---
title: "slang autodiff: missing-no_diff diagnostic tests use //TEST:SIMPLE(filecheck=CHECK), not //DIAGNOSTIC_TEST"
type: learning
topic: slang-compiler
source: learnings/1780300985125-slang-autodiff-missing-no-diff-diagnostic-tests-us.md
---
...
---
_Topic: [[wiki/topics/slang-compiler.md]] · catalog: [[wiki/index.md]] · source: `sources/learnings/1780300985125-slang-autodiff-missing-no-diff-diagnostic-tests-us.md`_

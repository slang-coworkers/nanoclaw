---
title: "ParseModifiers on a decl whose NAME can be a bareword keyword breaks previously-valid code — use bracket-only ParseSquareBracketAttributes"
type: learning
topic: misc
source: learnings/1787558855449-parsemodifiers-on-a-decl-whose-name-can-be-a-barew.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787558855449-parsemodifiers-on-a-decl-whose-name-can-be-a-barew.md`_

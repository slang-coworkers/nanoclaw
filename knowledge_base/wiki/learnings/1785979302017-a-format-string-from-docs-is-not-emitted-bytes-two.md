---
title: "A format string from docs is not emitted bytes — two prefix false-negatives in one gate"
type: learning
topic: agent-ops
source: learnings/1785979302017-a-format-string-from-docs-is-not-emitted-bytes-two.md
---

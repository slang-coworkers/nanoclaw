---
title: "[approver/clause-gap] ci_green_on_sha FALSE-PASSES on slang-rhi when a trivial status-poster is green while build check-runs are red"
type: learning
topic: ci-tooling
source: learnings/1788374870675-approver-clause-gap-ci-green-on-sha-false-passes-o.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1788374870675-approver-clause-gap-ci-green-on-sha-false-passes-o.md`_

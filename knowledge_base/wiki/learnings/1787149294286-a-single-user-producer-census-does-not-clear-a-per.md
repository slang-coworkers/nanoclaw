---
title: "A single-user-producer census does not clear a per-origin gate"
type: learning
topic: agent-ops
source: learnings/1787149294286-a-single-user-producer-census-does-not-clear-a-per.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787149294286-a-single-user-producer-census-does-not-clear-a-per.md`_

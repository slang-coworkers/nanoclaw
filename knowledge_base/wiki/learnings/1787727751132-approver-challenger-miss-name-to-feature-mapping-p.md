---
title: "[approver/challenger-miss] name-to-feature mapping PRs — verify the RESOLVED feature's GRANULARITY, not just that the name parses"
type: learning
topic: review-approval
source: learnings/1787727751132-approver-challenger-miss-name-to-feature-mapping-p.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787727751132-approver-challenger-miss-name-to-feature-mapping-p.md`_

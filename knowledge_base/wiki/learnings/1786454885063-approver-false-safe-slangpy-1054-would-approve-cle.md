---
title: "[approver/false-safe] slangpy#1054: WOULD_APPROVE cleared a signature layout a human later asked to change — correctness-only procedures are structurally blind to maintainer preference"
type: learning
topic: slang-compiler
source: learnings/1786454885063-approver-false-safe-slangpy-1054-would-approve-cle.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786454885063-approver-false-safe-slangpy-1054-would-approve-cle.md`_

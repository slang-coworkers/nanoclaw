---
title: "gh run rerun has hard age limits — old CI failures on stale PRs cannot be rerun"
type: learning
topic: ci-tooling
source: learnings/1788199935009-gh-run-rerun-has-hard-age-limits-old-ci-failures-o.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1788199935009-gh-run-rerun-has-hard-age-limits-old-ci-failures-o.md`_

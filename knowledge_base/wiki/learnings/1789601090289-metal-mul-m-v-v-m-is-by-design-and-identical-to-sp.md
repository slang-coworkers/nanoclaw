---
title: "Metal mul(M,v)→v*M is by-design and identical to SPIR-V — not the cause of Metal-only transposes"
type: learning
topic: slang-compiler
source: learnings/1789601090289-metal-mul-m-v-v-m-is-by-design-and-identical-to-sp.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789601090289-metal-mul-m-v-v-m-is-by-design-and-identical-to-sp.md`_

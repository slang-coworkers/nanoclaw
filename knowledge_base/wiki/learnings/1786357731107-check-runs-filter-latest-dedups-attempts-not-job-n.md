---
title: "check-runs filter=latest dedups ATTEMPTS, not job NAMES — it and newest-per-workflow dedup fix different defects, use both"
type: learning
topic: misc
source: learnings/1786357731107-check-runs-filter-latest-dedups-attempts-not-job-n.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786357731107-check-runs-filter-latest-dedups-attempts-not-job-n.md`_

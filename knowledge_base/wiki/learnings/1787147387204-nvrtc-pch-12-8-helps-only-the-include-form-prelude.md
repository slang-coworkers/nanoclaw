---
title: "NVRTC -pch (12.8+) helps only the #include-form prelude, not raw-prepended text; default heap is 256MB; one-shot is a regression"
type: learning
topic: agent-ops
source: learnings/1787147387204-nvrtc-pch-12-8-helps-only-the-include-form-prelude.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787147387204-nvrtc-pch-12-8-helps-only-the-include-form-prelude.md`_

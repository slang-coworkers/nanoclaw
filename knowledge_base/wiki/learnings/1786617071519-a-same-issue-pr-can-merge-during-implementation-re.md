---
title: "A same-issue PR can merge DURING implementation — re-fetch origin/master before opening the PR"
type: learning
topic: misc
source: learnings/1786617071519-a-same-issue-pr-can-merge-during-implementation-re.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786617071519-a-same-issue-pr-can-merge-during-implementation-re.md`_

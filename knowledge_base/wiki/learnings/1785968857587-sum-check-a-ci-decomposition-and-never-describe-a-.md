---
title: "Sum-check a CI decomposition, and never describe a sparse build matrix as a cross-product"
type: learning
topic: ci-tooling
source: learnings/1785968857587-sum-check-a-ci-decomposition-and-never-describe-a-.md
---

---
title: "Falcor bridge-403 confirmation must also check build-artifact age, not just bridge health"
type: learning
topic: ci-tooling
source: learnings/1788589902152-falcor-bridge-403-confirmation-must-also-check-bui.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1788589902152-falcor-bridge-403-confirmation-must-also-check-bui.md`_

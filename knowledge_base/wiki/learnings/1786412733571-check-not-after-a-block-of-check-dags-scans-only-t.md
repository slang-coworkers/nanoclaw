---
title: "CHECK-NOT after a block of CHECK-DAGs scans only the tail of the output — put negative assertions in their own prefix and pass"
type: learning
topic: misc
source: learnings/1786412733571-check-not-after-a-block-of-check-dags-scans-only-t.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786412733571-check-not-after-a-block-of-check-dags-scans-only-t.md`_

---
title: "Correction: use gh pr diff --name-status for file statuses (my deleted-branch-404 cause was wrong)"
type: learning
topic: verification
source: learnings/1787229827637-correction-use-gh-pr-diff-name-status-for-file-sta.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1787229827637-correction-use-gh-pr-diff-name-status-for-file-sta.md`_

---
title: "Delivery-gate + codex-attestation mechanics that block GitHub review replies"
type: learning
topic: agent-ops
source: learnings/1786490307277-delivery-gate-codex-attestation-mechanics-that-blo.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786490307277-delivery-gate-codex-attestation-mechanics-that-blo.md`_

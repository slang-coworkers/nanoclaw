---
title: "[approver/challenger-calibration] A DEFENSIBLE deferral of a hard-to-fix gap is still an OPEN_GAP — 'the naive fix would regress, so they tracked it' explains WHY it's unfixed, not that it's cleared"
type: learning
topic: review-approval
source: learnings/1787628734415-approver-challenger-calibration-a-defensible-defer.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787628734415-approver-challenger-calibration-a-defensible-defer.md`_

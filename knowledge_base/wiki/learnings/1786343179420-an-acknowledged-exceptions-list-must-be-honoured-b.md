---
title: "An acknowledged-exceptions list must be honoured by the gate that BLOCKS, not just the one that REPORTS"
type: learning
topic: agent-ops
source: learnings/1786343179420-an-acknowledged-exceptions-list-must-be-honoured-b.md
---

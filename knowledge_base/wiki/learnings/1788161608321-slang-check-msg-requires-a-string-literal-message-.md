---
title: "SLANG_CHECK_MSG requires a string-literal message — use addResultWithLocation for a dynamic one"
type: learning
topic: slang-compiler
source: learnings/1788161608321-slang-check-msg-requires-a-string-literal-message-.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788161608321-slang-check-msg-requires-a-string-literal-message-.md`_

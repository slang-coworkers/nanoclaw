---
title: "Singleton-designed class with no-op refcount LEAKS if heap-allocated (NULLFileSystem #12865)"
type: learning
topic: misc
source: learnings/1788257348928-singleton-designed-class-with-no-op-refcount-leaks.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788257348928-singleton-designed-class-with-no-op-refcount-leaks.md`_

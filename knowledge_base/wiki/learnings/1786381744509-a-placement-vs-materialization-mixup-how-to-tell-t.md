---
title: "A placement-vs-materialization mixup: how to tell 'the data is in the wrong memory space' from 'a per-thread copy of it survived'"
type: learning
topic: misc
source: learnings/1786381744509-a-placement-vs-materialization-mixup-how-to-tell-t.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786381744509-a-placement-vs-materialization-mixup-how-to-tell-t.md`_

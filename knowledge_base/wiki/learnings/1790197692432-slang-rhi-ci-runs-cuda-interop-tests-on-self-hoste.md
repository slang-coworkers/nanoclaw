---
title: "slang-rhi CI runs CUDA interop tests on self-hosted GPU runners — read the per-test line, not the 'GitHub-hosted skips' summary"
type: learning
topic: ci-tooling
source: learnings/1790197692432-slang-rhi-ci-runs-cuda-interop-tests-on-self-hoste.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1790197692432-slang-rhi-ci-runs-cuda-interop-tests-on-self-hoste.md`_

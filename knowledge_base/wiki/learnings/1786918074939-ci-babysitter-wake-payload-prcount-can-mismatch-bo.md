---
title: "CI babysitter wake payload prCount can mismatch both its own prs array and live gh pr list"
type: learning
topic: ci-tooling
source: learnings/1786918074939-ci-babysitter-wake-payload-prcount-can-mismatch-bo.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1786918074939-ci-babysitter-wake-payload-prcount-can-mismatch-bo.md`_

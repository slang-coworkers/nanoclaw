---
title: "[approver/clause-gap] Large automated branch-sync PRs abstain on tier_eligible — and that is correct, not a gap"
type: learning
topic: review-approval
source: learnings/1787771525975-approver-clause-gap-large-automated-branch-sync-pr.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787771525975-approver-clause-gap-large-automated-branch-sync-pr.md`_

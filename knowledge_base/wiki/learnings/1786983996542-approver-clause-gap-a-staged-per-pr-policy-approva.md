---
title: "[approver/clause-gap] A staged per-PR policy/APPROVAL_POLICY.json overrides the group mount — staging the bundled v0-shadow default silently flips fork PRs to a false head_provenance FAIL"
type: learning
topic: review-approval
source: learnings/1786983996542-approver-clause-gap-a-staged-per-pr-policy-approva.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786983996542-approver-clause-gap-a-staged-per-pr-policy-approva.md`_

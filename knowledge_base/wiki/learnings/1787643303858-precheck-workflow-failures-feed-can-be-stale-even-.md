---
title: "Precheck workflow_failures feed can be stale even when ci_health frame is fresh"
type: learning
topic: ci-tooling
source: learnings/1787643303858-precheck-workflow-failures-feed-can-be-stale-even-.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1787643303858-precheck-workflow-failures-feed-can-be-stale-even-.md`_

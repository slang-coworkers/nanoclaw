---
title: "[approver/challenger] production Claude PR Review is paths-gated to compiler dirs — a PR touching only extras/** legitimately gets zero review run; fallback tier is correct, NOT the 12064 miss"
type: learning
topic: review-approval
source: learnings/1786963629074-approver-challenger-production-claude-pr-review-is.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786963629074-approver-challenger-production-claude-pr-review-is.md`_

---
title: "[approver/confirmed] Main-merge synchronize: re-validate against the new merge base, but don't re-litigate byte-identical PR content — and never approve on pending CI"
type: learning
topic: agent-ops
source: learnings/1787586621701-approver-confirmed-main-merge-synchronize-re-valid.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787586621701-approver-confirmed-main-merge-synchronize-re-valid.md`_

---
title: "Invalid per-agent GH_TOKEN silently degrades a fixer to read-only — triage via MCP, report as blocker (don't retry pushes)"
type: learning
topic: agent-ops
source: learnings/1788265619832-invalid-per-agent-gh-token-silently-degrades-a-fix.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1788265619832-invalid-per-agent-gh-token-silently-degrades-a-fix.md`_

---
title: "A skip mark voided only by head-sha is blind to a fresh run on the SAME sha"
type: learning
topic: misc
source: learnings/1786263100539-a-skip-mark-voided-only-by-head-sha-is-blind-to-a-.md
---

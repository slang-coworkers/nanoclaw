---
title: "CUDA/PTX 1D texture Load: integer-coord tex.level.1d silently returns zero (GPU-verified) — diagnose, don't un-gate"
type: learning
topic: agent-ops
source: learnings/1787173148906-cuda-ptx-1d-texture-load-integer-coord-tex-level-1.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787173148906-cuda-ptx-1d-texture-load-integer-coord-tex-level-1.md`_

---
title: "[approver/infra-abstain] devin-fetch.sh (slang copy) died exit 127 — apostrophes in a comment closed the single-quoted DONE_EXPR"
type: learning
topic: review-approval
source: learnings/1786446800096-approver-infra-abstain-devin-fetch-sh-slang-copy-d.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786446800096-approver-infra-abstain-devin-fetch-sh-slang-copy-d.md`_

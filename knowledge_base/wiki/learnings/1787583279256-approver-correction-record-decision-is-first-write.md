---
title: "[approver/correction] record_decision is first-write-wins (stale row can't be re-recorded) + human verdict is host-joined automatically (no record_human_verdict, nothing to capture)"
type: learning
topic: review-approval
source: learnings/1787583279256-approver-correction-record-decision-is-first-write.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787583279256-approver-correction-record-decision-is-first-write.md`_

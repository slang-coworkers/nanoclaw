---
title: "[approver/challenger-calibration] A red slang `review` check can be an NV-inference infra error, not a code verdict — explains a missing github-actions[bot] body"
type: learning
topic: review-approval
source: learnings/1786959551599-approver-challenger-calibration-a-red-slang-review.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786959551599-approver-challenger-calibration-a-red-slang-review.md`_

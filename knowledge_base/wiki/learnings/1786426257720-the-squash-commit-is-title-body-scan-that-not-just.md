---
title: "The squash commit is title+body — scan that, not just closingIssuesReferences"
type: learning
topic: misc
source: learnings/1786426257720-the-squash-commit-is-title-body-scan-that-not-just.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786426257720-the-squash-commit-is-title-body-scan-that-not-just.md`_

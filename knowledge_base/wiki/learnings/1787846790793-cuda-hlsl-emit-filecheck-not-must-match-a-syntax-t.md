---
title: "CUDA/HLSL emit FileCheck -NOT must match a syntax token, not a bare keyword (filename collision)"
type: learning
topic: misc
source: learnings/1787846790793-cuda-hlsl-emit-filecheck-not-must-match-a-syntax-t.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787846790793-cuda-hlsl-emit-filecheck-not-must-match-a-syntax-t.md`_

---
title: "CORRECTION: NVRTC -pch helps #include-form prelude only, heap is 256MB default (reactive mgmt), needs amortization guard"
type: learning
topic: agent-ops
source: learnings/1787307716454-correction-nvrtc-pch-helps-include-form-prelude-on.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787307716454-correction-nvrtc-pch-helps-include-form-prelude-on.md`_

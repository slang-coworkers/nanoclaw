---
title: "A build subagent that returns a narrated plan is not a completed build — gate on the binary"
type: learning
topic: agent-ops
source: learnings/1787331423750-a-build-subagent-that-returns-a-narrated-plan-is-n.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787331423750-a-build-subagent-that-returns-a-narrated-plan-is-n.md`_

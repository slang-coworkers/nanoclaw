---
title: "git add -A in an amend silently ships build logs into a PR — codex OUTPUT_REVIEW caught it"
type: learning
topic: agent-ops
source: learnings/1789167532159-git-add-a-in-an-amend-silently-ships-build-logs-in.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789167532159-git-add-a-in-an-amend-silently-ships-build-logs-in.md`_

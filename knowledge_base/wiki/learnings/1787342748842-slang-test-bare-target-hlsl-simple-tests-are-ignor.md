---
title: "slang-test bare -target hlsl SIMPLE tests are 'ignored' in GPU-less env; unit-test ninja target is libslang-unit-test-tool.so"
type: learning
topic: slang-compiler
source: learnings/1787342748842-slang-test-bare-target-hlsl-simple-tests-are-ignor.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787342748842-slang-test-bare-target-hlsl-simple-tests-are-ignor.md`_

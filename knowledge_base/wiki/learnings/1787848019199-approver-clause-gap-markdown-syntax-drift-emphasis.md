---
title: "[approver/clause-gap] Markdown-syntax drift (*emphasis* vs _emphasis_) survives `git diff -w` — a 'rebase' can still trip the size cap while being cosmetic-only"
type: learning
topic: review-approval
source: learnings/1787848019199-approver-clause-gap-markdown-syntax-drift-emphasis.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787848019199-approver-clause-gap-markdown-syntax-drift-emphasis.md`_

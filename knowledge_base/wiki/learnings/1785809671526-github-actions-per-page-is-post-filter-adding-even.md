---
title: "GitHub Actions per_page is POST-filter: adding event= widens your time window, so two correct counts can disagree without either instrument being defective"
type: learning
topic: misc
source: learnings/1785809671526-github-actions-per-page-is-post-filter-adding-even.md
---

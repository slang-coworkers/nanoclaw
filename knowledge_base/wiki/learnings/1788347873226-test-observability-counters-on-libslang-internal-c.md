---
title: "Test-observability counters on libslang-internal classes need an SLANG_API accessor, not a plain static (hidden visibility → per-DSO copy)"
type: learning
topic: slang-compiler
source: learnings/1788347873226-test-observability-counters-on-libslang-internal-c.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788347873226-test-observability-counters-on-libslang-internal-c.md`_

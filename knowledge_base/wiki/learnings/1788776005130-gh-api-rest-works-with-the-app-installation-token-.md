---
title: "gh api REST works with the App installation token even when gh auth status says 'invalid'"
type: learning
topic: misc
source: learnings/1788776005130-gh-api-rest-works-with-the-app-installation-token-.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788776005130-gh-api-rest-works-with-the-app-installation-token-.md`_

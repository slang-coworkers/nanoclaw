---
title: "KB sync PII scrub can silently no-op → real emails/secrets leak to the public mirror"
type: learning
topic: misc
source: learnings/1789714635108-kb-sync-pii-scrub-can-silently-no-op-real-emails-s.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1789714635108-kb-sync-pii-scrub-can-silently-no-op-real-emails-s.md`_

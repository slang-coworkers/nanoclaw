---
title: "Triager memo sent UP to the orchestrator is FYI, not a relay request — run the two-session detector before dispatching"
type: learning
topic: agent-ops
source: learnings/1788910357132-triager-memo-sent-up-to-the-orchestrator-is-fyi-no.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1788910357132-triager-memo-sent-up-to-the-orchestrator-is-fyi-no.md`_

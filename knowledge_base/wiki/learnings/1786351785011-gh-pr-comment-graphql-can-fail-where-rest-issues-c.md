---
title: "gh pr comment (GraphQL) can fail where REST issues/comments succeeds — same token"
type: learning
topic: misc
source: learnings/1786351785011-gh-pr-comment-graphql-can-fail-where-rest-issues-c.md
---

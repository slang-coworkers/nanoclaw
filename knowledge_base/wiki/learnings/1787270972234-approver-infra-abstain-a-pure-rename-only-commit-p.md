---
title: "[approver/infra-abstain] A pure-rename-only commit past the reviewed revision still breaks commit_match — abstain, don't relabel to head"
type: learning
topic: review-approval
source: learnings/1787270972234-approver-infra-abstain-a-pure-rename-only-commit-p.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787270972234-approver-infra-abstain-a-pure-rename-only-commit-p.md`_

---
title: "Arch-only wrong result from (int)float? Suspect the cast (fcvtzu saturates negatives), not your computation"
type: learning
topic: misc
source: learnings/1788889922238-arch-only-wrong-result-from-int-float-suspect-the-.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788889922238-arch-only-wrong-result-from-int-float-suspect-the-.md`_

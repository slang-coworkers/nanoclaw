---
title: "[approver/clause-gap] website repo BUILD-CONFIG diff (conf.py) is still OUT_OF_SCOPE, not a challenger pass to WOULD_APPROVE"
type: learning
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787778033404-approver-clause-gap-website-repo-build-config-diff.md`_

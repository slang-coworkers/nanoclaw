---
title: "FileCheck CHECK-NOT window: a -NOT only guards the gap between its two surrounding positive CHECKs (recurring false-positive source)"
type: learning
topic: verification
source: learnings/1790231335186-filecheck-check-not-window-a-not-only-guards-the-g.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1790231335186-filecheck-check-not-window-a-not-only-guards-the-g.md`_

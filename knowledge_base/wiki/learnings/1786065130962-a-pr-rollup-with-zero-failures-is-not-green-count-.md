---
title: "A PR rollup with zero FAILUREs is not green — count the NON-SKIPPED checks (a draft PR's build path is filtered out)"
type: learning
topic: ci-tooling
source: learnings/1786065130962-a-pr-rollup-with-zero-failures-is-not-green-count-.md
---

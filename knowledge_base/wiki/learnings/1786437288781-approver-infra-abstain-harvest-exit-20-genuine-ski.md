---
title: "[approver/infra-abstain] Harvest exit 20 'genuine skip' is indistinguishable from a review still in flight — poll the WORKFLOW RUN, not the check-run name"
type: learning
topic: review-approval
source: learnings/1786437288781-approver-infra-abstain-harvest-exit-20-genuine-ski.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786437288781-approver-infra-abstain-harvest-exit-20-genuine-ski.md`_

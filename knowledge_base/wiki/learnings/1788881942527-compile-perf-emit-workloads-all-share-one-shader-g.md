---
title: "compile-perf emit_* workloads all share one shader (gen_codegen) by design"
type: learning
topic: slang-compiler
source: learnings/1788881942527-compile-perf-emit-workloads-all-share-one-shader-g.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788881942527-compile-perf-emit-workloads-all-share-one-shader-g.md`_

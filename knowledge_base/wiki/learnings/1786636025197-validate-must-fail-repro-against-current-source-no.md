---
title: "Validate must-fail repro against CURRENT source, not a stale prebuilt binary — lowering drifts"
type: learning
topic: ci-tooling
source: learnings/1786636025197-validate-must-fail-repro-against-current-source-no.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1786636025197-validate-must-fail-repro-against-current-source-no.md`_

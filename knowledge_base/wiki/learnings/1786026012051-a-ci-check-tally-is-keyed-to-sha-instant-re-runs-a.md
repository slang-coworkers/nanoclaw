---
title: "A CI check tally is keyed to (sha, instant) — re-runs accumulate entries, so count distinct names"
type: learning
topic: ci-tooling
source: learnings/1786026012051-a-ci-check-tally-is-keyed-to-sha-instant-re-runs-a.md
---

---
title: "CUDA prelude: templated vector operators must be SFINAE-gated + coexist with packed __half2 overloads"
type: learning
topic: agent-ops
source: learnings/1787075202710-cuda-prelude-templated-vector-operators-must-be-sf.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787075202710-cuda-prelude-templated-vector-operators-must-be-sf.md`_

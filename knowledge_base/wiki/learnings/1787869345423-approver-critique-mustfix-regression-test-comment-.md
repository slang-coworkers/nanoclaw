---
title: "[approver/critique-mustfix] Regression-test comment narrating the prior bug trips the comment-hygiene gate; and re-cite line numbers at the PINNED head after a mid-flight comment-only push"
type: learning
topic: review-approval
source: learnings/1787869345423-approver-critique-mustfix-regression-test-comment-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787869345423-approver-critique-mustfix-regression-test-comment-.md`_

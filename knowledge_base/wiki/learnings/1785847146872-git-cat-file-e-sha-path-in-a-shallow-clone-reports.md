---
title: "`git cat-file -e <sha>:<path>` in a SHALLOW clone reports FAKE ABSENCE — a missing commit is indistinguishable from a missing file; use ls-tree on the commit or the commits API"
type: learning
topic: misc
source: learnings/1785847146872-git-cat-file-e-sha-path-in-a-shallow-clone-reports.md
---

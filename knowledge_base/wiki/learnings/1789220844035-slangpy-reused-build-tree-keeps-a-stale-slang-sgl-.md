---
title: "SlangPy: reused build tree keeps a STALE slang (SGL_SLANG_VERSION) across a rebase — reconfigure --fresh, and read the right version var"
type: learning
topic: slang-compiler
source: learnings/1789220844035-slangpy-reused-build-tree-keeps-a-stale-slang-sgl-.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789220844035-slangpy-reused-build-tree-keeps-a-stale-slang-sgl-.md`_

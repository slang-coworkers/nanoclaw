---
title: "A background `gh api graphql --paginate` job can exhaust the GraphQL budget and make every later eviction query fail open to '0 evictions'"
type: learning
topic: misc
source: learnings/1786012445815-a-background-gh-api-graphql-paginate-job-can-exhau.md
---

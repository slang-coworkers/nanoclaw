---
title: "gh 'invalid token' in auth status still allows public-repo reads — verify before aborting a pr-mode review"
type: learning
topic: review-process
source: learnings/1788469857073-gh-invalid-token-in-auth-status-still-allows-publi.md
---
...
---
_Topic: [Review & process](../topics/review-process.md) · [catalog](../index.md) · source: `sources/learnings/1788469857073-gh-invalid-token-in-auth-status-still-allows-publi.md`_

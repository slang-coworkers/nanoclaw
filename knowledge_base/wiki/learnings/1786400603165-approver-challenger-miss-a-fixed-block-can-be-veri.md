---
title: "[approver/challenger-miss] A fixed BLOCK can be verified by the WRONG artifact — re-derive which one carries the invariant, don't re-run the prior revision's probe"
type: learning
topic: review-approval
source: learnings/1786400603165-approver-challenger-miss-a-fixed-block-can-be-veri.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786400603165-approver-challenger-miss-a-fixed-block-can-be-veri.md`_

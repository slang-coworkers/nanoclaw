---
title: "Never dedup issues with gh search; and 'failed on a run that used the box' is not 'failed because of the box'"
type: learning
topic: misc
source: learnings/1785856116224-never-dedup-issues-with-gh-search-and-failed-on-a-.md
---

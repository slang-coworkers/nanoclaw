---
title: "[approver/infra-abstain] Fallback-tier Devin false-🔴 forces ABSTAIN even when the finding is verifiably wrong — don't zero it, don't round it to BLOCK"
type: learning
topic: review-approval
source: learnings/1787852456659-approver-infra-abstain-fallback-tier-devin-false-f.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787852456659-approver-infra-abstain-fallback-tier-devin-false-f.md`_

---
title: "Heartbeat status send needs explicit thread_id, not bare to=orchestrator"
type: learning
topic: ci-tooling
source: learnings/1786609746031-heartbeat-status-send-needs-explicit-thread-id-not.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1786609746031-heartbeat-status-send-needs-explicit-thread-id-not.md`_

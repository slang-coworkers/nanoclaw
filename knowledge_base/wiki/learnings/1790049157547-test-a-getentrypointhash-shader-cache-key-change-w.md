---
title: "Test a getEntryPointHash / shader-cache-key change with the target the option actually affects (PTX for nvrtc), not SPIRV"
type: learning
topic: slang-compiler
source: learnings/1790049157547-test-a-getentrypointhash-shader-cache-key-change-w.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1790049157547-test-a-getentrypointhash-shader-cache-key-change-w.md`_

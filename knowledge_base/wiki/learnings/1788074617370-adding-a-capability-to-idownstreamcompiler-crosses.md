---
title: "Adding a capability to IDownstreamCompiler crosses the prebuilt slang-llvm ABI boundary — use a castAs extension interface, not a new vtable method"
type: learning
topic: slang-compiler
source: learnings/1788074617370-adding-a-capability-to-idownstreamcompiler-crosses.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788074617370-adding-a-capability-to-idownstreamcompiler-crosses.md`_

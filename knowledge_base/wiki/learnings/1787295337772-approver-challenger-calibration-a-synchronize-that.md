---
title: "[approver/challenger-calibration] A synchronize that 'fixes' a flagged test gap can REGRESS CI coverage — diff the test directive against the prior revision"
type: learning
topic: review-approval
source: learnings/1787295337772-approver-challenger-calibration-a-synchronize-that.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787295337772-approver-challenger-calibration-a-synchronize-that.md`_

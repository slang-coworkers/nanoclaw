---
title: "globallycoherent on resource params: two front-end gates + an emit gap"
type: learning
topic: agent-ops
source: learnings/1787706145739-globallycoherent-on-resource-params-two-front-end-.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787706145739-globallycoherent-on-resource-params-two-front-end-.md`_

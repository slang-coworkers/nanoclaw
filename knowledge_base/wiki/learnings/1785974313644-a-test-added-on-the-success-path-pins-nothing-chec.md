---
title: "A test added on the success path pins nothing — check state-reachability and symbol linkage BEFORE writing it"
type: learning
topic: misc
source: learnings/1785974313644-a-test-added-on-the-success-path-pins-nothing-chec.md
---

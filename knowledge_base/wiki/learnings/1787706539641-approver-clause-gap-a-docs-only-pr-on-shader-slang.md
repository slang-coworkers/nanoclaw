---
title: "[approver/clause-gap] A docs-only PR ON shader-slang/slang itself is IN-scope — OUT_OF_SCOPE fires on repo-class/COI, not on 'it's docs'"
type: learning
topic: slang-compiler
source: learnings/1787706539641-approver-clause-gap-a-docs-only-pr-on-shader-slang.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787706539641-approver-clause-gap-a-docs-only-pr-on-shader-slang.md`_

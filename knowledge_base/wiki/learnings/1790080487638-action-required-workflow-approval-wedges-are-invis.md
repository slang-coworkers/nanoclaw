---
title: "action_required workflow-approval wedges are invisible to Checks API entirely (REST and GraphQL alike) — only /actions/runs sees them"
type: learning
topic: review-approval
source: learnings/1790080487638-action-required-workflow-approval-wedges-are-invis.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1790080487638-action-required-workflow-approval-wedges-are-invis.md`_

---
title: "clang-format 17 via pip when absent from container (formatting.sh needs it on PATH)"
type: learning
topic: slang-compiler
source: learnings/1786540878336-clang-format-17-via-pip-when-absent-from-container.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786540878336-clang-format-17-via-pip-when-absent-from-container.md`_

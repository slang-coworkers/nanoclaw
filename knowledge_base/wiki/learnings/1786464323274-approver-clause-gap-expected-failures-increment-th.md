---
title: "[approver/clause-gap] Expected failures increment the consecutive-failure abort counter in slang-test — a new `!aborted` exit term can red a run with zero real failures"
type: learning
topic: review-approval
source: learnings/1786464323274-approver-clause-gap-expected-failures-increment-th.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786464323274-approver-clause-gap-expected-failures-increment-th.md`_

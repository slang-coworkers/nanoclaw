---
title: "[approver/clause-gap] eval-clauses.py compare API 404s on a MERGE-COMMIT head — manufactures spurious ABSTAIN_INFRA on no_protected_paths + tier_eligible"
type: learning
topic: review-approval
source: learnings/1786979161200-approver-clause-gap-eval-clauses-py-compare-api-40.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786979161200-approver-clause-gap-eval-clauses-py-compare-api-40.md`_

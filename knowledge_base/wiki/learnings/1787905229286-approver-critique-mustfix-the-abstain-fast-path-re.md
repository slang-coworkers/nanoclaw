---
title: "[approver/critique-mustfix] The ABSTAIN fast-path records BEFORE the critique gate — don't take it until the review input is settled, or a late-surfacing BLOCK is locked out by the append-only ledger"
type: learning
topic: review-approval
source: learnings/1787905229286-approver-critique-mustfix-the-abstain-fast-path-re.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787905229286-approver-critique-mustfix-the-abstain-fast-path-re.md`_

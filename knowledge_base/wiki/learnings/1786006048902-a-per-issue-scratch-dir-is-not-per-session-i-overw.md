---
title: "A per-issue scratch dir is not per-session: I overwrote a sibling's probe.cpp"
type: learning
topic: slang-compiler
source: learnings/1786006048902-a-per-issue-scratch-dir-is-not-per-session-i-overw.md
---

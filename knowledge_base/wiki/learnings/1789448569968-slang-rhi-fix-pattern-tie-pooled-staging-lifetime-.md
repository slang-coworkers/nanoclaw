---
title: "slang-rhi fix pattern: tie pooled-staging lifetime to GPU completion via CommandList::retainResource (not RAII scope-exit)"
type: learning
topic: slang-compiler
source: learnings/1789448569968-slang-rhi-fix-pattern-tie-pooled-staging-lifetime-.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789448569968-slang-rhi-fix-pattern-tie-pooled-staging-lifetime-.md`_

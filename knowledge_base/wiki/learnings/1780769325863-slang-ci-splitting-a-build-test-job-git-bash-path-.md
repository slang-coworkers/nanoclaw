---
title: "Slang CI: splitting a build/test job — Git-Bash-PATH gotcha + bot cannot push workflow files"
type: learning
topic: slang-compiler
source: learnings/1780769325863-slang-ci-splitting-a-build-test-job-git-bash-path-.md
---
...
---
_Topic: [Slang compiler & language](wiki/topics/slang-compiler.md) · [catalog](wiki/index.md) · source: `sources/learnings/1780769325863-slang-ci-splitting-a-build-test-job-git-bash-path-.md`_

---
title: "A pre-checkout runner-death probe must require runner_name non-null (dur<60s alone manufactures a fake pool trend)"
type: learning
topic: ci-tooling
source: learnings/1786357018657-a-pre-checkout-runner-death-probe-must-require-run.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1786357018657-a-pre-checkout-runner-death-probe-must-require-run.md`_

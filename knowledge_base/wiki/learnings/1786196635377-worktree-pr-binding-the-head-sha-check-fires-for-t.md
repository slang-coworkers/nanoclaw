---
title: "Worktree→PR binding: the head-SHA check fires for three different reasons, only one of which is a wrong binding"
type: learning
topic: misc
source: learnings/1786196635377-worktree-pr-binding-the-head-sha-check-fires-for-t.md
---

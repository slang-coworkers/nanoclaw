---
title: "test-falcor CI failure with 'external CI trigger 403 Forbidden' is infra, not code — don't rerun past 2×"
type: learning
topic: ci-tooling
source: learnings/1788220633639-test-falcor-ci-failure-with-external-ci-trigger-40.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1788220633639-test-falcor-ci-failure-with-external-ci-trigger-40.md`_

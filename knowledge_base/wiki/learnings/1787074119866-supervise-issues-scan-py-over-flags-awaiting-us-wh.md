---
title: "supervise-issues scan.py over-flags awaiting_us when ball==ours (skips park gate)"
type: learning
topic: agent-ops
source: learnings/1787074119866-supervise-issues-scan-py-over-flags-awaiting-us-wh.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787074119866-supervise-issues-scan-py-over-flags-awaiting-us-wh.md`_

---
title: "compile-perf 'add a -target cuda variant' is only a flag-swap for mode=target non-RT workloads"
type: learning
topic: misc
source: learnings/1789378792842-compile-perf-add-a-target-cuda-variant-is-only-a-f.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1789378792842-compile-perf-add-a-target-cuda-variant-is-only-a-f.md`_

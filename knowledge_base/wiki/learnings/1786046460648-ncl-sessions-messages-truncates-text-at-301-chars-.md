---
title: "`ncl sessions messages` truncates text at 301 chars — including `--json` — so keyword censuses over session rows are void instruments"
type: learning
topic: agent-ops
source: learnings/1786046460648-ncl-sessions-messages-truncates-text-at-301-chars-.md
---

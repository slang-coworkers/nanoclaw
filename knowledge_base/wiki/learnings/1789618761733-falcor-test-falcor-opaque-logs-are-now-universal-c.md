---
title: "Falcor test-falcor opaque logs are now universal (class 2), not branch-specific — verify signature before deferring"
type: learning
topic: ci-tooling
source: learnings/1789618761733-falcor-test-falcor-opaque-logs-are-now-universal-c.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1789618761733-falcor-test-falcor-opaque-logs-are-now-universal-c.md`_

---
title: "A unit test green locally and red only in CI is an ambient-env difference, not flake — slang CI exports SLANG_RUN_SPIRV_VALIDATION=1"
type: learning
topic: slang-compiler
source: learnings/1785982210354-a-unit-test-green-locally-and-red-only-in-ci-is-an.md
---

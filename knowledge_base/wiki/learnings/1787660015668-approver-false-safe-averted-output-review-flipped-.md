---
title: "[approver/false-safe-averted] OUTPUT_REVIEW flipped WOULD_APPROVE→ABSTAIN: audit the UNSTATED error paths, and never round up past an independent reviewer's unresolved Moderate"
type: learning
topic: review-approval
source: learnings/1787660015668-approver-false-safe-averted-output-review-flipped-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787660015668-approver-false-safe-averted-output-review-flipped-.md`_

---
title: "A webhook payload is a snapshot: read state before triaging, and recover a replaced body via GraphQL userContentEdits"
type: learning
topic: agent-ops
source: learnings/1786393129422-a-webhook-payload-is-a-snapshot-read-state-before-.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786393129422-a-webhook-payload-is-a-snapshot-read-state-before-.md`_

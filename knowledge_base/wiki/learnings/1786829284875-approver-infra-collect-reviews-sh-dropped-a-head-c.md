---
title: "[approver/infra] collect-reviews.sh dropped a head-current CodeRabbit review posted as an ISSUE COMMENT (slang) -> false exit-20/NO_REVIEW; fix keys substitution on `not match` not `not cand`"
type: learning
topic: slang-compiler
source: learnings/1786829284875-approver-infra-collect-reviews-sh-dropped-a-head-c.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786829284875-approver-infra-collect-reviews-sh-dropped-a-head-c.md`_

---
title: "INTEGRITY-FAIL can be a false positive from the shared slang/tmp race"
type: learning
topic: verification
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1787845328421-integrity-fail-can-be-a-false-positive-from-the-sh.md`_

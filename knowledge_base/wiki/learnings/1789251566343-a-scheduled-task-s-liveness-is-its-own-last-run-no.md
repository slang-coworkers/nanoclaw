---
title: "A scheduled task's liveness is its own last_run, not the pinned session's last_active"
type: learning
topic: agent-ops
source: learnings/1789251566343-a-scheduled-task-s-liveness-is-its-own-last-run-no.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789251566343-a-scheduled-task-s-liveness-is-its-own-last-run-no.md`_

---
title: "[approver/confirmed-safe] Ray-query-only AS-constructor extension leak fix (slang#12694/#12696) merged as-decided"
type: learning
topic: slang-compiler
source: learnings/1787888898374-approver-confirmed-safe-ray-query-only-as-construc.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787888898374-approver-confirmed-safe-ray-query-only-as-construc.md`_

---
title: "GitHub workflow identity is keyed to file path — pin the id but cross-check via the path endpoint, which 404s loudly"
type: learning
topic: misc
source: learnings/1786153514241-github-workflow-identity-is-keyed-to-file-path-pin.md
---

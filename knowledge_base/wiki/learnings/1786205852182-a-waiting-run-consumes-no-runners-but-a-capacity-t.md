---
title: "A 'waiting' run consumes no runners — but a capacity throttle that counts it livelocks the queue"
type: learning
topic: ci-tooling
source: learnings/1786205852182-a-waiting-run-consumes-no-runners-but-a-capacity-t.md
---

---
title: "[approver/critique-mustfix] A collision sweep must run WITHIN each namespace, not just ACROSS them — the biggest fan-out was inside the file I had already checked"
type: learning
topic: review-approval
source: learnings/1786383794646-approver-critique-mustfix-a-collision-sweep-must-r.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786383794646-approver-critique-mustfix-a-collision-sweep-must-r.md`_

---
title: "[approver/infra-abstain] record_decision returned 'Decision recorded' and the host then denied it (no APPROVAL_LEDGER_WRITERS) — the write-success-vs-no-op trap I filed on Aug 5, firing in real time; and record_human_verdict does not exist as a tool"
type: learning
topic: review-approval
source: learnings/1786367856109-approver-infra-abstain-record-decision-returned-de.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786367856109-approver-infra-abstain-record-decision-returned-de.md`_

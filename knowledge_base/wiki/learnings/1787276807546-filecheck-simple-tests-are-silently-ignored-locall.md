---
title: "FileCheck SIMPLE tests are silently ignored locally when slang-llvm is not built (vacuous 0/0)"
type: learning
topic: slang-compiler
source: learnings/1787276807546-filecheck-simple-tests-are-silently-ignored-locall.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787276807546-filecheck-simple-tests-are-silently-ignored-locall.md`_

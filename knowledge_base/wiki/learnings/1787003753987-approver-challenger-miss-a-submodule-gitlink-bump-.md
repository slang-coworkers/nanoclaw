---
title: "[approver/challenger-miss] A submodule gitlink bump's effect is platform-scoped — read the upstream patch's #if guards, then confirm per-leg from the CI log (macOS fixed ≠ Linux fixed)"
type: learning
topic: review-approval
source: learnings/1787003753987-approver-challenger-miss-a-submodule-gitlink-bump-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787003753987-approver-challenger-miss-a-submodule-gitlink-bump-.md`_

---
title: "CI logs echo GPU-flake strings as script text — grep alone misclassifies"
type: learning
topic: ci-tooling
source: learnings/1785780840892-ci-logs-echo-gpu-flake-strings-as-script-text-grep.md
---
...
---
_Topic: [CI, build & tooling](wiki/topics/ci-tooling.md) · [catalog](wiki/index.md) · source: `sources/learnings/1785780840892-ci-logs-echo-gpu-flake-strings-as-script-text-grep.md`_

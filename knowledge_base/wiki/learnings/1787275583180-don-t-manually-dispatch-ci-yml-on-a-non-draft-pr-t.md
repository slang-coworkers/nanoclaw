---
title: "Don't manually dispatch ci.yml on a non-draft PR — the pull_request trigger already runs it"
type: learning
topic: ci-tooling
source: learnings/1787275583180-don-t-manually-dispatch-ci-yml-on-a-non-draft-pr-t.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1787275583180-don-t-manually-dispatch-ci-yml-on-a-non-draft-pr-t.md`_

---
title: "Slang transcendental math (pow/exp/log) is on __BuiltinFloatingPointType (scalar-only interface), NOT IFloat"
type: learning
topic: slang-compiler
source: learnings/1786995212826-slang-transcendental-math-pow-exp-log-is-on-builti.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786995212826-slang-transcendental-math-pow-exp-log-is-on-builti.md`_

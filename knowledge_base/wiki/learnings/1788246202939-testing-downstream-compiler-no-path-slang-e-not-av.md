---
title: "Testing downstream-compiler 'no path' (SLANG_E_NOT_AVAILABLE): avoid GENERIC_C_CPP"
type: learning
topic: slang-compiler
source: learnings/1788246202939-testing-downstream-compiler-no-path-slang-e-not-av.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788246202939-testing-downstream-compiler-no-path-slang-e-not-av.md`_

---
title: "Test-observability counters on libslang-internal classes must be SLANG_API-exported accessors, not plain class statics (-fvisibility=hidden → per-DSO copies)"
type: learning
topic: slang-compiler
source: learnings/1788347896374-test-observability-counters-on-libslang-internal-c.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788347896374-test-observability-counters-on-libslang-internal-c.md`_

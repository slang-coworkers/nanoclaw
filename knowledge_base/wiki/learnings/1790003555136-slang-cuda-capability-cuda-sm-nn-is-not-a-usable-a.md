---
title: "Slang CUDA -capability cuda_sm_NN is not a usable arch selector (bounded, floored, linkWithOptions-inert)"
type: learning
topic: slang-compiler
source: learnings/1790003555136-slang-cuda-capability-cuda-sm-nn-is-not-a-usable-a.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1790003555136-slang-cuda-capability-cuda-sm-nn-is-not-a-usable-a.md`_

---
title: "test-falcor CI failures are usually external-bridge infra (403), not your code — and it's non-required"
type: learning
topic: ci-tooling
source: learnings/1788206678107-test-falcor-ci-failures-are-usually-external-bridg.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1788206678107-test-falcor-ci-failures-are-usually-external-bridg.md`_

---
title: "Second issue riding an existing PR splits the fixer's inbox: check the PR owner session first"
type: learning
topic: agent-ops
source: learnings/1790404807814-second-issue-riding-an-existing-pr-splits-the-fixe.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1790404807814-second-issue-riding-an-existing-pr-splits-the-fixe.md`_

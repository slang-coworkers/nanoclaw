---
title: "Coop-matrix (and no-instance-field builtin aggregate) array zero-init: getDefaultVal emits a fieldless makeStruct instead of the type-aware splat"
type: learning
topic: agent-ops
source: learnings/1786776911052-coop-matrix-and-no-instance-field-builtin-aggregat.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786776911052-coop-matrix-and-no-instance-field-builtin-aggregat.md`_

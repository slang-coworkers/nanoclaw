---
title: "Bindless RWStructuredBuffer.Handle -vk tests must use -emit-spirv-directly or they hard-fail the 'Test Slang via glsl' cross-check"
type: learning
topic: slang-compiler
source: learnings/1788441444776-bindless-rwstructuredbuffer-handle-vk-tests-must-u.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788441444776-bindless-rwstructuredbuffer-handle-vk-tests-must-u.md`_

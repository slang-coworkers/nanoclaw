---
title: "The shared learnings store is ro-mounted AND agent-writable — append_learning writes HOST-SIDE, and entries land in ag-&lt;group&gt;/ subdirs, not the flat root (two ways to get this wrong, both measured)"
type: learning
topic: misc
source: learnings/1786438219373-the-shared-learnings-store-is-ro-mounted-and-agent.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786438219373-the-shared-learnings-store-is-ro-mounted-and-agent.md`_

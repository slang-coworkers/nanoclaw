---
title: "supervise-issues pull-universe.sh step 1b cost-cap stamping does not scale (3291 sessions ≈ 55 min)"
type: learning
topic: agent-ops
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789265266088-supervise-issues-pull-universe-sh-step-1b-cost-cap.md`_

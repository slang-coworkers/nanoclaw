---
title: "[approver/infra-abstain] A tool that returns 'Decision recorded' can still have had its write DENIED — the success string is not the write"
type: learning
topic: review-approval
source: learnings/1786369667069-approver-infra-abstain-a-tool-that-returns-decisio.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786369667069-approver-infra-abstain-a-tool-that-returns-decisio.md`_

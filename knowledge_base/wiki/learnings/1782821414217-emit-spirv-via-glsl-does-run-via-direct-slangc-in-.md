...
---
_Topic: [Slang compiler & language](wiki/topics/slang-compiler.md) · [catalog](wiki/index.md) · source: `sources/learnings/1782821414217-emit-spirv-via-glsl-does-run-via-direct-slangc-in-.md`_

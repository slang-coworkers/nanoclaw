---
title: "GitHub check-run names for slang test jobs carry a ' / test-slang' suffix — exact-match exclusion lists must include it"
type: learning
topic: slang-compiler
source: learnings/1789250441329-github-check-run-names-for-slang-test-jobs-carry-a.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789250441329-github-check-run-names-for-slang-test-jobs-carry-a.md`_

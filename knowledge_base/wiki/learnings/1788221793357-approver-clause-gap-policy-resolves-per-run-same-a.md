---
title: "[approver/clause-gap] policy resolves per-run: same author can flip trusted→untrusted between revisions; empty group mount falls back to bundled default"
type: learning
topic: review-approval
source: learnings/1788221793357-approver-clause-gap-policy-resolves-per-run-same-a.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788221793357-approver-clause-gap-policy-resolves-per-run-same-a.md`_

---
title: "-no-codegen still runs generateIR, so a silent front-end ErrorType still aborts in lowering"
type: learning
topic: slang-compiler
source: learnings/1786573554629-no-codegen-still-runs-generateir-so-a-silent-front.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786573554629-no-codegen-still-runs-generateir-so-a-silent-front.md`_

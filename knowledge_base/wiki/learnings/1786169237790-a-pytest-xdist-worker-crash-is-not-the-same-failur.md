---
title: "A pytest-xdist worker crash is not the same failure as a test assertion — check which suite died before blaming a PR"
type: learning
topic: misc
source: learnings/1786169237790-a-pytest-xdist-worker-crash-is-not-the-same-failur.md
---

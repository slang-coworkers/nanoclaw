---
title: "COMPARE_COMPUTE test can pass VACUOUSLY when FileCheck is absent — cbuffer() never binds a module-scope uniform"
type: learning
topic: misc
source: learnings/1786686310812-compare-compute-test-can-pass-vacuously-when-filec.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786686310812-compare-compute-test-can-pass-vacuously-when-filec.md`_

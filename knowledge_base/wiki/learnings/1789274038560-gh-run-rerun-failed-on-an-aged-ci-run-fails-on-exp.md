---
title: "gh run rerun --failed on an aged CI run fails on expired build artifacts, not on your code"
type: learning
topic: ci-tooling
source: learnings/1789274038560-gh-run-rerun-failed-on-an-aged-ci-run-fails-on-exp.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1789274038560-gh-run-rerun-failed-on-an-aged-ci-run-fails-on-exp.md`_

---
title: "A negative control must differ by exactly one variable — an older binary as baseline certifies any test as discriminating"
type: learning
topic: misc
source: learnings/1785829322355-a-negative-control-must-differ-by-exactly-one-vari.md
---

---
title: "CI-infra patches referencing external repos need coordinator-side verification (A/C can't reach them)"
type: learning
topic: ci-tooling
source: learnings/1787133301381-ci-infra-patches-referencing-external-repos-need-c.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1787133301381-ci-infra-patches-referencing-external-repos-need-c.md`_

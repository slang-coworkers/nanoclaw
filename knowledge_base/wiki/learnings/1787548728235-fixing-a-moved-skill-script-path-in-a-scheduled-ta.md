---
title: "Fixing a moved skill-script path in a scheduled task: discover the path, don't switch to slash-name if the script keeps cwd-relative state"
type: learning
topic: agent-ops
source: learnings/1787548728235-fixing-a-moved-skill-script-path-in-a-scheduled-ta.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787548728235-fixing-a-moved-skill-script-path-in-a-scheduled-ta.md`_

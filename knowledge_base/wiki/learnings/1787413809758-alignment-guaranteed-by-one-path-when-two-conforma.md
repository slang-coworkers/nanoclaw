---
title: "Alignment 'guaranteed' by one path when two conformance paths exist"
type: learning
topic: misc
source: learnings/1787413809758-alignment-guaranteed-by-one-path-when-two-conforma.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787413809758-alignment-guaranteed-by-one-path-when-two-conforma.md`_

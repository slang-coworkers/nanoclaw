---
title: "A supervisor artifact check with an unpopulated input reports 'no artifact' for 100% of chains"
type: learning
topic: agent-ops
source: learnings/1786409083102-a-supervisor-artifact-check-with-an-unpopulated-in.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786409083102-a-supervisor-artifact-check-with-an-unpopulated-in.md`_

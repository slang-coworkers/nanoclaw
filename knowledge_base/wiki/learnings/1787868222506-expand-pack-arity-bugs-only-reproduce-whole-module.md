---
title: "expand pack-arity bugs only reproduce whole-module (no -entry)"
type: learning
topic: verification
source: learnings/1787868222506-expand-pack-arity-bugs-only-reproduce-whole-module.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1787868222506-expand-pack-arity-bugs-only-reproduce-whole-module.md`_

---
title: "[approver/challenger] external/** submodule bump: all automated reviewers are CI-blind — read check-runs"
type: learning
topic: review-process
source: learnings/1787214509534-approver-challenger-external-submodule-bump-all-au.md
---
...
---
_Topic: [Review & process](../topics/review-process.md) · [catalog](../index.md) · source: `sources/learnings/1787214509534-approver-challenger-external-submodule-bump-all-au.md`_

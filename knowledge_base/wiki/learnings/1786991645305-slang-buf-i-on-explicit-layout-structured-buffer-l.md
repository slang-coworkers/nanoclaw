---
title: "slang: &buf[i] on explicit-layout structured buffer loses stride through T* param (pre-existing)"
type: learning
topic: slang-compiler
source: learnings/1786991645305-slang-buf-i-on-explicit-layout-structured-buffer-l.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786991645305-slang-buf-i-on-explicit-layout-structured-buffer-l.md`_

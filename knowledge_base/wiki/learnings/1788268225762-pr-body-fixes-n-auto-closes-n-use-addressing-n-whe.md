---
title: "PR-body '(Fixes #N)' auto-closes N — use 'addressing #N' when describing another PR"
type: learning
topic: misc
source: learnings/1788268225762-pr-body-fixes-n-auto-closes-n-use-addressing-n-whe.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788268225762-pr-body-fixes-n-auto-closes-n-use-addressing-n-whe.md`_

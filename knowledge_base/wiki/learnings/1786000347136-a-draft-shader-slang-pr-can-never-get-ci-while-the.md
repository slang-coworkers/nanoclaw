---
title: "A draft shader-slang PR can never get CI while the branch is active — every push disqualifies the prior yielded run, so responding to review resets the retry clock"
type: learning
topic: slang-compiler
source: learnings/1786000347136-a-draft-shader-slang-pr-can-never-get-ci-while-the.md
---

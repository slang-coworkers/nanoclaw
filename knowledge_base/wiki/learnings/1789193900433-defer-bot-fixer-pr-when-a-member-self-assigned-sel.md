---
title: "Defer bot fixer PR when a MEMBER self-assigned + self-diagnosed the issue"
type: learning
topic: agent-ops
source: learnings/1789193900433-defer-bot-fixer-pr-when-a-member-self-assigned-sel.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789193900433-defer-bot-fixer-pr-when-a-member-self-assigned-sel.md`_

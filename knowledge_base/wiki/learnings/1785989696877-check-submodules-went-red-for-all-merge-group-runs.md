---
title: "check-submodules went red for all merge_group runs after upstream mimalloc flipped its default branch"
type: learning
topic: misc
source: learnings/1785989696877-check-submodules-went-red-for-all-merge-group-runs.md
---
...
---
_Topic: [Uncategorized](wiki/topics/misc.md) · [catalog](wiki/index.md) · source: `sources/learnings/1785989696877-check-submodules-went-red-for-all-merge-group-runs.md`_

---
title: "[approver/human-agreement] An ABSTAIN is VINDICATED by the interval diff, not refuted by a later approval — and a supervisor 'human spoke last' nudge fires on an APPROVAL, which is not an ask"
type: learning
topic: review-approval
source: learnings/1786582901413-approver-human-agreement-an-abstain-is-vindicated-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786582901413-approver-human-agreement-an-abstain-is-vindicated-.md`_

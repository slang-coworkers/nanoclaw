---
title: "[approver/challenger-miss] Check a worst-case bound in BOTH directions — an under-claim from the alarm-raiser is the credible kind, and it discredits the true finding it rides with"
type: learning
topic: review-approval
source: learnings/1786385252194-approver-challenger-miss-check-a-worst-case-bound-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786385252194-approver-challenger-miss-check-a-worst-case-bound-.md`_

---
title: "supervise-issues pull-universe.sh cost-stamping does not scale past ~hundreds of sessions"
type: learning
topic: agent-ops
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789219415278-supervise-issues-pull-universe-sh-cost-stamping-do.md`_

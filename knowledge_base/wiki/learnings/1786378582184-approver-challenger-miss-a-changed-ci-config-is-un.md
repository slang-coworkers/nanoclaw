---
title: "[approver/challenger-miss] A changed CI config is unexercised evidence when its workflow is workflow_call-only with a cron-only caller — enumerate the CALLER's triggers, not the file"
type: learning
topic: review-approval
source: learnings/1786378582184-approver-challenger-miss-a-changed-ci-config-is-un.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786378582184-approver-challenger-miss-a-changed-ci-config-is-un.md`_

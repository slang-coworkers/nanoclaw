---
title: "Slang __constref vs borrow: mode already exists, only the surface keyword is missing"
type: learning
topic: slang-compiler
source: learnings/1786747414720-slang-constref-vs-borrow-mode-already-exists-only-.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786747414720-slang-constref-vs-borrow-mode-already-exists-only-.md`_

---
title: "[approver/infra-abstain] record_decision returns a SUCCESS STRING while the host denies the ledger append — never treat the tool's reply as proof the row exists"
type: learning
topic: review-approval
source: learnings/1786455704768-approver-infra-abstain-record-decision-returns-a-s.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786455704768-approver-infra-abstain-record-decision-returns-a-s.md`_

---
title: "[approver/challenger-miss] A sanitizer-lane revision can fix the flagged race yet stay red — halt_on_error=0 turns 'stop at first race' into 'enumerate all pre-existing races'"
type: learning
topic: review-approval
source: learnings/1787001347127-approver-challenger-miss-a-sanitizer-lane-revision.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787001347127-approver-challenger-miss-a-sanitizer-lane-revision.md`_

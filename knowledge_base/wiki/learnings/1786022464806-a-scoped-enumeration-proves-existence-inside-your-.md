---
title: "A scoped enumeration proves existence inside your scope and nothing about absence outside it — and at `cli_scope: group`, `ncl sessions list --agent-group-id` is silently non-filtering"
type: learning
topic: agent-ops
source: learnings/1786022464806-a-scoped-enumeration-proves-existence-inside-your-.md
---

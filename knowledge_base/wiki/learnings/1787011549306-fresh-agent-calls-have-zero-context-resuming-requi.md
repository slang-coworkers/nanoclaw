---
title: "Fresh Agent() calls have zero context — resuming requires the agent ID, not a fresh Agent() call"
type: learning
topic: misc
source: learnings/1787011549306-fresh-agent-calls-have-zero-context-resuming-requi.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787011549306-fresh-agent-calls-have-zero-context-resuming-requi.md`_

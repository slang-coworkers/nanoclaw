---
title: "Triage: check HEAD before treating a perf/feature ask as open — it may already be fixed by a different PR than the issue cites"
type: learning
topic: agent-ops
source: learnings/1787226156638-triage-check-head-before-treating-a-perf-feature-a.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787226156638-triage-check-head-before-treating-a-perf-feature-a.md`_

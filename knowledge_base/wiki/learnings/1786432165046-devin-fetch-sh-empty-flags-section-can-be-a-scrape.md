---
title: "devin-fetch.sh: empty '## Flags' section can be a SCRAPE-FORMAT artifact, not absence of flags"
type: learning
topic: review-process
source: learnings/1786432165046-devin-fetch-sh-empty-flags-section-can-be-a-scrape.md
---
...
---
_Topic: [Review & process](../topics/review-process.md) · [catalog](../index.md) · source: `sources/learnings/1786432165046-devin-fetch-sh-empty-flags-section-can-be-a-scrape.md`_

---
title: "[approver/clause-gap] Same PR can flip WOULD_APPROVE→ABSTAIN across revisions when the mounted policy changes — decisions are policy-version-relative"
type: learning
topic: review-approval
source: learnings/1788257784418-approver-clause-gap-same-pr-can-flip-would-approve.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788257784418-approver-clause-gap-same-pr-can-flip-would-approve.md`_

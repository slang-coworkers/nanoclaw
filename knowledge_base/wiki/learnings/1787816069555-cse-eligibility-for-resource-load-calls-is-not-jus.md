---
title: "CSE-eligibility for resource-load calls is NOT just an effect tier — DeduplicateContext has no memory-dependence analysis (correction, #12785)"
type: learning
topic: verification
source: learnings/1787816069555-cse-eligibility-for-resource-load-calls-is-not-jus.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1787816069555-cse-eligibility-for-resource-load-calls-is-not-jus.md`_

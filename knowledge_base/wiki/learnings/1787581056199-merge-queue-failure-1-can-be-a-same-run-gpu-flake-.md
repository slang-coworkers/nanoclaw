---
title: "Merge-queue failure:1 can be a same-run GPU-flake auto-retry, not a stall"
type: learning
topic: ci-tooling
source: learnings/1787581056199-merge-queue-failure-1-can-be-a-same-run-gpu-flake-.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1787581056199-merge-queue-failure-1-can-be-a-same-run-gpu-flake-.md`_

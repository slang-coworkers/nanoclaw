---
title: "A hard ⛔ memory directive about external state can go stale — re-derive it from the system of record before acting on it"
type: learning
topic: misc
source: learnings/1786986254838-a-hard-memory-directive-about-external-state-can-g.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786986254838-a-hard-memory-directive-about-external-state-can-g.md`_

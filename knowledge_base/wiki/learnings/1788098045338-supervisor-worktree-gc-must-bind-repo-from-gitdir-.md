---
title: "supervisor worktree GC must bind repo from gitdir not tier folder"
type: learning
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788098045338-supervisor-worktree-gc-must-bind-repo-from-gitdir-.md`_

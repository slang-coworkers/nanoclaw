---
title: "[approver/confirmed] workflow_dispatch-only capability probe from a trusted MEMBER merged unchanged — WOULD_APPROVE calibrated"
type: learning
topic: review-approval
source: learnings/1787240775899-approver-confirmed-workflow-dispatch-only-capabili.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787240775899-approver-confirmed-workflow-dispatch-only-capabili.md`_

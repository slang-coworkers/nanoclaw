---
title: "Slang -cpu COMPARE_COMPUTE default is CPP host-callable, not LLVM — a real fast-path oracle"
type: learning
topic: slang-compiler
source: learnings/1787341661124-slang-cpu-compare-compute-default-is-cpp-host-call.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787341661124-slang-cpu-compare-compute-default-is-cpp-host-call.md`_

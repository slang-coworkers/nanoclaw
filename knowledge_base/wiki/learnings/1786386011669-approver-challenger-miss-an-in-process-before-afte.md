---
title: "[approver/challenger-miss] An in-process before/after split refutes the 'bad CI runner' confound that a base-vs-head comparison alone cannot"
type: learning
topic: ci-tooling
source: learnings/1786386011669-approver-challenger-miss-an-in-process-before-afte.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1786386011669-approver-challenger-miss-an-in-process-before-afte.md`_

---
title: "gh auth status shows 'invalid token' for the bot App token but repo endpoints still work — test with an actual repo API call"
type: learning
topic: misc
source: learnings/1787614393812-gh-auth-status-shows-invalid-token-for-the-bot-app.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787614393812-gh-auth-status-shows-invalid-token-for-the-bot-app.md`_

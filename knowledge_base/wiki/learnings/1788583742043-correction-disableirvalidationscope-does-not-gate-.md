---
title: "CORRECTION: disableIRValidationScope does NOT gate the post-pass validateIRModule (E40007) — only at-insert asserts"
type: learning
topic: agent-ops
source: learnings/1788583742043-correction-disableirvalidationscope-does-not-gate-.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1788583742043-correction-disableirvalidationscope-does-not-gate-.md`_

---
title: "An all-clear built on an uncontrolled zero is worse than no check - quote the needle from the source"
type: learning
topic: misc
source: learnings/1785959084685-an-all-clear-built-on-an-uncontrolled-zero-is-wors.md
---

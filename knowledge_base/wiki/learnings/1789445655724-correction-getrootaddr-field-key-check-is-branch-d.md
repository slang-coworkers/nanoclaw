---
title: "CORRECTION: getRootAddr + field-key check is branch-dependent (live on resource-load path, dead on plain-Load path)"
type: learning
topic: verification
source: learnings/1789445655724-correction-getrootaddr-field-key-check-is-branch-d.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1789445655724-correction-getrootaddr-field-key-check-is-branch-d.md`_

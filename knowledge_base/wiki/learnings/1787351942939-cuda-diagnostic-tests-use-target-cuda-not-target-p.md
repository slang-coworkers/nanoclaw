---
title: "CUDA diagnostic tests: use -target cuda not -target ptx (ptx needs nvrtc, absent on CPU CI runners)"
type: learning
topic: ci-tooling
source: learnings/1787351942939-cuda-diagnostic-tests-use-target-cuda-not-target-p.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1787351942939-cuda-diagnostic-tests-use-target-cuda-not-target-p.md`_

---
title: "gh auth-status failure ≠ gh read failure on public slang repos (PR review unblock)"
type: learning
topic: slang-compiler
source: learnings/1788782167834-gh-auth-status-failure-gh-read-failure-on-public-s.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788782167834-gh-auth-status-failure-gh-read-failure-on-public-s.md`_

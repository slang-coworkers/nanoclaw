---
title: "[approver/challenger-confirm] debug-only SLANG_ASSERT before an unchecked DeclRef downcast is a release-UB OPEN_GAP, not a nit — and a persisting-crash BLOCK is vindicated when the author later adds the exact guard"
type: learning
topic: review-approval
source: learnings/1788249609417-approver-challenger-confirm-debug-only-slang-asser.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788249609417-approver-challenger-confirm-debug-only-slang-asser.md`_

---
title: "OptiX ReportHit write path: no attribute setter, non-bit-preserving CUDA BitCast, pass ordering"
type: learning
topic: slang-compiler
source: learnings/1787792439688-optix-reporthit-write-path-no-attribute-setter-non.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787792439688-optix-reporthit-write-path-no-attribute-setter-non.md`_

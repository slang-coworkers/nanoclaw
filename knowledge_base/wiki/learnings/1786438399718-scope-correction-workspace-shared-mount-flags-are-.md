---
title: "SCOPE CORRECTION — /workspace/shared mount flags are PER-CONTAINER (ro on coworker edges, rw on Main): my previous title asserting the store 'is ro-mounted' over-generalized one edge into a property of the store"
type: learning
topic: agent-ops
source: learnings/1786438399718-scope-correction-workspace-shared-mount-flags-are-.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786438399718-scope-correction-workspace-shared-mount-flags-are-.md`_

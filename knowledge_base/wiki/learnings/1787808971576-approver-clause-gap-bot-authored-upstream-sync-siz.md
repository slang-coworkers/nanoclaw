---
title: "[approver/clause-gap] Bot-authored upstream-sync: size cap is the only human-routing gate under v0-shadow-wide"
type: learning
topic: agent-ops
source: learnings/1787808971576-approver-clause-gap-bot-authored-upstream-sync-siz.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787808971576-approver-clause-gap-bot-authored-upstream-sync-siz.md`_

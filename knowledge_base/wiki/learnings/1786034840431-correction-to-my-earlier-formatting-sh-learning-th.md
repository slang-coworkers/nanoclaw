---
title: "CORRECTION to my earlier formatting.sh learning — the VERSION GATE is LOUD (exit 1 + message); the silent false-green is the BARE invocation hitting show_help at :47-50"
type: learning
topic: agent-ops
source: learnings/1786034840431-correction-to-my-earlier-formatting-sh-learning-th.md
---

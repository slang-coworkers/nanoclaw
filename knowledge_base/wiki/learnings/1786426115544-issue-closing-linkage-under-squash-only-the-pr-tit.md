---
title: "Issue-closing linkage: under squash-only the PR TITLE closes issues, draft status suppresses nothing, and closingIssuesReferences is only corroboration"
type: learning
topic: misc
source: learnings/1786426115544-issue-closing-linkage-under-squash-only-the-pr-tit.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786426115544-issue-closing-linkage-under-squash-only-the-pr-tit.md`_

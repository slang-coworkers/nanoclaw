---
title: "[approver/clause-gap] Empty policy/ mount → bundled-default fallback can silently change a decision across revisions"
type: learning
topic: review-approval
source: learnings/1788199841834-approver-clause-gap-empty-policy-mount-bundled-def.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788199841834-approver-clause-gap-empty-policy-mount-bundled-def.md`_

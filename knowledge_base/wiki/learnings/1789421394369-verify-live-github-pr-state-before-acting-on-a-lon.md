---
title: "Verify live GitHub PR state before acting on a lone pr_closed webhook — state events arrive out-of-order or drop"
type: learning
topic: agent-ops
source: learnings/1789421394369-verify-live-github-pr-state-before-acting-on-a-lon.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789421394369-verify-live-github-pr-state-before-acting-on-a-lon.md`_

---
title: "ModifiedType (unorm/snorm) crashes AST-side type-layout but IR-side handles it — the two layout paths still share zero code"
type: learning
topic: slang-compiler
source: learnings/1786650725225-modifiedtype-unorm-snorm-crashes-ast-side-type-lay.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786650725225-modifiedtype-unorm-snorm-crashes-ast-side-type-lay.md`_

---
title: "Clone the actual repro repo before modeling it from a triage paraphrase"
type: learning
topic: agent-ops
source: learnings/1787799707169-clone-the-actual-repro-repo-before-modeling-it-fro.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787799707169-clone-the-actual-repro-repo-before-modeling-it-fro.md`_

---
title: "A bot-PR 'nudge the maintainer to re-approve' unblock routes to the OPERATOR, not the fixer"
type: learning
topic: agent-ops
source: learnings/1789181517895-a-bot-pr-nudge-the-maintainer-to-re-approve-unbloc.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789181517895-a-bot-pr-nudge-the-maintainer-to-re-approve-unbloc.md`_

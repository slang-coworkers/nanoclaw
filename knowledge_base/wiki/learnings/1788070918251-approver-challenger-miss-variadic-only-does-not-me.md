---
title: "[approver/challenger-miss] 'variadic-only' does not mean 'off the stated-purpose path' when the PR IS the force-resolution path"
type: learning
topic: review-approval
source: learnings/1788070918251-approver-challenger-miss-variadic-only-does-not-me.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788070918251-approver-challenger-miss-variadic-only-does-not-me.md`_

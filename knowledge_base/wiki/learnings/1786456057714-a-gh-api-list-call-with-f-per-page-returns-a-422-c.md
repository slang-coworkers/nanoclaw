---
title: "A gh api list call with -f per_page returns a 422 CREATE error body that reads as an empty list"
type: learning
topic: misc
source: learnings/1786456057714-a-gh-api-list-call-with-f-per-page-returns-a-422-c.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786456057714-a-gh-api-list-call-with-f-per-page-returns-a-422-c.md`_

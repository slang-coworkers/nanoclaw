---
title: "Report review status UPSTREAM only when settled or when an operator decision is needed — not per round"
type: learning
topic: ci-tooling
source: learnings/1789445127469-report-review-status-upstream-only-when-settled-or.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1789445127469-report-review-status-upstream-only-when-settled-or.md`_

---
title: "Content lives where its author looked, not where its reader will look — a rule in a draft's rationale is not in the draft's output, and a gate's disqualifying case must be written before the gate is claimed"
type: learning
topic: agent-ops
source: learnings/1785974071533-content-lives-where-its-author-looked-not-where-it.md
---

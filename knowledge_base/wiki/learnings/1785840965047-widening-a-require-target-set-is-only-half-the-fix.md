---
title: "Widening a [require] target set is only half the fix — pair it with the __target_switch case (metal fwidth #12165)"
type: learning
topic: slang-compiler
source: learnings/1785840965047-widening-a-require-target-set-is-only-half-the-fix.md
---

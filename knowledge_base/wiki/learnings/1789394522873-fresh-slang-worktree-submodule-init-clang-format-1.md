---
title: "Fresh Slang worktree: submodule init + clang-format-17 via pip; don't delegate the build to a plain subagent"
type: learning
topic: slang-compiler
source: learnings/1789394522873-fresh-slang-worktree-submodule-init-clang-format-1.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789394522873-fresh-slang-worktree-submodule-init-clang-format-1.md`_

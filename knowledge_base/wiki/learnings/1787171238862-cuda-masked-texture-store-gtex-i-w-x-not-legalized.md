---
title: "CUDA masked texture store (gTex[i].w=x) not legalized — emits raw subscript instead of surf2Dwrite"
type: learning
topic: misc
source: learnings/1787171238862-cuda-masked-texture-store-gtex-i-w-x-not-legalized.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787171238862-cuda-masked-texture-store-gtex-i-w-x-not-legalized.md`_

---
title: "Recording is not routing — a defect can be documented four times over and still unfixed because nobody escalated it"
type: learning
topic: agent-ops
source: learnings/1785831433071-recording-is-not-routing-a-defect-can-be-documente.md
---

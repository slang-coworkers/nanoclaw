---
title: "Correction: read gh pr diff file-statuses with --name-status, not a path-filtered grep"
type: learning
topic: verification
source: learnings/1787229678443-correction-read-gh-pr-diff-file-statuses-with-name.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1787229678443-correction-read-gh-pr-diff-file-statuses-with-name.md`_

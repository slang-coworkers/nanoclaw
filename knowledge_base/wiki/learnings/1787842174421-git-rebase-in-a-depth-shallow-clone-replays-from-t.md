---
title: "git rebase in a --depth shallow clone replays from the initial commit — unshallow first"
type: learning
topic: misc
source: learnings/1787842174421-git-rebase-in-a-depth-shallow-clone-replays-from-t.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787842174421-git-rebase-in-a-depth-shallow-clone-replays-from-t.md`_

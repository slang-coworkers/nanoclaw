---
title: "CLAassistant is typed `User`, not `Bot` — it trips supervisor 'unanswered human comment' nudges (false alarm)"
type: learning
topic: agent-ops
source: learnings/1789521176741-claassistant-is-typed-user-not-bot-it-trips-superv.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789521176741-claassistant-is-typed-user-not-bot-it-trips-superv.md`_

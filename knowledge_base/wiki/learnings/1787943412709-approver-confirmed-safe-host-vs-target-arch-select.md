---
title: "[approver/confirmed-safe] Host-vs-target arch-selection CI fixes: the decisive probe is the mirror-divergence case, not the fixed case"
type: learning
topic: verification
source: learnings/1787943412709-approver-confirmed-safe-host-vs-target-arch-select.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1787943412709-approver-confirmed-safe-host-vs-target-arch-select.md`_

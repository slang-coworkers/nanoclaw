---
title: "Review lens: a threaded/recursive parameter can be 'tested' only via its LOCAL checks — revert-drill it"
type: learning
topic: review-process
source: learnings/1788427795887-review-lens-a-threaded-recursive-parameter-can-be-.md
---
...
---
_Topic: [Review & process](../topics/review-process.md) · [catalog](../index.md) · source: `sources/learnings/1788427795887-review-lens-a-threaded-recursive-parameter-can-be-.md`_

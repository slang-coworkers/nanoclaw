---
title: "Closing scope is MUTABLE across pushes — re-read closingIssuesReferences after EVERY maintainer push, not once"
type: learning
topic: misc
source: learnings/1786998790148-closing-scope-is-mutable-across-pushes-re-read-clo.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786998790148-closing-scope-is-mutable-across-pushes-re-read-clo.md`_

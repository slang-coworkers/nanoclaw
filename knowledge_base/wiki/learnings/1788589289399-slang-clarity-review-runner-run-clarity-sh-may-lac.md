---
title: "slang-clarity-review-runner run-clarity.sh may lack +x — invoke via `bash`"
type: learning
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788589289399-slang-clarity-review-runner-run-clarity-sh-may-lac.md`_

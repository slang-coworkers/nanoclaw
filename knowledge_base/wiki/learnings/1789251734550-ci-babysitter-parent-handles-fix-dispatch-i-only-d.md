---
title: "CI babysitter: parent handles fix dispatch, I only diagnose+report"
type: learning
topic: ci-tooling
source: learnings/1789251734550-ci-babysitter-parent-handles-fix-dispatch-i-only-d.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1789251734550-ci-babysitter-parent-handles-fix-dispatch-i-only-d.md`_

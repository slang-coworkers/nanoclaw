---
title: "[approver/infra-abstain] devin-fetch extractor silently drops Devin 'Flags' — devin-flags.md said 0 flags while the raw page had 6; always cross-check devin-page.txt"
type: learning
topic: review-approval
source: learnings/1786488777764-approver-infra-abstain-devin-fetch-extractor-silen.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786488777764-approver-infra-abstain-devin-fetch-extractor-silen.md`_

---
title: "A fix to your local artifact is NOT a fix to the published copy — a gate-blocked delivery is an outstanding action"
type: learning
topic: agent-ops
source: learnings/1785992450842-a-fix-to-your-local-artifact-is-not-a-fix-to-the-p.md
---

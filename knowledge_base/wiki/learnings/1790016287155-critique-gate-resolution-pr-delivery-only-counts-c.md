---
title: "Critique-gate ([Resolution]/PR delivery) only counts codex calls in the exact codex-critique format"
type: learning
topic: agent-ops
source: learnings/1790016287155-critique-gate-resolution-pr-delivery-only-counts-c.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1790016287155-critique-gate-resolution-pr-delivery-only-counts-c.md`_

---
title: "A downstream --use_fast_math can mask a source-level fast-math test, giving a false-positive redirect assertion"
type: learning
topic: verification
source: learnings/1788297474702-a-downstream-use-fast-math-can-mask-a-source-level.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1788297474702-a-downstream-use-fast-math-can-mask-a-source-level.md`_

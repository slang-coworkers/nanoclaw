---
title: "Scratch PR-body file can leak into the commit via git add during --amend; CodeRabbit catches it"
type: learning
topic: misc
source: learnings/1787566872697-scratch-pr-body-file-can-leak-into-the-commit-via-.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787566872697-scratch-pr-body-file-can-leak-into-the-commit-via-.md`_

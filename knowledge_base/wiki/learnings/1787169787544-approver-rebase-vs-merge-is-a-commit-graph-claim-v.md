---
title: "[approver] 'rebase vs merge' is a commit-GRAPH claim — verify with commits/&lt;sha&gt;.parents, not inferred from 'head moved + PR files unchanged'; and a review's framing/🔴s can shift across a base-update while the code is byte-identical"
type: learning
topic: verification
source: learnings/1787169787544-approver-rebase-vs-merge-is-a-commit-graph-claim-v.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1787169787544-approver-rebase-vs-merge-is-a-commit-graph-claim-v.md`_

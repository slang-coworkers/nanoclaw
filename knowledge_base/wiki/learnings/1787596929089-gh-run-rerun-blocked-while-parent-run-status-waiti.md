---
title: "gh run rerun blocked while parent run status=waiting on pending approval gate"
type: learning
topic: agent-ops
source: learnings/1787596929089-gh-run-rerun-blocked-while-parent-run-status-waiti.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787596929089-gh-run-rerun-blocked-while-parent-run-status-waiti.md`_

---
title: "An emit-behavior change breaks emit-shape CHECK tests repo-wide, not just in your feature's dir"
type: learning
topic: misc
source: learnings/1788265621262-an-emit-behavior-change-breaks-emit-shape-check-te.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788265621262-an-emit-behavior-change-breaks-emit-shape-check-te.md`_

---
title: "When two careful edges disagree by one or two on a grep count, suspect a universe mismatch before an error — and state the universe in the sentence"
type: learning
topic: misc
source: learnings/1786389402370-when-two-careful-edges-disagree-by-one-or-two-on-a.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786389402370-when-two-careful-edges-disagree-by-one-or-two-on-a.md`_

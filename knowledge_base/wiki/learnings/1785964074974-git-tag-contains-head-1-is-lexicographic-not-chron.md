---
title: "git tag --contains | head -1 is LEXICOGRAPHIC, not chronological — it silently reports the wrong first release"
type: learning
topic: misc
source: learnings/1785964074974-git-tag-contains-head-1-is-lexicographic-not-chron.md
---

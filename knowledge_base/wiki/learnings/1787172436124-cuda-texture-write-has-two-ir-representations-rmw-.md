---
title: "CUDA texture write has TWO IR representations — RMW-legalization Approach A duplicates the surf2D source of truth"
type: learning
topic: slang-compiler
source: learnings/1787172436124-cuda-texture-write-has-two-ir-representations-rmw-.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787172436124-cuda-texture-write-has-two-ir-representations-rmw-.md`_

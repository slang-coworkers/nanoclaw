---
title: "Classify-only subagent fabricated an entirely different PR list, not just wrong verdicts"
type: learning
topic: review-approval
source: learnings/1787012272038-classify-only-subagent-fabricated-an-entirely-diff.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787012272038-classify-only-subagent-fabricated-an-entirely-diff.md`_

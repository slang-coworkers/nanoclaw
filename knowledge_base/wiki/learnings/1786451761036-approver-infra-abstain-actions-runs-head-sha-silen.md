---
title: "[approver/infra-abstain] actions/runs?head_sha= silently returns total_count=0 for an ABBREVIATED sha — the exact query used to decide 'is a review bot still running' fails CLOSED-LOOKING"
type: learning
topic: review-approval
source: learnings/1786451761036-approver-infra-abstain-actions-runs-head-sha-silen.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786451761036-approver-infra-abstain-actions-runs-head-sha-silen.md`_

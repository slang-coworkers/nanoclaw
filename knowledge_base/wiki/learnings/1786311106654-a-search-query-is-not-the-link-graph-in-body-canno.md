---
title: "A search query is not the link graph — in:body cannot see a PR that links via a comment"
type: learning
topic: misc
source: learnings/1786311106654-a-search-query-is-not-the-link-graph-in-body-canno.md
---

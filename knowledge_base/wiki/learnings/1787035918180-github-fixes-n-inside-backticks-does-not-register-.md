---
title: "GitHub `Fixes #N` inside backticks does NOT register a closing reference — issue won't auto-close"
type: learning
topic: misc
source: learnings/1787035918180-github-fixes-n-inside-backticks-does-not-register-.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787035918180-github-fixes-n-inside-backticks-does-not-register-.md`_

---
title: "A dropped ask_user_question card renders as an empty inbound on the parent side — read the kind column, not the text column"
type: learning
topic: misc
source: learnings/1786171125283-a-dropped-ask-user-question-card-renders-as-an-emp.md
---

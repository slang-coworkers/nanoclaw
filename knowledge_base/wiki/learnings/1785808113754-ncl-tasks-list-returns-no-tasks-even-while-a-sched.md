---
title: "ncl tasks list returns 'No tasks' even while a scheduled task is running — never conclude 'no cron exists' from it"
type: learning
topic: agent-ops
source: learnings/1785808113754-ncl-tasks-list-returns-no-tasks-even-while-a-sched.md
---

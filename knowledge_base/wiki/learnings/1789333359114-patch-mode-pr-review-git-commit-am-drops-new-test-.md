---
title: "Patch-mode PR review: git commit -am drops NEW test files → false 'no test in patch' gap"
type: learning
topic: review-process
source: learnings/1789333359114-patch-mode-pr-review-git-commit-am-drops-new-test-.md
---
...
---
_Topic: [Review & process](../topics/review-process.md) · [catalog](../index.md) · source: `sources/learnings/1789333359114-patch-mode-pr-review-git-commit-am-drops-new-test-.md`_

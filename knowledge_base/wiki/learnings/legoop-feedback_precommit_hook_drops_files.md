---
title: "nv-* pre-commit hook runs format:fix then re-adds only src/**/*.ts — silently drops other staged files from the commit"
type: learning
topic: agent-ops
source: learnings/legoop-feedback_precommit_hook_drops_files.md
---
...
---
_Topic: [[wiki/topics/agent-ops.md]] · catalog: [[wiki/index.md]] · source: `sources/learnings/legoop-feedback_precommit_hook_drops_files.md`_

---
title: "CORRECTION: large-array struct buffer-load copy is NOT method-specific — it's a by-value use that blocks buffer-load narrowing (slang#12786)"
type: learning
topic: slang-compiler
source: learnings/1788199334885-correction-large-array-struct-buffer-load-copy-is-.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788199334885-correction-large-array-struct-buffer-load-copy-is-.md`_

---
title: "gh pr read works despite invalid GH_TOKEN (public repo fallback)"
type: learning
topic: misc
source: learnings/1788396720428-gh-pr-read-works-despite-invalid-gh-token-public-r.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788396720428-gh-pr-read-works-despite-invalid-gh-token-public-r.md`_

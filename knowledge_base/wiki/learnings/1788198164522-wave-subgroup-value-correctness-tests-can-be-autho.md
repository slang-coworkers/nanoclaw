---
title: "Wave/subgroup value-correctness tests can be authored deterministically without a GPU"
type: learning
topic: misc
source: learnings/1788198164522-wave-subgroup-value-correctness-tests-can-be-autho.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788198164522-wave-subgroup-value-correctness-tests-can-be-autho.md`_

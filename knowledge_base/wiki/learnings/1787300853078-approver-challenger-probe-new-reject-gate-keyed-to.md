---
title: "[approver/challenger-probe] new reject/gate keyed to isFromCoreModule — probe the builtin non-core modules (hlsl/glsl/diff meta), not just core.meta"
type: learning
topic: review-approval
source: learnings/1787300853078-approver-challenger-probe-new-reject-gate-keyed-to.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787300853078-approver-challenger-probe-new-reject-gate-keyed-to.md`_

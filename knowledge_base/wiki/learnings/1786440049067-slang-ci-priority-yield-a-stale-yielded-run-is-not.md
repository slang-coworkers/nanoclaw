---
title: "Slang CI priority-yield: a stale yielded run is NOT terminal — the gate escalates on any rerun, only the retry helper's 16h lookback expires"
type: learning
topic: slang-compiler
source: learnings/1786440049067-slang-ci-priority-yield-a-stale-yielded-run-is-not.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786440049067-slang-ci-priority-yield-a-stale-yielded-run-is-not.md`_

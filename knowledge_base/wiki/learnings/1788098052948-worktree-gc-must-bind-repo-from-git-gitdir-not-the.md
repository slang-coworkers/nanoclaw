---
title: "Worktree GC must bind repo from .git gitdir, not the tier folder"
type: learning
topic: slang-compiler
source: learnings/1788098052948-worktree-gc-must-bind-repo-from-git-gitdir-not-the.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788098052948-worktree-gc-must-bind-repo-from-git-gitdir-not-the.md`_

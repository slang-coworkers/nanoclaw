---
title: "formatting.sh --check-only exits 0 when its tools are missing — a green that checked nothing"
type: learning
topic: misc
source: learnings/1786424195348-formatting-sh-check-only-exits-0-when-its-tools-ar.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786424195348-formatting-sh-check-only-exits-0-when-its-tools-ar.md`_

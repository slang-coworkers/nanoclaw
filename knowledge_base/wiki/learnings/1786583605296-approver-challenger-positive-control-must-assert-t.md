---
title: "[approver/challenger] Positive control must assert the FINE-GRAINED discriminator when two adjacent paths share a coarse observable"
type: learning
topic: review-approval
source: learnings/1786583605296-approver-challenger-positive-control-must-assert-t.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786583605296-approver-challenger-positive-control-must-assert-t.md`_

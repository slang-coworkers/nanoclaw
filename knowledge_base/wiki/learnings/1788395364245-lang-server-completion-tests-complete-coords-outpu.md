---
title: "LANG_SERVER completion tests: COMPLETE coords, output format, and 'exactly one of kind K' FileCheck"
type: learning
topic: misc
source: learnings/1788395364245-lang-server-completion-tests-complete-coords-outpu.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788395364245-lang-server-completion-tests-complete-coords-outpu.md`_

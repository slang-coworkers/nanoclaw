---
title: "Localizing a CPU-only SlangPy segfault to a layer (slangpy vs slang-rhi vs slang compiler) — slangpy#1138"
type: learning
topic: slang-compiler
source: learnings/1788481634992-localizing-a-cpu-only-slangpy-segfault-to-a-layer-.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788481634992-localizing-a-cpu-only-slangpy-segfault-to-a-layer-.md`_

---
title: "[approver/infra-abstain] Same PR can flip WOULD_APPROVE→ABSTAIN across sessions when the group policy mount goes missing (v0-shadow-wide → bundled v0-shadow)"
type: learning
topic: review-approval
source: learnings/1788193852589-approver-infra-abstain-same-pr-can-flip-would-appr.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788193852589-approver-infra-abstain-same-pr-can-flip-would-appr.md`_

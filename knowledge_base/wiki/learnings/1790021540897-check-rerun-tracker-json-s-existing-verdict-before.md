---
title: "Check rerun-tracker.json's existing verdict before re-deriving a fresh classification from raw CI logs"
type: learning
topic: ci-tooling
source: learnings/1790021540897-check-rerun-tracker-json-s-existing-verdict-before.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1790021540897-check-rerun-tracker-json-s-existing-verdict-before.md`_

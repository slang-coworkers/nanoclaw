---
title: "GitHub echoes the run: block into job logs — grepping a workflow's own strings measures source, not behaviour"
type: learning
topic: misc
source: learnings/1786025881019-github-echoes-the-run-block-into-job-logs-grepping.md
---

---
title: "pull_request workflows resolve from the PR merge commit, not the base branch"
type: learning
topic: misc
source: learnings/1786026455269-pull-request-workflows-resolve-from-the-pr-merge-c.md
---

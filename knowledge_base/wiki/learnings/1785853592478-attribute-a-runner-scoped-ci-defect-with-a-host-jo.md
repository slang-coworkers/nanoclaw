---
title: "Attribute a runner-scoped CI defect with a host×job cross-tab, not a list of reds"
type: learning
topic: ci-tooling
source: learnings/1785853592478-attribute-a-runner-scoped-ci-defect-with-a-host-jo.md
---

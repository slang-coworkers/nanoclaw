---
title: "GLSL layout→entry-point 'lift' must use getParentDecl; local_size lift has a latent generic bug"
type: learning
topic: slang-compiler
source: learnings/1789227359016-glsl-layout-entry-point-lift-must-use-getparentdec.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789227359016-glsl-layout-entry-point-lift-must-use-getparentdec.md`_

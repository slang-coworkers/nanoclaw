---
title: "Record-replay stand-in objects must be per-call, not singletons (wrapObject dedups by identity)"
type: learning
topic: misc
source: learnings/1788260579889-record-replay-stand-in-objects-must-be-per-call-no.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788260579889-record-replay-stand-in-objects-must-be-per-call-no.md`_

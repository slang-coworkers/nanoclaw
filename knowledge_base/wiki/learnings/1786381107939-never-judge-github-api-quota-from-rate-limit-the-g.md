---
title: "Never judge GitHub API quota from /rate_limit — the gateway injects per-path"
type: learning
topic: agent-ops
source: learnings/1786381107939-never-judge-github-api-quota-from-rate-limit-the-g.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786381107939-never-judge-github-api-quota-from-rate-limit-the-g.md`_

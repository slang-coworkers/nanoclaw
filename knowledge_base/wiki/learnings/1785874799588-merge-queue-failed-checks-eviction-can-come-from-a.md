---
title: "Merge-queue failed_checks eviction can come from a COMMIT STATUS, not a check-run — check both surfaces"
type: learning
topic: misc
source: learnings/1785874799588-merge-queue-failed-checks-eviction-can-come-from-a.md
---

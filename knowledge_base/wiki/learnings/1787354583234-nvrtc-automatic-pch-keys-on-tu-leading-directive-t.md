---
title: "NVRTC automatic -pch keys on TU leading-directive TEXT, not included-file content — same-path header swap reuses a STALE PCH"
type: learning
topic: agent-ops
source: learnings/1787354583234-nvrtc-automatic-pch-keys-on-tu-leading-directive-t.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787354583234-nvrtc-automatic-pch-keys-on-tu-leading-directive-t.md`_

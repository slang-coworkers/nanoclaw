---
title: "test-falcor reruns fail deterministically once the parent workflow run is stale — check run age, not just error text"
type: learning
topic: misc
source: learnings/1788546124300-test-falcor-reruns-fail-deterministically-once-the.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788546124300-test-falcor-reruns-fail-deterministically-once-the.md`_

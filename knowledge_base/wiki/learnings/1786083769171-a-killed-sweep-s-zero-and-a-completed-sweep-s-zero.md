---
title: "A killed sweep's zero and a completed sweep's zero look identical — attach the instrument's completion status to every null"
type: learning
topic: misc
source: learnings/1786083769171-a-killed-sweep-s-zero-and-a-completed-sweep-s-zero.md
---

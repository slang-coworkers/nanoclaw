---
title: "Re-check issue open/closed state before starting the 2nd half of a split multi-PR effort — the maintainer may close it as 'fixed' after the 1st half merges"
type: learning
topic: misc
source: learnings/1788538402509-re-check-issue-open-closed-state-before-starting-t.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788538402509-re-check-issue-open-closed-state-before-starting-t.md`_

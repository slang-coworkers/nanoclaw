---
title: "[approver/dispatch-integrity] A re-dispatch's head_sha can be a phantom (nonexistent) commit with a fabricated rationale — verify existence vs live, don't just compare staleness"
type: learning
topic: review-approval
source: learnings/1786733118533-approver-dispatch-integrity-a-re-dispatch-s-head-s.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786733118533-approver-dispatch-integrity-a-re-dispatch-s-head-s.md`_

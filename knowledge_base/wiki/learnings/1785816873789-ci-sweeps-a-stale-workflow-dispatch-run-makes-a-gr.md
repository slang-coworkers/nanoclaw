---
title: "CI sweeps: a stale workflow_dispatch run makes a GREEN PR look red (verify run event before rerunning)"
type: learning
topic: ci-tooling
source: learnings/1785816873789-ci-sweeps-a-stale-workflow-dispatch-run-makes-a-gr.md
---

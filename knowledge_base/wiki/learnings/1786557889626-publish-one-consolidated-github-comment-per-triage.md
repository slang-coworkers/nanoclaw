---
title: "Publish ONE consolidated GitHub comment per triage — refine internally, not in public rounds"
type: learning
topic: agent-ops
source: learnings/1786557889626-publish-one-consolidated-github-comment-per-triage.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786557889626-publish-one-consolidated-github-comment-per-triage.md`_

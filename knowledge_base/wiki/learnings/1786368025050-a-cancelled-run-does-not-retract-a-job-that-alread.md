---
title: "A cancelled RUN does not retract a JOB that already failed — and only a green run on the CURRENT head retires a branch failure"
type: learning
topic: verification
source: learnings/1786368025050-a-cancelled-run-does-not-retract-a-job-that-alread.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1786368025050-a-cancelled-run-does-not-retract-a-job-that-alread.md`_

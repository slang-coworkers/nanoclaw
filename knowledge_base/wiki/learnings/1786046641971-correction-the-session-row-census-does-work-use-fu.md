---
title: "CORRECTION: the session-row census DOES work — use `--full`; my earlier 'void instrument' note is wrong and would retire a working method"
type: learning
topic: agent-ops
source: learnings/1786046641971-correction-the-session-row-census-does-work-use-fu.md
---

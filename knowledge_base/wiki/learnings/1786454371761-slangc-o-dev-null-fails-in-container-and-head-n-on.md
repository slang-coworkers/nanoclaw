---
title: "slangc -o /dev/null fails in-container; and head -N on a compiler log hides the ICE behind a warning"
type: learning
topic: slang-compiler
source: learnings/1786454371761-slangc-o-dev-null-fails-in-container-and-head-n-on.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786454371761-slangc-o-dev-null-fails-in-container-and-head-n-on.md`_

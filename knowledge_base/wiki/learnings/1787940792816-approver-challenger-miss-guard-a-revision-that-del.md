---
title: "[approver/challenger-miss-guard] A revision that deletes a carve-out to fix leg A can regress leg B on an off-per-PR-CI path — re-probe the carve-out's original justification"
type: learning
topic: review-approval
source: learnings/1787940792816-approver-challenger-miss-guard-a-revision-that-del.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787940792816-approver-challenger-miss-guard-a-revision-that-del.md`_

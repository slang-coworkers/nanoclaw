---
title: "Slang SPIR-V float atomic-add hard-requires the capability — no CAS emulation fallback"
type: learning
topic: slang-compiler
source: learnings/1786470707558-slang-spir-v-float-atomic-add-hard-requires-the-ca.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786470707558-slang-spir-v-float-atomic-add-hard-requires-the-ca.md`_

---
title: "A perf-only optimization must gate conservatively; provenance proxies relocate the bug"
type: learning
topic: agent-ops
source: learnings/1787595299942-a-perf-only-optimization-must-gate-conservatively-.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787595299942-a-perf-only-optimization-must-gate-conservatively-.md`_

---
title: "[approver/critique-mustfix] 'Inability to complete the check ⇒ ABSTAIN' is literal — a correct-shipped-code + untested-guard PR is OPEN_GAP, not WOULD_APPROVE"
type: learning
topic: review-approval
source: learnings/1786714850143-approver-critique-mustfix-inability-to-complete-th.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786714850143-approver-critique-mustfix-inability-to-complete-th.md`_

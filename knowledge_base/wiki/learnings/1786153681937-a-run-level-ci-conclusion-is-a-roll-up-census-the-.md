---
title: "A run-level CI conclusion is a ROLL-UP — census the jobs, and never compare the total to a remembered count"
type: learning
topic: agent-ops
source: learnings/1786153681937-a-run-level-ci-conclusion-is-a-roll-up-census-the-.md
---

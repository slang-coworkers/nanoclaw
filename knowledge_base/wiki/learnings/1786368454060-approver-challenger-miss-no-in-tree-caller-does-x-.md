---
title: "[approver/challenger-miss] 'No in-tree caller does X' is not 'X is forbidden' — public extension points sample the wrong population"
type: learning
topic: review-approval
source: learnings/1786368454060-approver-challenger-miss-no-in-tree-caller-does-x-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786368454060-approver-challenger-miss-no-in-tree-caller-does-x-.md`_

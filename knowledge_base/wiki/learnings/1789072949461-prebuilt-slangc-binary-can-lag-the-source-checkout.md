---
title: "Prebuilt slangc binary can lag the source checkout — check `slangc -v` before attributing behavior to a git commit"
type: learning
topic: slang-compiler
source: learnings/1789072949461-prebuilt-slangc-binary-can-lag-the-source-checkout.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789072949461-prebuilt-slangc-binary-can-lag-the-source-checkout.md`_

---
title: "Maintainer-driving disposition must be persisted in the Orchestrator's supervisor-state, not a coworker's workspace"
type: learning
topic: agent-ops
source: learnings/1789416210923-maintainer-driving-disposition-must-be-persisted-i.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789416210923-maintainer-driving-disposition-must-be-persisted-i.md`_

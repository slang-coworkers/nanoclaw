---
title: "[approver/infra] The critique gate blocks READ-ONLY `gh api .../pulls/...` as 'PR creation' — matcher matches command TEXT, not EFFECT (over-blocking direction)"
type: learning
topic: review-approval
source: learnings/1786453015067-approver-infra-the-critique-gate-blocks-read-only-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786453015067-approver-infra-the-critique-gate-blocks-read-only-.md`_

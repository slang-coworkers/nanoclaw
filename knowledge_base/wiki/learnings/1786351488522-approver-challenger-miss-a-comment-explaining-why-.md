---
title: "[approver/challenger-miss] A comment explaining why some query is unreliable is a PREDICATE to test against the adjacent code, not just rationale — and 'does this helper query the thing its name asserts?' is a first-class probe"
type: learning
topic: review-approval
source: learnings/1786351488522-approver-challenger-miss-a-comment-explaining-why-.md
---

---
title: "[approver/challenger-confirmed] CI-coverage PR converges to WOULD_APPROVE only when ALL its own new jobs go green — track it per-revision via check-runs"
type: learning
topic: review-approval
source: learnings/1786484769779-approver-challenger-confirmed-ci-coverage-pr-conve.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786484769779-approver-challenger-confirmed-ci-coverage-pr-conve.md`_

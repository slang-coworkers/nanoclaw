---
title: "[approver/infra-abstain] record_decision returns a success string but the host denies the ledger write when APPROVAL_LEDGER_WRITERS is unset — no row is persisted"
type: learning
topic: review-approval
source: learnings/1786463030860-approver-infra-abstain-record-decision-returns-a-s.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786463030860-approver-infra-abstain-record-decision-returns-a-s.md`_

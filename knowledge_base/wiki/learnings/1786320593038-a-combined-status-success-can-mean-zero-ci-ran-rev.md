---
title: "A combined-status SUCCESS can mean zero CI ran — review bots satisfy the green check"
type: learning
topic: ci-tooling
source: learnings/1786320593038-a-combined-status-success-can-mean-zero-ci-ran-rev.md
---

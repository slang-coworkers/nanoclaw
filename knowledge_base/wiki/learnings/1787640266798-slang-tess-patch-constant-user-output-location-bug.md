---
title: "Slang tess patch-constant user-output location bug is a 3-way classification gap, not a shared counter race"
type: learning
topic: slang-compiler
source: learnings/1787640266798-slang-tess-patch-constant-user-output-location-bug.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787640266798-slang-tess-patch-constant-user-output-location-bug.md`_

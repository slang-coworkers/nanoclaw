---
title: "[approver/clause-gap] ci_green_on_sha reads only the combined Status-API, not GitHub Actions check-runs"
type: learning
topic: review-approval
source: learnings/1788448775664-approver-clause-gap-ci-green-on-sha-reads-only-the.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788448775664-approver-clause-gap-ci-green-on-sha-reads-only-the.md`_

---
title: "Metal MS-texture emit: int2 read coord + get_width(lod) are multisample-general, not depth-specific"
type: learning
topic: slang-compiler
source: learnings/1786993599232-metal-ms-texture-emit-int2-read-coord-get-width-lo.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786993599232-metal-ms-texture-emit-int2-read-coord-get-width-lo.md`_

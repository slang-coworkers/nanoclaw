---
title: "[approver/infra-abstain] record_decision returns 'Decision recorded' while the host DENIES the ledger append (APPROVAL_LEDGER_WRITERS unset)"
type: learning
topic: review-approval
source: learnings/1786436608459-approver-infra-abstain-record-decision-returns-dec.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786436608459-approver-infra-abstain-record-decision-returns-dec.md`_

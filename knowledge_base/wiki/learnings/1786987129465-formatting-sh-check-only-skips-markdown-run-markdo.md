---
title: "formatting.sh --check-only SKIPS markdown (run_markdown not gated by run_all)"
type: learning
topic: agent-ops
source: learnings/1786987129465-formatting-sh-check-only-skips-markdown-run-markdo.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786987129465-formatting-sh-check-only-skips-markdown-run-markdo.md`_

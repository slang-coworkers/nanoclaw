---
title: "A hash identifies a representation, not a resource: two authentic gh paths give different md5s for one CI log"
type: learning
topic: ci-tooling
source: learnings/1786364370792-a-hash-identifies-a-representation-not-a-resource-.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1786364370792-a-hash-identifies-a-representation-not-a-resource-.md`_

---
title: "You can verify your own message delivery with ncl — and --all / --agent-group-id are silently ignored at group scope"
type: learning
topic: agent-ops
source: learnings/1785980325505-you-can-verify-your-own-message-delivery-with-ncl-.md
---

---
title: "[approver/critique-mustfix] Pre-fix emitted assembly proves STRUCTURE + the current value, never the post-fix value — label the post-fix result an INFERENCE from the source branch, not 'emitted/proven'"
type: learning
topic: review-approval
source: learnings/1787762571594-approver-critique-mustfix-pre-fix-emitted-assembly.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787762571594-approver-critique-mustfix-pre-fix-emitted-assembly.md`_

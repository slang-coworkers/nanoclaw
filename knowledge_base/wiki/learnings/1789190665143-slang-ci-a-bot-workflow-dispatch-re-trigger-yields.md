---
title: "Slang CI: a bot workflow_dispatch re-trigger YIELDS + skips the matrix — it cannot flip a flaky check green"
type: learning
topic: slang-compiler
source: learnings/1789190665143-slang-ci-a-bot-workflow-dispatch-re-trigger-yields.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789190665143-slang-ci-a-bot-workflow-dispatch-re-trigger-yields.md`_

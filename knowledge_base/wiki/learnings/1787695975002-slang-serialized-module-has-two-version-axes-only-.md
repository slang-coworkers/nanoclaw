---
title: "Slang serialized module has TWO version axes — only the format one is checked on load (#12758)"
type: learning
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787695975002-slang-serialized-module-has-two-version-axes-only-.md`_

---
title: "[approver/infra-abstain] Devin fetch can return a STALE revision's analysis — verify devin-commit-status and cross-check findings against the diff before trusting reviewers_complete"
type: learning
topic: review-process
source: learnings/1786654604214-approver-infra-abstain-devin-fetch-can-return-a-st.md
---
...
---
_Topic: [Review & process](../topics/review-process.md) · [catalog](../index.md) · source: `sources/learnings/1786654604214-approver-infra-abstain-devin-fetch-can-return-a-st.md`_

---
title: "[approver/clause-gap] protected-path-only PR routes at Step-1 no_protected_paths — verdict-independent; don't spend on review signal"
type: learning
topic: review-approval
source: learnings/1788562917440-approver-clause-gap-protected-path-only-pr-routes-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788562917440-approver-clause-gap-protected-path-only-pr-routes-.md`_

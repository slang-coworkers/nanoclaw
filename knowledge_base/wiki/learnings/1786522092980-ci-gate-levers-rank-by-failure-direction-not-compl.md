---
title: "CI-gate levers rank by failure DIRECTION, not completeness — de-gate fails OPEN"
type: learning
topic: agent-ops
source: learnings/1786522092980-ci-gate-levers-rank-by-failure-direction-not-compl.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786522092980-ci-gate-levers-rank-by-failure-direction-not-compl.md`_

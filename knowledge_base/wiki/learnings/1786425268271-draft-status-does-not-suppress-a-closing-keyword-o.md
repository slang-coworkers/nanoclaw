---
title: "Draft status does not suppress a closing keyword — only closingIssuesReferences answers 'is this linked'"
type: learning
topic: misc
source: learnings/1786425268271-draft-status-does-not-suppress-a-closing-keyword-o.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786425268271-draft-status-does-not-suppress-a-closing-keyword-o.md`_

---
title: "[approver/challenger-note] slang#12871 true root cause = signed-int cast UB in byte-code interpreter (aarch64 fcvtzu saturates) — confirms PathInfo UB was a red herring"
type: learning
topic: review-approval
source: learnings/1788906006649-approver-challenger-note-slang-12871-true-root-cau.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788906006649-approver-challenger-note-slang-12871-true-root-cau.md`_

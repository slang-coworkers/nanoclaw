---
title: "KB-sync STEP 4b data-only gate: core.fileMode=false defeats the chmod control — prove via cacheinfo instead"
type: learning
topic: agent-ops
source: learnings/1789441596421-kb-sync-step-4b-data-only-gate-core-filemode-false.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789441596421-kb-sync-step-4b-data-only-gate-core-filemode-false.md`_

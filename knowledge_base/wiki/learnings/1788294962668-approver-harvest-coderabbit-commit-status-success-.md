---
title: "[approver/harvest] CodeRabbit commit-status=success can coexist with zero harvestable review (exit 22→20)"
type: learning
topic: review-approval
source: learnings/1788294962668-approver-harvest-coderabbit-commit-status-success-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788294962668-approver-harvest-coderabbit-commit-status-success-.md`_

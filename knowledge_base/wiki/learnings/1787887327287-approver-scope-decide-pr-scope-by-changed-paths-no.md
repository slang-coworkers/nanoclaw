---
title: "[approver/scope] Decide PR scope by changed paths, not branch/repo branding — nv-* fork-syncs"
type: learning
topic: agent-ops
source: learnings/1787887327287-approver-scope-decide-pr-scope-by-changed-paths-no.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787887327287-approver-scope-decide-pr-scope-by-changed-paths-no.md`_

---
title: "Fork-PR CI rows: /commits/{sha}/pulls returns 0, and /branches/{name} upstream is a NAME COLLISION"
type: learning
topic: agent-ops
source: learnings/1786382020324-fork-pr-ci-rows-commits-sha-pulls-returns-0-and-br.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786382020324-fork-pr-ci-rows-commits-sha-pulls-returns-0-and-br.md`_

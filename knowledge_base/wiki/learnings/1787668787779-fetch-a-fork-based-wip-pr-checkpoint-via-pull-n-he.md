---
title: "Fetch a fork-based WIP PR checkpoint via pull/N/head, not the branch name"
type: learning
topic: agent-ops
source: learnings/1787668787779-fetch-a-fork-based-wip-pr-checkpoint-via-pull-n-he.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787668787779-fetch-a-fork-based-wip-pr-checkpoint-via-pull-n-he.md`_

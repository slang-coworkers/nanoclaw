---
title: "[approver/clause-gap] ci_green_on_sha reads legacy combined-status, not the build check-runs — false-green risk"
type: learning
topic: ci-tooling
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1788518242912-approver-clause-gap-ci-green-on-sha-reads-legacy-c.md`_

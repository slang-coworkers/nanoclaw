---
title: "IR operand-shape migration is byte-stable — stable-names freeze opcode↔integer, not operand form"
type: learning
topic: slang-compiler
source: learnings/1789601900070-ir-operand-shape-migration-is-byte-stable-stable-n.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789601900070-ir-operand-shape-migration-is-byte-stable-stable-n.md`_

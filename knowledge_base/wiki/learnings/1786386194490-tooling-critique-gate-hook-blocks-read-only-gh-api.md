---
title: "[tooling] critique-gate hook blocks READ-ONLY `gh api .../pulls/...` GETs — use gh pr view/diff or graphql"
type: learning
topic: agent-ops
source: learnings/1786386194490-tooling-critique-gate-hook-blocks-read-only-gh-api.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786386194490-tooling-critique-gate-hook-blocks-read-only-gh-api.md`_

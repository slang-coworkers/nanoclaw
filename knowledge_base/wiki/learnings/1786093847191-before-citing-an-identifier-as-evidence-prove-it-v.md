---
title: "Before citing an identifier as evidence, prove it varies (cross-repo dispatch head_sha is a constant)"
type: learning
topic: ci-tooling
source: learnings/1786093847191-before-citing-an-identifier-as-evidence-prove-it-v.md
---
...
---
_Topic: [CI, build & tooling](wiki/topics/ci-tooling.md) · [catalog](wiki/index.md) · source: `sources/learnings/1786093847191-before-citing-an-identifier-as-evidence-prove-it-v.md`_

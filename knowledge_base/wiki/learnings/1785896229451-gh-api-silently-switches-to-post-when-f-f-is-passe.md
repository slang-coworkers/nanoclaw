---
title: "gh api silently switches to POST when -F/-f is passed without -X GET"
type: learning
topic: misc
source: learnings/1785896229451-gh-api-silently-switches-to-post-when-f-f-is-passe.md
---

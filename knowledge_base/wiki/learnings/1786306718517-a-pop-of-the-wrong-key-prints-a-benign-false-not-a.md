---
title: "A pop() of the wrong key prints a benign False, not an error — verify which mark key an entry actually carries"
type: learning
topic: verification
source: learnings/1786306718517-a-pop-of-the-wrong-key-prints-a-benign-false-not-a.md
---

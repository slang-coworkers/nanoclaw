---
title: "slangi VM printf fixes: new regression test can pass without guarding the emitter-side operand-size change"
type: learning
topic: slang-compiler
source: learnings/1788902064424-slangi-vm-printf-fixes-new-regression-test-can-pas.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788902064424-slangi-vm-printf-fixes-new-regression-test-can-pas.md`_

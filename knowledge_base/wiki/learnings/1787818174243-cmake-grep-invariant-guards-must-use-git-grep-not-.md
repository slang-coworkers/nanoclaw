---
title: "CMake grep-invariant guards must use git grep, not rg/grep -r (submodule descent)"
type: learning
topic: ci-tooling
source: learnings/1787818174243-cmake-grep-invariant-guards-must-use-git-grep-not-.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1787818174243-cmake-grep-invariant-guards-must-use-git-grep-not-.md`_

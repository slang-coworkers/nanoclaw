---
title: "Verify a 'green once PR X lands' dependency by applying X's actual diff — #12935 is insufficient for genuinely-multi-type is/as (#13261)"
type: learning
topic: ci-tooling
source: learnings/1790318063842-verify-a-green-once-pr-x-lands-dependency-by-apply.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1790318063842-verify-a-green-once-pr-x-lands-dependency-by-apply.md`_

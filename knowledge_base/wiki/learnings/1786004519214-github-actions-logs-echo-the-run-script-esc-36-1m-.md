---
title: "GitHub Actions logs echo the run: script — ESC[36;1m lines are source, not output"
type: learning
topic: misc
source: learnings/1786004519214-github-actions-logs-echo-the-run-script-esc-36-1m-.md
---
...
---
_Topic: [Uncategorized](wiki/topics/misc.md) · [catalog](wiki/index.md) · source: `sources/learnings/1786004519214-github-actions-logs-echo-the-run-script-esc-36-1m-.md`_

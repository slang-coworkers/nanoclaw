---
title: "slang-test runs tests in its own order, not argv order — an ordering drill needs -explicit-test-order"
type: learning
topic: slang-compiler
source: learnings/1786307890574-slang-test-runs-tests-in-its-own-order-not-argv-or.md
---

---
title: "gh run rerun --failed is blocked while a bot-PR CI run waits on the priority-yield gate"
type: learning
topic: agent-ops
source: learnings/1789265883183-gh-run-rerun-failed-is-blocked-while-a-bot-pr-ci-r.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789265883183-gh-run-rerun-failed-is-blocked-while-a-bot-pr-ci-r.md`_

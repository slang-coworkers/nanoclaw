---
title: "Delivery gate counts ANY file edit — update memory/notes before the final OUTPUT critique"
type: learning
topic: agent-ops
source: learnings/1789554373150-delivery-gate-counts-any-file-edit-update-memory-n.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789554373150-delivery-gate-counts-any-file-edit-update-memory-n.md`_

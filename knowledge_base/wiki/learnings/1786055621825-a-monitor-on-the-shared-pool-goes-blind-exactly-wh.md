---
title: "A monitor on the shared pool goes blind exactly when it matters — check the platform status page first"
type: learning
topic: misc
source: learnings/1786055621825-a-monitor-on-the-shared-pool-goes-blind-exactly-wh.md
---

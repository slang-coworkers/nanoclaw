---
title: "Correction: gh CLI App-installation token is fine for actions/PR endpoints — don't over-generalize from auth-status/rate_limit failures"
type: learning
topic: ci-tooling
source: learnings/1788205146208-correction-gh-cli-app-installation-token-is-fine-f.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1788205146208-correction-gh-cli-app-installation-token-is-fine-f.md`_

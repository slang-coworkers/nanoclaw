---
title: "slang-test runs FileCheck internally — no external FileCheck binary needed"
type: learning
topic: slang-compiler
source: learnings/1786715257186-slang-test-runs-filecheck-internally-no-external-f.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786715257186-slang-test-runs-filecheck-internally-no-external-f.md`_

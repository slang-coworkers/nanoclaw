---
title: "SlangPy CPU backend: zero device dispatch limit breaks all dispatches (slangpy#1136)"
type: learning
topic: slang-compiler
source: learnings/1788474155417-slangpy-cpu-backend-zero-device-dispatch-limit-bre.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788474155417-slangpy-cpu-backend-zero-device-dispatch-limit-bre.md`_

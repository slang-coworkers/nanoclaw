---
title: "gh api contents/ path prefix mismatch caused a silent false-negative in a bash loop"
type: learning
topic: misc
source: learnings/1787993108357-gh-api-contents-path-prefix-mismatch-caused-a-sile.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787993108357-gh-api-contents-path-prefix-mismatch-caused-a-sile.md`_

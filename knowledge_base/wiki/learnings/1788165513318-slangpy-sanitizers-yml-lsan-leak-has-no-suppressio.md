---
title: "slangpy sanitizers.yml LSan leak has no suppression path; the cycle is in the Python cache layer, not the C++ m_args graph"
type: learning
topic: slang-compiler
source: learnings/1788165513318-slangpy-sanitizers-yml-lsan-leak-has-no-suppressio.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788165513318-slangpy-sanitizers-yml-lsan-leak-has-no-suppressio.md`_

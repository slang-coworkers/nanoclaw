---
title: "Phantom red variant 2: SAME-event duplicate check-suites defeat 'prefer the pull_request suite' — created_at is the only load-bearing rule"
type: learning
topic: misc
source: learnings/1785817670285-phantom-red-variant-2-same-event-duplicate-check-s.md
---

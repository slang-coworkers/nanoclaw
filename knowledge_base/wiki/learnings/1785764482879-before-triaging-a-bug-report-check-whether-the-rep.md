---
title: "Before triaging a bug report, check whether the reporter's version predates the fix (git tag --contains)"
type: learning
topic: misc
source: learnings/1785764482879-before-triaging-a-bug-report-check-whether-the-rep.md
---

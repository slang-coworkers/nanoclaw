---
title: "An overlap ZERO is a timestamp, not a property — recompute on every BEHIND nudge (5-day expiry, measured)"
type: learning
topic: misc
source: learnings/1786454983376-an-overlap-zero-is-a-timestamp-not-a-property-reco.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786454983376-an-overlap-zero-is-a-timestamp-not-a-property-reco.md`_

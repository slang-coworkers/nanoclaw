---
title: "Excluding a class from Slang's single-arg coercion fast-path: narrow to construction only (new OR differing-arg-type), not blanket"
type: learning
topic: slang-compiler
source: learnings/1786592881454-excluding-a-class-from-slang-s-single-arg-coercion.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786592881454-excluding-a-class-from-slang-s-single-arg-coercion.md`_

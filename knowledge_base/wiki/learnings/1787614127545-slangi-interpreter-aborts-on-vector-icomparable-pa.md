---
title: "slangi interpreter aborts on vector IComparable path — use -cpu COMPARE_COMPUTE to repro generic comparison bugs"
type: learning
topic: slang-compiler
source: learnings/1787614127545-slangi-interpreter-aborts-on-vector-icomparable-pa.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787614127545-slangi-interpreter-aborts-on-vector-icomparable-pa.md`_

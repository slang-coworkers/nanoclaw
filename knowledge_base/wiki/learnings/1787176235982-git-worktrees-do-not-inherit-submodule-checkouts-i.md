---
title: "Git worktrees do not inherit submodule checkouts — init them before CMake configure"
type: learning
topic: ci-tooling
source: learnings/1787176235982-git-worktrees-do-not-inherit-submodule-checkouts-i.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1787176235982-git-worktrees-do-not-inherit-submodule-checkouts-i.md`_

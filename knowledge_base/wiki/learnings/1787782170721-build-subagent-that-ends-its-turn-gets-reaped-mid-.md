---
title: "Build subagent that ends its turn gets reaped mid-build → stale zero-byte .so → objcopy empty-file FAILED"
type: learning
topic: ci-tooling
source: learnings/1787782170721-build-subagent-that-ends-its-turn-gets-reaped-mid-.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1787782170721-build-subagent-that-ends-its-turn-gets-reaped-mid-.md`_

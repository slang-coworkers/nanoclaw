---
title: "Verify 'separate findings' on the SAME toolchain as the PR head — stale local checkout can produce phantom bugs"
type: learning
topic: verification
source: learnings/1788483703122-verify-separate-findings-on-the-same-toolchain-as-.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1788483703122-verify-separate-findings-on-the-same-toolchain-as-.md`_

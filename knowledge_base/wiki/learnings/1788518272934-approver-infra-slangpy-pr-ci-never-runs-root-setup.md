---
title: "[approver/infra] slangpy PR CI never runs root setup.py (CMake build); + CodeRabbit re-reviews in-place — read coveredCommitId, and settle-watch head storms"
type: learning
topic: ci-tooling
source: learnings/1788518272934-approver-infra-slangpy-pr-ci-never-runs-root-setup.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1788518272934-approver-infra-slangpy-pr-ci-never-runs-root-setup.md`_

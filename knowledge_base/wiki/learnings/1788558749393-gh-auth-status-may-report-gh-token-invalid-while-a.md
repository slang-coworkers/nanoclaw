---
title: "gh auth status may report GH_TOKEN invalid while API reads still work"
type: learning
topic: misc
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788558749393-gh-auth-status-may-report-gh-token-invalid-while-a.md`_

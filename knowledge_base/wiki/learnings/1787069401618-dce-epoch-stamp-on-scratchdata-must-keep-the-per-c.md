---
title: "DCE epoch-stamp on scratchData must keep the per-call zeroing (serialize-ir stores unbounded indices)"
type: learning
topic: misc
source: learnings/1787069401618-dce-epoch-stamp-on-scratchdata-must-keep-the-per-c.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787069401618-dce-epoch-stamp-on-scratchdata-must-keep-the-per-c.md`_

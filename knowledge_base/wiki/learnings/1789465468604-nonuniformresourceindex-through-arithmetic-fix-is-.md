---
title: "NonUniformResourceIndex through arithmetic: fix is in the function-call specializer, not (only) the float pass"
type: learning
topic: ci-tooling
source: learnings/1789465468604-nonuniformresourceindex-through-arithmetic-fix-is-.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1789465468604-nonuniformresourceindex-through-arithmetic-fix-is-.md`_

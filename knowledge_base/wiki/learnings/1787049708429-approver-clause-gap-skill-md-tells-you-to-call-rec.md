---
title: "[approver/clause-gap] SKILL.md tells you to call record_human_verdict on pr_merged/pr_review, but that tool is NOT exposed — the host joins the outcome automatically"
type: learning
topic: review-approval
source: learnings/1787049708429-approver-clause-gap-skill-md-tells-you-to-call-rec.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787049708429-approver-clause-gap-skill-md-tells-you-to-call-rec.md`_

---
title: "Don't assert an absence you didn't run the probe for — truncated grep preview and skipped nvidia-smi both produced false negatives in one PR"
type: learning
topic: review-process
source: learnings/1787049086568-don-t-assert-an-absence-you-didn-t-run-the-probe-f.md
---
...
---
_Topic: [Review & process](../topics/review-process.md) · [catalog](../index.md) · source: `sources/learnings/1787049086568-don-t-assert-an-absence-you-didn-t-run-the-probe-f.md`_

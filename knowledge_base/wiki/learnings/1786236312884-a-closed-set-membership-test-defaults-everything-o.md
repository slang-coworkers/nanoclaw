---
title: "A closed-set membership test defaults everything outside the set to the OPPOSITE class — hardcoded `bot_logins` made every third-party bot a 'human' and fired false nudges"
type: learning
topic: misc
source: learnings/1786236312884-a-closed-set-membership-test-defaults-everything-o.md
---

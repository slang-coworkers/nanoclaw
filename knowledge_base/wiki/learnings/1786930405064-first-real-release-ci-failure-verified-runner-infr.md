---
title: "First real release CI failure verified — runner infra, not source; verification loop works unchanged on red runs"
type: learning
topic: ci-tooling
source: learnings/1786930405064-first-real-release-ci-failure-verified-runner-infr.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1786930405064-first-real-release-ci-failure-verified-runner-infr.md`_

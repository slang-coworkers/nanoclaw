---
title: "Issue may describe code that lives only in an unmerged PR — verify against the source PR branch, not just master"
type: learning
topic: verification
source: learnings/1787545144849-issue-may-describe-code-that-lives-only-in-an-unme.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1787545144849-issue-may-describe-code-that-lives-only-in-an-unme.md`_

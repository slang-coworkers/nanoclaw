---
title: "Slang hiddenFromLookup only affects local vars (member lookup ignores it)"
type: learning
topic: slang-compiler
source: learnings/1787706486418-slang-hiddenfromlookup-only-affects-local-vars-mem.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787706486418-slang-hiddenfromlookup-only-affects-local-vars-mem.md`_

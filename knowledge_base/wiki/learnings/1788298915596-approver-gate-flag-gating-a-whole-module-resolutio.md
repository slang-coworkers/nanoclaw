---
title: "[approver/gate-flag] Gating a whole-module resolution pass on a scan-computed RequiredLoweringPassSet flag risks skipping it for IR that materializes AFTER the scan (lazy generic clones / dynamic conformances)"
type: learning
topic: slang-compiler
source: learnings/1788298915596-approver-gate-flag-gating-a-whole-module-resolutio.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788298915596-approver-gate-flag-gating-a-whole-module-resolutio.md`_

---
title: "[approver/human-disagreement] #12794 ABSTAIN(OPEN_GAP) overruled by clean merge — a best-effort producer path with silent fall-through is itself evidence the un-asserted output is incidental"
type: learning
topic: review-approval
source: learnings/1787840426446-approver-human-disagreement-12794-abstain-open-gap.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787840426446-approver-human-disagreement-12794-abstain-open-gap.md`_

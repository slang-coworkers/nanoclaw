---
title: "[approver/infra-abstain] devin-fetch.sh emits an EMPTY Flags section on a FLAGGED review — innerText comes back JSON-escaped, so the splitter never matches"
type: learning
topic: review-process
source: learnings/1786386045220-approver-infra-abstain-devin-fetch-sh-emits-an-emp.md
---
...
---
_Topic: [Review & process](../topics/review-process.md) · [catalog](../index.md) · source: `sources/learnings/1786386045220-approver-infra-abstain-devin-fetch-sh-emits-an-emp.md`_

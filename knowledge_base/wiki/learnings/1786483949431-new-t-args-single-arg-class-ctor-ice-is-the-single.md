---
title: "new-T-args single-arg class ctor ICE is the single-arg coercion special case, not new"
type: learning
topic: ci-tooling
source: learnings/1786483949431-new-t-args-single-arg-class-ctor-ice-is-the-single.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1786483949431-new-t-args-single-arg-class-ctor-ice-is-the-single.md`_

---
title: "A test workaround can be masking an upstream over-fire — ask which artifact the code believed it was validating"
type: learning
topic: misc
source: learnings/1785997176542-a-test-workaround-can-be-masking-an-upstream-over-.md
---

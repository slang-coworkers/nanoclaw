---
title: "Slang bindless heap binding indices are preset-fixed, not CLI-configurable"
type: learning
topic: slang-compiler
source: learnings/1789582349574-slang-bindless-heap-binding-indices-are-preset-fix.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789582349574-slang-bindless-heap-binding-indices-are-preset-fix.md`_

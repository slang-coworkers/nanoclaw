---
title: "A GHA rerun mutates the SAME run id — comparing run ids across ticks cannot detect a re-dispatch; key on (databaseId, run_attempt)"
type: learning
topic: misc
source: learnings/1786454704637-a-gha-rerun-mutates-the-same-run-id-comparing-run-.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786454704637-a-gha-rerun-mutates-the-same-run-id-comparing-run-.md`_

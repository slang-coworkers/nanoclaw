---
title: "[approver/infra-abstain] An EMPTY policy mount is an infra regression, not a policy change — decide under last-known-good signed policy + escalate, don't silently obey the bundled conservative default"
type: learning
topic: review-approval
source: learnings/1788294009551-approver-infra-abstain-an-empty-policy-mount-is-an.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788294009551-approver-infra-abstain-an-empty-policy-mount-is-an.md`_

---
title: "Slang class types can't run under -cpu COMPARE_COMPUTE or slangi; use EXECUTABLE; and single-arg class ctor coercion trap"
type: learning
topic: slang-compiler
source: learnings/1786587930985-slang-class-types-can-t-run-under-cpu-compare-comp.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786587930985-slang-class-types-can-t-run-under-cpu-compare-comp.md`_

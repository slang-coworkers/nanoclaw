---
title: "Slang: a new statement keyword can't dispatch on leading tokens — keywords are shadowable, so tentative-parse to a unique discriminator"
type: learning
topic: slang-compiler
source: learnings/1787605380180-slang-a-new-statement-keyword-can-t-dispatch-on-le.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787605380180-slang-a-new-statement-keyword-can-t-dispatch-on-le.md`_

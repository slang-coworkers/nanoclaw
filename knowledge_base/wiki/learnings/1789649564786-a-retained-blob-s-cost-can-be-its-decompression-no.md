---
title: "A retained blob's cost can be its decompression, not its retention (Slang RiffFileSystem)"
type: learning
topic: slang-compiler
source: learnings/1789649564786-a-retained-blob-s-cost-can-be-its-decompression-no.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789649564786-a-retained-blob-s-cost-can-be-its-decompression-no.md`_

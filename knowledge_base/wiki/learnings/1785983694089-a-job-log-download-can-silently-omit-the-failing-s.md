---
title: "A job-log download can silently omit the failing step: read step conclusions, not just the log body"
type: learning
topic: agent-ops
source: learnings/1785983694089-a-job-log-download-can-silently-omit-the-failing-s.md
---

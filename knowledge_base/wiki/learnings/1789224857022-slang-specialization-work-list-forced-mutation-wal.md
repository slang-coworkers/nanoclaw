---
title: "Slang specialization work list: forced (mutation) walk stops on workListSet, not the `expanded` memo"
type: learning
topic: slang-compiler
source: learnings/1789224857022-slang-specialization-work-list-forced-mutation-wal.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789224857022-slang-specialization-work-list-forced-mutation-wal.md`_

---
title: "[approver/challenger] WebFetch silently FOLLOWS same-host 302s — verify any 'URL X serves page Y' route claim with curl -D - (no-follow), not WebFetch"
type: learning
topic: review-approval
source: learnings/1786990448164-approver-challenger-webfetch-silently-follows-same.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786990448164-approver-challenger-webfetch-silently-follows-same.md`_

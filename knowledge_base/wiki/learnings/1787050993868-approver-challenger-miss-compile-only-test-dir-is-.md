---
title: "[approver/challenger-miss] 'compile-only test dir' is a checkable claim, not an assumption — verify the actual TEST directives"
type: learning
topic: verification
source: learnings/1787050993868-approver-challenger-miss-compile-only-test-dir-is-.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1787050993868-approver-challenger-miss-compile-only-test-dir-is-.md`_

---
title: "CUDA surface stride + format-through-param is compile-time verifiable and structurally documented"
type: learning
topic: misc
source: learnings/1787665524776-cuda-surface-stride-format-through-param-is-compil.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787665524776-cuda-surface-stride-format-through-param-is-compil.md`_

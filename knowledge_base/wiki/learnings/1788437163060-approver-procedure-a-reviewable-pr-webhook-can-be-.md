---
title: "[approver/procedure] A reviewable-PR webhook can be stale — check live PR state before spending review budget"
type: learning
topic: agent-ops
source: learnings/1788437163060-approver-procedure-a-reviewable-pr-webhook-can-be-.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1788437163060-approver-procedure-a-reviewable-pr-webhook-can-be-.md`_

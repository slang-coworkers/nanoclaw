---
title: "[approver/infra-abstain] Devin partial-render is a devin-fetch.sh limitation on large PRs — prompt-level 'wait' does not fix it; cross-check max line-ref every run"
type: learning
topic: review-approval
source: learnings/1788792549825-approver-infra-abstain-devin-partial-render-is-a-d.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788792549825-approver-infra-abstain-devin-partial-render-is-a-d.md`_

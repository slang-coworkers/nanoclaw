---
title: "Create symlinks (AGENTS.md→CLAUDE.md, .agents→.claude) in group folders for Codex agents so the Codex CLI natively discovers our skills. Prefer letting the harness pick them up over overriding developer instructions."
type: learning
topic: agent-ops
source: learnings/legoop-feedback_codex_symlinks_for_skills.md
---
...
---
_Topic: [[wiki/topics/agent-ops.md]] · catalog: [[wiki/index.md]] · source: `sources/learnings/legoop-feedback_codex_symlinks_for_skills.md`_

---
title: "[approver/challenger-calibration] VM-emit missing-constant fix: a bundled test-assertion change is un-masking, verify vs core-module source not scope-creep"
type: learning
topic: review-approval
source: learnings/1786546050952-approver-challenger-calibration-vm-emit-missing-co.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786546050952-approver-challenger-calibration-vm-emit-missing-co.md`_

---
title: "[approver/process] On a merge-only synchronize, settle a prior gap by BLOB IDENTITY of the decisive files, not a rebuild"
type: learning
topic: ci-tooling
source: learnings/1787668555293-approver-process-on-a-merge-only-synchronize-settl.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1787668555293-approver-process-on-a-merge-only-synchronize-settl.md`_

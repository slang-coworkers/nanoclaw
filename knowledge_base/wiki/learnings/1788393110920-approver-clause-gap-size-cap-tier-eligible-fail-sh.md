---
title: "[approver/clause-gap] Size-cap (tier_eligible) FAIL short-circuits before verdict parse — an oversized PR with a 🔴 bug records ABSTAIN, not BLOCK"
type: learning
topic: review-approval
source: learnings/1788393110920-approver-clause-gap-size-cap-tier-eligible-fail-sh.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788393110920-approver-clause-gap-size-cap-tier-eligible-fail-sh.md`_

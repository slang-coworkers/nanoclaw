---
title: "Review lens: AnyValue bulk-copy / empty-struct legalize fixes — check the target branch is numerically exercised, not just compiled"
type: learning
topic: ci-tooling
source: learnings/1788301928667-review-lens-anyvalue-bulk-copy-empty-struct-legali.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1788301928667-review-lens-anyvalue-bulk-copy-empty-struct-legali.md`_

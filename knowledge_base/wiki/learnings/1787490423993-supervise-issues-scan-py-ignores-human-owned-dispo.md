---
title: "supervise-issues scan.py ignores human-owned disposition on ball==ours"
type: learning
topic: agent-ops
source: learnings/1787490423993-supervise-issues-scan-py-ignores-human-owned-dispo.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787490423993-supervise-issues-scan-py-ignores-human-owned-dispo.md`_

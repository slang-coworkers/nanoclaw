---
title: "[approver/infra-abstain] record_decision returns 'Decision recorded' before the writer gate — the ack is emission-only, and a silent non-denial is NOT a successful write"
type: learning
topic: review-approval
source: learnings/1786361652051-approver-infra-abstain-record-decision-returns-dec.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786361652051-approver-infra-abstain-record-decision-returns-dec.md`_

---
title: "GitHub Actions conclusion=action_required is an approval GATE, not a failure — bucket it as a fifth state"
type: learning
topic: agent-ops
source: learnings/1786327920887-github-actions-conclusion-action-required-is-an-ap.md
---

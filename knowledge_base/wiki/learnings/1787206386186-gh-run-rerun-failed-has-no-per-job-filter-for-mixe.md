---
title: "gh run rerun --failed has no per-job filter for mixed intermittent+legitimate failures"
type: learning
topic: misc
source: learnings/1787206386186-gh-run-rerun-failed-has-no-per-job-filter-for-mixe.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787206386186-gh-run-rerun-failed-has-no-per-job-filter-for-mixe.md`_

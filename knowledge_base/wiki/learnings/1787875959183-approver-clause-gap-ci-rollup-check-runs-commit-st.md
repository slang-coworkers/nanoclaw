---
title: "[approver/clause-gap] CI rollup: check-runs != commit statuses — read BOTH before any green-CI claim"
type: learning
topic: review-approval
source: learnings/1787875959183-approver-clause-gap-ci-rollup-check-runs-commit-st.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787875959183-approver-clause-gap-ci-rollup-check-runs-commit-st.md`_

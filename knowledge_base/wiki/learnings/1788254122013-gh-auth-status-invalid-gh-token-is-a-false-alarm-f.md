---
title: "gh auth status 'invalid GH_TOKEN' is a false alarm for read-only pr-mode reviews"
type: learning
topic: review-process
source: learnings/1788254122013-gh-auth-status-invalid-gh-token-is-a-false-alarm-f.md
---
...
---
_Topic: [Review & process](../topics/review-process.md) · [catalog](../index.md) · source: `sources/learnings/1788254122013-gh-auth-status-invalid-gh-token-is-a-false-alarm-f.md`_

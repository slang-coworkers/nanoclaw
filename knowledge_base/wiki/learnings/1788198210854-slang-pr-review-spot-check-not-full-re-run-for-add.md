---
title: "Slang PR review: spot-check (not full re-run) for additive nit-fixes, and diff_hash goes stale for the approver"
type: learning
topic: slang-compiler
source: learnings/1788198210854-slang-pr-review-spot-check-not-full-re-run-for-add.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788198210854-slang-pr-review-spot-check-not-full-re-run-for-add.md`_

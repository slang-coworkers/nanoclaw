---
title: "Grep the FAILURE token, never the resource name — ports.ubuntu.com appears in every healthy apt-get update"
type: learning
topic: misc
source: learnings/1786366839960-grep-the-failure-token-never-the-resource-name-por.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786366839960-grep-the-failure-token-never-the-resource-name-por.md`_

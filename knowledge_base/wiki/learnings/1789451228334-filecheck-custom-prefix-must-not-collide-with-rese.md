---
title: "FileCheck custom prefix must not collide with reserved CHECK suffixes (CHECK-EMPTY etc.)"
type: learning
topic: misc
source: learnings/1789451228334-filecheck-custom-prefix-must-not-collide-with-rese.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1789451228334-filecheck-custom-prefix-must-not-collide-with-rese.md`_

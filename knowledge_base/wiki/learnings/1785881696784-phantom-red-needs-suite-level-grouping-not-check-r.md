---
title: "Phantom-red needs SUITE-level grouping, not check-run-name grouping"
type: learning
topic: misc
source: learnings/1785881696784-phantom-red-needs-suite-level-grouping-not-check-r.md
---

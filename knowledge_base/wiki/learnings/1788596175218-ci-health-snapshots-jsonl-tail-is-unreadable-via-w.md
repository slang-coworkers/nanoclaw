---
title: "CI health_snapshots.jsonl tail is unreadable via WebFetch — returns stale top-of-file lines"
type: learning
topic: ci-tooling
source: learnings/1788596175218-ci-health-snapshots-jsonl-tail-is-unreadable-via-w.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1788596175218-ci-health-snapshots-jsonl-tail-is-unreadable-via-w.md`_

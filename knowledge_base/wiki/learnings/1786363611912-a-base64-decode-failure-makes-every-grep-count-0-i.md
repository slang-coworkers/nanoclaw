---
title: "A base64-decode failure makes every grep count 0, including the must-hit control"
type: learning
topic: agent-ops
source: learnings/1786363611912-a-base64-decode-failure-makes-every-grep-count-0-i.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786363611912-a-base64-decode-failure-makes-every-grep-count-0-i.md`_

---
title: "classify-only subagent misattributed a cross-repo SlangPy Tests failure to the wrong Slang PR"
type: learning
topic: slang-compiler
source: learnings/1790266311097-classify-only-subagent-misattributed-a-cross-repo-.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1790266311097-classify-only-subagent-misattributed-a-cross-repo-.md`_

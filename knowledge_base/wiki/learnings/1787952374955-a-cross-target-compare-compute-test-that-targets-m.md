---
title: "A cross-target COMPARE_COMPUTE test that targets -mtl must not contain a double case; locally-ignored mtl subtests hide it"
type: learning
topic: misc
source: learnings/1787952374955-a-cross-target-compare-compute-test-that-targets-m.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787952374955-a-cross-target-compare-compute-test-that-targets-m.md`_

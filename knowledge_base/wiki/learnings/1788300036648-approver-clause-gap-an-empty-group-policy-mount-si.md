---
title: "[approver/clause-gap] An empty group policy mount silently downgrades a substantive OPEN_GAP to a bare eligibility CLAUSE_FAIL — the fallback isn't just 'conservative', it discards the more-informative signal"
type: learning
topic: review-approval
source: learnings/1788300036648-approver-clause-gap-an-empty-group-policy-mount-si.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788300036648-approver-clause-gap-an-empty-group-policy-mount-si.md`_

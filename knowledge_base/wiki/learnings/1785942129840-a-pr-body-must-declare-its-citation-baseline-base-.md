---
title: "A PR body must declare its citation baseline — base-vs-branch line offsets caused four false corrections in one review"
type: learning
topic: ci-tooling
source: learnings/1785942129840-a-pr-body-must-declare-its-citation-baseline-base-.md
---
...
---
_Topic: [CI, build & tooling](wiki/topics/ci-tooling.md) · [catalog](wiki/index.md) · source: `sources/learnings/1785942129840-a-pr-body-must-declare-its-citation-baseline-base-.md`_

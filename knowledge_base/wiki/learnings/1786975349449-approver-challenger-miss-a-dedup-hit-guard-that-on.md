---
title: "[approver/challenger-miss] A dedup-hit guard that only picks a GVN survivor is symptom-only — clear it against a TRANSFORMING variant, not just the equivalence repro"
type: learning
topic: review-approval
source: learnings/1786975349449-approver-challenger-miss-a-dedup-hit-guard-that-on.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786975349449-approver-challenger-miss-a-dedup-hit-guard-that-on.md`_

---
title: "Verify a PR fix on a build FROM the PR head, with master as control — worktree needs submodule init"
type: learning
topic: ci-tooling
source: learnings/1787626975022-verify-a-pr-fix-on-a-build-from-the-pr-head-with-m.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1787626975022-verify-a-pr-fix-on-a-build-from-the-pr-head-with-m.md`_

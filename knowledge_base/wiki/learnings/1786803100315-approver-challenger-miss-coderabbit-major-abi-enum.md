---
title: "[approver/challenger-miss] CodeRabbit 'Major' ABI/enum findings can be false positives — verify enum-insertion claims against the actual diff hunk"
type: learning
topic: verification
source: learnings/1786803100315-approver-challenger-miss-coderabbit-major-abi-enum.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1786803100315-approver-challenger-miss-coderabbit-major-abi-enum.md`_

---
title: "[approver/clause-gap] website-repo conf.py linkcheck diff is OUT_OF_SCOPE:website-build-config not :website-content"
type: learning
topic: review-approval
source: learnings/1787783167738-approver-clause-gap-website-repo-conf-py-linkcheck.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787783167738-approver-clause-gap-website-repo-conf-py-linkcheck.md`_

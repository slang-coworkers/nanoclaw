---
title: "Witness tables can legitimately have duplicate requirement keys (autodiff DiffPair path) — do not assert uniqueness"
type: learning
topic: slang-compiler
source: learnings/1786802981602-witness-tables-can-legitimately-have-duplicate-req.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786802981602-witness-tables-can-legitimately-have-duplicate-req.md`_

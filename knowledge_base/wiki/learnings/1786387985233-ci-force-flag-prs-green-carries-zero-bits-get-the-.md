---
title: "CI force-flag PRs: green carries zero bits — get the runner-log token, on the SAME runner pool (`runs-on` is a request, `actions/jobs/<id>` is what ran)"
type: learning
topic: ci-tooling
source: learnings/1786387985233-ci-force-flag-prs-green-carries-zero-bits-get-the-.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1786387985233-ci-force-flag-prs-green-carries-zero-bits-get-the-.md`_

---
title: "Provisioning a per-coworker Claude Code subagent type (.claude/agents) in NanoClaw"
type: learning
topic: misc
source: learnings/1788288563386-provisioning-a-per-coworker-claude-code-subagent-t.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788288563386-provisioning-a-per-coworker-claude-code-subagent-t.md`_

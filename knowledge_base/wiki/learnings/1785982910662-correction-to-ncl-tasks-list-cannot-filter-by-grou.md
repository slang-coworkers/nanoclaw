---
title: "CORRECTION to 'ncl tasks list cannot filter by group' — `--group` errors loudly at group scope; only the non-existent `--agent-group-id` fails silently"
type: learning
topic: agent-ops
source: learnings/1785982910662-correction-to-ncl-tasks-list-cannot-filter-by-grou.md
---

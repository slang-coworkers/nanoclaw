---
title: "Orchestrator double-dispatch spawns duplicate fixer sessions on one branch"
type: learning
topic: agent-ops
source: learnings/1781117092067-orchestrator-double-dispatch-spawns-duplicate-fixe.md
---
...
## Detection
`ncl sessions list --agent-group <fixer-group>` → ≥2 `running` sessions on the same thread is the signature. Cross-check shared worktree + branch + staged-index mtimes.
...
---
_Topic: [[wiki/topics/agent-ops.md]] · catalog: [[wiki/index.md]] · source: `sources/learnings/1781117092067-orchestrator-double-dispatch-spawns-duplicate-fixe.md`_

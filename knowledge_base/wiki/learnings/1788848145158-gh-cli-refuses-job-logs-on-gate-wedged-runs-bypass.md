---
title: "gh CLI refuses job logs on gate-wedged runs — bypass via raw REST API curl"
type: learning
topic: agent-ops
source: learnings/1788848145158-gh-cli-refuses-job-logs-on-gate-wedged-runs-bypass.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1788848145158-gh-cli-refuses-job-logs-on-gate-wedged-runs-bypass.md`_

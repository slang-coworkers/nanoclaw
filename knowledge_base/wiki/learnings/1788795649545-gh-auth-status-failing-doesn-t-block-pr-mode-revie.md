---
title: "gh auth status failing doesn't block pr-mode reviews — gh pr diff/view still work on public repos"
type: learning
topic: review-process
source: learnings/1788795649545-gh-auth-status-failing-doesn-t-block-pr-mode-revie.md
---
...
---
_Topic: [Review & process](../topics/review-process.md) · [catalog](../index.md) · source: `sources/learnings/1788795649545-gh-auth-status-failing-doesn-t-block-pr-mode-revie.md`_

---
title: "WGSL emit has TWO type paths (_emitType routing vs emitSimpleTypeImpl naming) — a grep hit in one is not coverage in the other"
type: learning
topic: slang-compiler
source: learnings/1786706500522-wgsl-emit-has-two-type-paths-emittype-routing-vs-e.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786706500522-wgsl-emit-has-two-type-paths-emittype-routing-vs-e.md`_

---
title: "Inline-buffer over-read: validate copy length vs capacity, NOT offset+length"
type: learning
topic: ci-tooling
source: learnings/1789179069634-inline-buffer-over-read-validate-copy-length-vs-ca.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1789179069634-inline-buffer-over-read-validate-copy-length-vs-ca.md`_

---
title: "Referential errors need a namespace check, not more scepticism — and naming a blocker is not building the path around it"
type: learning
topic: ci-tooling
source: learnings/1786454756839-referential-errors-need-a-namespace-check-not-more.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1786454756839-referential-errors-need-a-namespace-check-not-more.md`_

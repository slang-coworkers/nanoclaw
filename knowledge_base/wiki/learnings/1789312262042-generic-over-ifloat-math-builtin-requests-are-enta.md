---
title: "Generic-over-IFloat math builtin requests are entangled with the min/max vector-ICE + autodiff-overload traps"
type: learning
topic: slang-compiler
source: learnings/1789312262042-generic-over-ifloat-math-builtin-requests-are-enta.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789312262042-generic-over-ifloat-math-builtin-requests-are-enta.md`_

---
title: "A reclaimable-state window is a BAND, not a deadline — and 'an open PR' suppressing a staleness detector is a structural blind spot, not a threshold"
type: learning
topic: verification
source: learnings/1786409172570-a-reclaimable-state-window-is-a-band-not-a-deadlin.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1786409172570-a-reclaimable-state-window-is-a-band-not-a-deadlin.md`_

---
title: "Reviewer A can silently do a static-only review — verify the build actually ran"
type: learning
topic: review-process
source: learnings/1787323074074-reviewer-a-can-silently-do-a-static-only-review-ve.md
---
...
---
_Topic: [Review & process](../topics/review-process.md) · [catalog](../index.md) · source: `sources/learnings/1787323074074-reviewer-a-can-silently-do-a-static-only-review-ve.md`_

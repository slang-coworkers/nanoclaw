---
title: "worktree GC PR-state must key on the worktree's actual branch, not the fix/issue-N convention"
type: learning
topic: misc
source: learnings/1786971355711-worktree-gc-pr-state-must-key-on-the-worktree-s-ac.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786971355711-worktree-gc-pr-state-must-key-on-the-worktree-s-ac.md`_

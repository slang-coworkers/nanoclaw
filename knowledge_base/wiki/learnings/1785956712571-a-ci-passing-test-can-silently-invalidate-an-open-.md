---
title: "A CI-passing test can silently invalidate an open bug report's headline"
type: learning
topic: ci-tooling
source: learnings/1785956712571-a-ci-passing-test-can-silently-invalidate-an-open-.md
---

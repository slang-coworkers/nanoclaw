---
title: "[approver/clause-gap] ci_green_on_sha reads combined-status only — blind to GitHub Actions check-runs (the real build matrix)"
type: learning
topic: ci-tooling
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1787045208678-approver-clause-gap-ci-green-on-sha-reads-combined.md`_

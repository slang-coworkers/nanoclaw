---
title: "[approver/challenger-miss] A REFERENTIAL failure is not an epistemic one — I misfiled a name-resolves-per-edge error as a trust error, and had the right rule in 7 files already"
type: learning
topic: review-approval
source: learnings/1786454639668-approver-challenger-miss-a-referential-failure-is-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786454639668-approver-challenger-miss-a-referential-failure-is-.md`_

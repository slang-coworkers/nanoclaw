---
title: "devin-fetch.sh emits an EMPTY Flags section with exit 0 — newline-escape mismatch, not a clean verdict"
type: learning
topic: review-process
source: learnings/1786376659246-devin-fetch-sh-emits-an-empty-flags-section-with-e.md
---
...
---
_Topic: [Review & process](../topics/review-process.md) · [catalog](../index.md) · source: `sources/learnings/1786376659246-devin-fetch-sh-emits-an-empty-flags-section-with-e.md`_

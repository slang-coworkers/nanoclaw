---
title: "supervisor pull-universe dropped comment body, starving the board-sync administrative-comment filter"
type: learning
topic: agent-ops
source: learnings/1786798462479-supervisor-pull-universe-dropped-comment-body-star.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786798462479-supervisor-pull-universe-dropped-comment-body-star.md`_

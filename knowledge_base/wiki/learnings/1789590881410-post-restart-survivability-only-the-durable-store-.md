---
title: "Post-restart survivability: only the durable store + GitHub persist — verify memory writes land on disk, ground timestamps with `date -u`, don't cite a prior session's message ids"
type: learning
topic: agent-ops
source: learnings/1789590881410-post-restart-survivability-only-the-durable-store-.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789590881410-post-restart-survivability-only-the-durable-store-.md`_

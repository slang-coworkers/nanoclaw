---
title: "[approver/infra-abstain] A dropped ledger row is not 'mostly abstains' — the attributed set was 2 approvals + 3 BLOCKs, and per-session counts are lower bounds by construction"
type: learning
topic: review-approval
source: learnings/1786431944573-approver-infra-abstain-a-dropped-ledger-row-is-not.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786431944573-approver-infra-abstain-a-dropped-ledger-row-is-not.md`_

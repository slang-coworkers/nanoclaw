---
title: "CORRECTION: slang-rhi Vulkan bindless uses a fused COMBINED_IMAGE_SAMPLER model (single .x), not a buggy missing-.y"
type: learning
topic: slang-compiler
source: learnings/1787796424823-correction-slang-rhi-vulkan-bindless-uses-a-fused-.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787796424823-correction-slang-rhi-vulkan-bindless-uses-a-fused-.md`_

---
title: "One PR can be the fix vehicle for multiple triaged issues → multiple fixer chains touch one branch"
type: learning
topic: agent-ops
source: learnings/1787779963798-one-pr-can-be-the-fix-vehicle-for-multiple-triaged.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787779963798-one-pr-can-be-the-fix-vehicle-for-multiple-triaged.md`_

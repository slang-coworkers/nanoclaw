---
title: "Arch-dependent wrong autodiff result → suspect the slangi VM (uninitialized working-set), not the transform"
type: learning
topic: slang-compiler
source: learnings/1788287604621-arch-dependent-wrong-autodiff-result-suspect-the-s.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788287604621-arch-dependent-wrong-autodiff-result-suspect-the-s.md`_

---
title: "Repeat-runs-at-fixed-SHA in GitHub Actions: two traps (workflow_dispatch ref, cancel-in-progress)"
type: learning
topic: misc
source: learnings/1785761300983-repeat-runs-at-fixed-sha-in-github-actions-two-tra.md
---

---
title: "Script-gated deferral tasks must distinguish 'condition not met' from 'probe failed' — verify with a deliberately-failing control before arming"
type: learning
topic: verification
source: learnings/1788432587694-script-gated-deferral-tasks-must-distinguish-condi.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1788432587694-script-gated-deferral-tasks-must-distinguish-condi.md`_

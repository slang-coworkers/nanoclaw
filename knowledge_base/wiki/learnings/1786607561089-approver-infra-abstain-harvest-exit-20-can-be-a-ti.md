---
title: "[approver/infra-abstain] harvest exit 20 can be a timing race — check for an in_progress `review` check-run before falling to Devin-only"
type: learning
topic: review-approval
source: learnings/1786607561089-approver-infra-abstain-harvest-exit-20-can-be-a-ti.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786607561089-approver-infra-abstain-harvest-exit-20-can-be-a-ti.md`_

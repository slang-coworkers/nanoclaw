---
title: "Switching a gate macro #ifdef→#if leaves stale prose; sweep comments+docs+PR-body"
type: learning
topic: agent-ops
source: learnings/1788296573909-switching-a-gate-macro-ifdef-if-leaves-stale-prose.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1788296573909-switching-a-gate-macro-ifdef-if-leaves-stale-prose.md`_

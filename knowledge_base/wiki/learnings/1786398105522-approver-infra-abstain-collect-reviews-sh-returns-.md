---
title: "[approver/infra-abstain] collect-reviews.sh returns spurious ABSTAIN_INFRA on any PR with >100 reviews — gh --paginate follows a Link header the OneCLI proxy won't credential"
type: learning
topic: review-approval
source: learnings/1786398105522-approver-infra-abstain-collect-reviews-sh-returns-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786398105522-approver-infra-abstain-collect-reviews-sh-returns-.md`_

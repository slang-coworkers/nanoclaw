---
title: "Supervisor thread-key regex is greedy — spine-sanctioned sub-threads parse to a nonexistent repo and report 'no public footprint'"
type: learning
topic: agent-ops
source: learnings/1786408898253-supervisor-thread-key-regex-is-greedy-spine-sancti.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786408898253-supervisor-thread-key-regex-is-greedy-spine-sancti.md`_

---
title: "[approver/challenger-confirmed] 'Pre-existing?' is settled by a base-blob diff, and it cuts BOTH ways — a refactor that preserves gating semantics doesn't own a latent bug it merely restructures"
type: learning
topic: review-approval
source: learnings/1786486818801-approver-challenger-confirmed-pre-existing-is-sett.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786486818801-approver-challenger-confirmed-pre-existing-is-sett.md`_

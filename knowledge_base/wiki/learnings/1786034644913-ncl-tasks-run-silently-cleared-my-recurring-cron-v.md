---
title: "`ncl tasks run` silently CLEARED my recurring cron — verify recurrence after any task write, not just the field you set"
type: learning
topic: agent-ops
source: learnings/1786034644913-ncl-tasks-run-silently-cleared-my-recurring-cron-v.md
---

---
title: "Windows _wstat64/File::exists on NUL returns _S_IFCHR, not _S_IFREG — getPathType(NUL) FAILs"
type: learning
topic: misc
source: learnings/1787277668063-windows-wstat64-file-exists-on-nul-returns-s-ifchr.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787277668063-windows-wstat64-file-exists-on-nul-returns-s-ifchr.md`_

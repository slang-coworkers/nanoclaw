---
title: "`ncl` does not support `--flag=value` syntax anywhere — use space-separated values; plus the final inert-flag spec"
type: learning
topic: agent-ops
source: learnings/1786243340982-ncl-does-not-support-flag-value-syntax-anywhere-us.md
---

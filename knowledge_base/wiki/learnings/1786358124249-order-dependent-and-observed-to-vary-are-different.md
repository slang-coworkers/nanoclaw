---
title: "'Order-dependent' and 'observed to vary' are different claims — prove the falsifiable one (input-order flip), not the dramatic one"
type: learning
topic: verification
source: learnings/1786358124249-order-dependent-and-observed-to-vary-are-different.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1786358124249-order-dependent-and-observed-to-vary-are-different.md`_

---
title: "Direct SPIR-V emits Patch decoration only for SV tess-factor builtins, not user per-patch varyings"
type: learning
topic: slang-compiler
source: learnings/1787638721070-direct-spir-v-emits-patch-decoration-only-for-sv-t.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787638721070-direct-spir-v-emits-patch-decoration-only-for-sv-t.md`_

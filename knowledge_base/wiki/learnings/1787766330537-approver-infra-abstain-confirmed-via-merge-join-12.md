---
title: "[approver/infra-abstain] CONFIRMED via merge join: #12666 NO_REVIEW_SIGNAL abstain → human APPROVED (predicted infra false-negative, 0 code misses across 3 abstains)"
type: learning
topic: review-approval
source: learnings/1787766330537-approver-infra-abstain-confirmed-via-merge-join-12.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787766330537-approver-infra-abstain-confirmed-via-merge-join-12.md`_

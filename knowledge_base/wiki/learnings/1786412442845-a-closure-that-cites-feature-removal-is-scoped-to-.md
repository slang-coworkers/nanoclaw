---
title: "A closure that cites feature removal is scoped to the versions that removed it — check the DEFAULT path before treating it as a dedup"
type: learning
topic: ci-tooling
source: learnings/1786412442845-a-closure-that-cites-feature-removal-is-scoped-to-.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1786412442845-a-closure-that-cites-feature-removal-is-scoped-to-.md`_

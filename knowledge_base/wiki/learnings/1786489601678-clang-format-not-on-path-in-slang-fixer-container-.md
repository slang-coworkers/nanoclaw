---
title: "clang-format not on PATH in slang-fixer container; pip-install 17.x per-session"
type: learning
topic: agent-ops
source: learnings/1786489601678-clang-format-not-on-path-in-slang-fixer-container-.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786489601678-clang-format-not-on-path-in-slang-fixer-container-.md`_

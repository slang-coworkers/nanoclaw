---
title: "test-falcor CI failures have multiple infra modes — re-read the fresh log each time, don't assume one cause"
type: learning
topic: ci-tooling
source: learnings/1788545708307-test-falcor-ci-failures-have-multiple-infra-modes-.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1788545708307-test-falcor-ci-failures-have-multiple-infra-modes-.md`_

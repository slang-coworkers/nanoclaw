---
title: "gh auth status 'invalid GH_TOKEN' is a false alarm for reads — don't abort a PR review on it"
type: learning
topic: review-process
source: learnings/1788307346773-gh-auth-status-invalid-gh-token-is-a-false-alarm-f.md
---
...
---
_Topic: [Review & process](../topics/review-process.md) · [catalog](../index.md) · source: `sources/learnings/1788307346773-gh-auth-status-invalid-gh-token-is-a-false-alarm-f.md`_

---
title: "A bite check asserting only 'impossible input → 0' certifies a dead filter — assert the WIDE case returns the baseline, or the control has no discriminating power"
type: learning
topic: misc
source: learnings/1786138391512-a-bite-check-asserting-only-impossible-input-0-cer.md
---

---
title: "[approver/challenger-miss] CI-coverage PRs: check the NEW jobs are green via check-runs, not folded /status"
type: learning
topic: review-approval
source: learnings/1786478437471-approver-challenger-miss-ci-coverage-prs-check-the.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786478437471-approver-challenger-miss-ci-coverage-prs-check-the.md`_

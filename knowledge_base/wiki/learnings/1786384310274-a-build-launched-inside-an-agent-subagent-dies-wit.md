---
title: "A build launched inside an Agent subagent dies with it — and ninja reports it as 'interrupted by user'"
type: learning
topic: ci-tooling
source: learnings/1786384310274-a-build-launched-inside-an-agent-subagent-dies-wit.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1786384310274-a-build-launched-inside-an-agent-subagent-dies-wit.md`_

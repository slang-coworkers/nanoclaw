---
title: "slangpy fix delivery: codex OUTPUT_REVIEW reads origin/main..HEAD, so COMMIT before reviewing; read the PINNED submodule not the main checkout"
type: learning
topic: slang-compiler
source: learnings/1789381460302-slangpy-fix-delivery-codex-output-review-reads-ori.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789381460302-slangpy-fix-delivery-codex-output-review-reads-ori.md`_

---
title: "[approver/infra-abstain] Record the ABSTAIN row LAST — the mechanical delivery gate can force a critique that flips the verdict AFTER the append-only write locks it"
type: learning
topic: review-approval
source: learnings/1787732678394-approver-infra-abstain-record-the-abstain-row-last.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787732678394-approver-infra-abstain-record-the-abstain-row-last.md`_

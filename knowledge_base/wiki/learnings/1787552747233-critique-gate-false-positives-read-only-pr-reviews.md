---
title: "Critique gate false-positives read-only PR reviews fetch as PR-creation"
type: learning
topic: agent-ops
source: learnings/1787552747233-critique-gate-false-positives-read-only-pr-reviews.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787552747233-critique-gate-false-positives-read-only-pr-reviews.md`_

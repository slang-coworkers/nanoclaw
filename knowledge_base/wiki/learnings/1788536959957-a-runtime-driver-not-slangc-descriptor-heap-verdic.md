---
title: "A 'runtime/driver, not slangc' descriptor-heap verdict can be reached BEFORE the GPU repro — and repro-blocker premises can be wrong"
type: learning
topic: slang-compiler
source: learnings/1788536959957-a-runtime-driver-not-slangc-descriptor-heap-verdic.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788536959957-a-runtime-driver-not-slangc-descriptor-heap-verdic.md`_

---
title: "A prefix-requiring grep recipe undercounts an id union the source text writes bare"
type: learning
topic: ci-tooling
source: learnings/1786402949849-a-prefix-requiring-grep-recipe-undercounts-an-id-u.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1786402949849-a-prefix-requiring-grep-recipe-undercounts-an-id-u.md`_

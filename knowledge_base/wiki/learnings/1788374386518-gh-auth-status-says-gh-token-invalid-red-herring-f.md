---
title: "`gh auth status` says 'GH_TOKEN invalid' — red herring for the nv-slang-bot app installation token"
type: learning
topic: slang-compiler
source: learnings/1788374386518-gh-auth-status-says-gh-token-invalid-red-herring-f.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788374386518-gh-auth-status-says-gh-token-invalid-red-herring-f.md`_

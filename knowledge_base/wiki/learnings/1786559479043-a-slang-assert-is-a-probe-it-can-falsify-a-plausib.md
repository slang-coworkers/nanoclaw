---
title: "A SLANG_ASSERT is a probe — it can falsify a plausible invariant in one build (VM operand .size is a recorded range, not natural size)"
type: learning
topic: slang-compiler
source: learnings/1786559479043-a-slang-assert-is-a-probe-it-can-falsify-a-plausib.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786559479043-a-slang-assert-is-a-probe-it-can-falsify-a-plausib.md`_

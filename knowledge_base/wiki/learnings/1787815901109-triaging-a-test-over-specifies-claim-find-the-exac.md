---
title: "Triaging a 'test over-specifies' claim: find the exact failing assertion line, then check which sibling assertion passed"
type: learning
topic: ci-tooling
source: learnings/1787815901109-triaging-a-test-over-specifies-claim-find-the-exac.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1787815901109-triaging-a-test-over-specifies-claim-find-the-exac.md`_

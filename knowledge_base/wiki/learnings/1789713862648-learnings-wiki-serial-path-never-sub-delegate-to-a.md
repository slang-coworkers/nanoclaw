---
title: "learnings-wiki serial path: never sub-delegate to a fork; forks re-enact the orchestrator and burn ~1M tokens"
type: learning
topic: agent-ops
source: learnings/1789713862648-learnings-wiki-serial-path-never-sub-delegate-to-a.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789713862648-learnings-wiki-serial-path-never-sub-delegate-to-a.md`_

---
title: "Rich diagnostics emit a separate span row; exhaustive DIAGNOSTIC_TEST must annotate it (dedup needs identical text)"
type: learning
topic: misc
source: learnings/1787794172021-rich-diagnostics-emit-a-separate-span-row-exhausti.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787794172021-rich-diagnostics-emit-a-separate-span-row-exhausti.md`_

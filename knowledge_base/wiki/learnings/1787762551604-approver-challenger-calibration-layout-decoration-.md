---
title: "[approver/challenger-calibration] Layout-decoration PR: the deterministic FileCheck emission test IS the trigger-present control — check it distinguishes live-from-dead before clearing a 'GPU-only test' gap"
type: learning
topic: review-approval
source: learnings/1787762551604-approver-challenger-calibration-layout-decoration-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787762551604-approver-challenger-calibration-layout-decoration-.md`_

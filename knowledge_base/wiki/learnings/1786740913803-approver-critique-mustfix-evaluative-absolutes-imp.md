---
title: "[approver/critique-mustfix] Evaluative absolutes ('improvement'/'no new risk') on an un-regression-tested change are OUTPUT_REVIEW must-fixes; and codex attesting a volatile file falsely trips the delivery gate"
type: learning
topic: review-approval
source: learnings/1786740913803-approver-critique-mustfix-evaluative-absolutes-imp.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786740913803-approver-critique-mustfix-evaluative-absolutes-imp.md`_

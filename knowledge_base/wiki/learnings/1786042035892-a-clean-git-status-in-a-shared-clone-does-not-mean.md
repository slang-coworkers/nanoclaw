---
title: "A clean git status in a shared clone does not mean your patch is still there — diff the hunk, not the status"
type: learning
topic: misc
source: learnings/1786042035892-a-clean-git-status-in-a-shared-clone-does-not-mean.md
---

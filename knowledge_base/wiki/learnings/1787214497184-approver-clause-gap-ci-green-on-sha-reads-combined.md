---
title: "[approver/clause-gap] ci_green_on_sha reads combined status, blind to build check-runs"
type: learning
topic: ci-tooling
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1787214497184-approver-clause-gap-ci-green-on-sha-reads-combined.md`_

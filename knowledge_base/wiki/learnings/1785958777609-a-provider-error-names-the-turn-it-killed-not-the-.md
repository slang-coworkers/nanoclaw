---
title: "A provider error names the turn it killed, not the state of the task"
type: learning
topic: misc
source: learnings/1785958777609-a-provider-error-names-the-turn-it-killed-not-the-.md
---

---
title: "A CI-failure signature changes between ticks — reclassify from the failed JOBS, never from your stored verdict"
type: learning
topic: ci-tooling
source: learnings/1786021291273-a-ci-failure-signature-changes-between-ticks-recla.md
---

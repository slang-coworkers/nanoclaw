---
title: "clang-format for slang: 17.x ONLY (repo docs say 17-18 and are wrong) — install via venv, PEP 668 blocks system pip"
type: learning
topic: slang-compiler
source: learnings/1786381193362-clang-format-for-slang-17-x-only-repo-docs-say-17-.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786381193362-clang-format-for-slang-17-x-only-repo-docs-say-17-.md`_

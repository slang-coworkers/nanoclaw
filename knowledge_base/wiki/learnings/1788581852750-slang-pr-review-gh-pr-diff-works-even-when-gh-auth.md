---
title: "slang PR review: gh pr diff works even when gh auth status shows invalid GH_TOKEN (OneCLI intercepts only gh api)"
type: learning
topic: slang-compiler
source: learnings/1788581852750-slang-pr-review-gh-pr-diff-works-even-when-gh-auth.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788581852750-slang-pr-review-gh-pr-diff-works-even-when-gh-auth.md`_

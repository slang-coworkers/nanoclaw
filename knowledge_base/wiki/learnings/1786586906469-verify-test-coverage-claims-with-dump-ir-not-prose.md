---
title: "Verify test COVERAGE claims with -dump-ir, not prose (slang diagnostic-walker tests)"
type: learning
topic: slang-compiler
source: learnings/1786586906469-verify-test-coverage-claims-with-dump-ir-not-prose.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786586906469-verify-test-coverage-claims-with-dump-ir-not-prose.md`_

---
title: "Before reporting an action blocked-on-approval, GREP THE POLICY STORE for that action's authority — I invented an operator gate that my own notes retired, and stalled a finished PR for 2 days"
type: learning
topic: agent-ops
source: learnings/1786451909191-before-reporting-an-action-blocked-on-approval-gre.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786451909191-before-reporting-an-action-blocked-on-approval-gre.md`_

---
title: "spirv_asm ErrorType leak = a warning-backed failed path slips past the error-count gate"
type: learning
topic: slang-compiler
source: learnings/1786527874805-spirv-asm-errortype-leak-a-warning-backed-failed-p.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786527874805-spirv-asm-errortype-leak-a-warning-backed-failed-p.md`_

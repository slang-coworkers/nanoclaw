---
title: "formatting.sh --check-only exit code is masked when piped to tail/head"
type: learning
topic: misc
source: learnings/1788327088692-formatting-sh-check-only-exit-code-is-masked-when-.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788327088692-formatting-sh-check-only-exit-code-is-masked-when-.md`_

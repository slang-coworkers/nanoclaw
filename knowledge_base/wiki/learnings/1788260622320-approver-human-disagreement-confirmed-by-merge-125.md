---
title: "[approver/human-disagreement] CONFIRMED by merge: #12503 shipped UNCHANGED at the exact ABSTAIN'd head — process-label-only abstains are over-conservative on code-correct PRs"
type: learning
topic: review-approval
source: learnings/1788260622320-approver-human-disagreement-confirmed-by-merge-125.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788260622320-approver-human-disagreement-confirmed-by-merge-125.md`_

---
title: "Shallow clone + a re-pointed FETCH_HEAD makes `git diff A..B` fail OPEN — a 9.2 MB diff of other PRs' commits that looks like your PR"
type: learning
topic: misc
source: learnings/1786387943319-shallow-clone-a-re-pointed-fetch-head-makes-git-di.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786387943319-shallow-clone-a-re-pointed-fetch-head-makes-git-di.md`_

---
title: "Adding a castAs capability interface to a downstream compiler: standalone (not ICastable) + serve from getObject"
type: learning
topic: slang-compiler
source: learnings/1788289363595-adding-a-castas-capability-interface-to-a-downstre.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788289363595-adding-a-castas-capability-interface-to-a-downstre.md`_

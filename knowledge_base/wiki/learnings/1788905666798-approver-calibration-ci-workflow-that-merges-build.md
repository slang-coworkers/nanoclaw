---
title: "[approver/calibration] CI workflow that merges+builds an untrusted PR: CWE-522 persist-credentials is blocking only under specific factors"
type: learning
topic: ci-tooling
source: learnings/1788905666798-approver-calibration-ci-workflow-that-merges-build.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1788905666798-approver-calibration-ci-workflow-that-merges-build.md`_

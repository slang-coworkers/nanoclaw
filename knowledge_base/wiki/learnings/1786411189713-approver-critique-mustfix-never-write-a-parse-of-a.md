---
title: "[approver/critique-mustfix] Never write a parse of an artifact that hasn't returned — and a real call chain is not an order proof"
type: learning
topic: review-approval
source: learnings/1786411189713-approver-critique-mustfix-never-write-a-parse-of-a.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786411189713-approver-critique-mustfix-never-write-a-parse-of-a.md`_

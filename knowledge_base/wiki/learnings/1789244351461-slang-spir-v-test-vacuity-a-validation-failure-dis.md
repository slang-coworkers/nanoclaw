---
title: "Slang SPIR-V test vacuity: a validation-failure disassembly + `internal error` defeats CHECK-NOT: error: and positive OpType checks"
type: learning
topic: slang-compiler
source: learnings/1789244351461-slang-spir-v-test-vacuity-a-validation-failure-dis.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789244351461-slang-spir-v-test-vacuity-a-validation-failure-dis.md`_

---
title: "Triaging uniform CI test failures: new-test vs PR-regression vs inherited master breakage"
type: learning
topic: ci-tooling
source: learnings/1788474162476-triaging-uniform-ci-test-failures-new-test-vs-pr-r.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1788474162476-triaging-uniform-ci-test-failures-new-test-vs-pr-r.md`_

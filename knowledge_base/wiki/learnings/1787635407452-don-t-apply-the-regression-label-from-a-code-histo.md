---
title: "Don't apply the regression label from a code-history hypothesis — runtime-bisect first"
type: learning
topic: verification
source: learnings/1787635407452-don-t-apply-the-regression-label-from-a-code-histo.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1787635407452-don-t-apply-the-regression-label-from-a-code-histo.md`_

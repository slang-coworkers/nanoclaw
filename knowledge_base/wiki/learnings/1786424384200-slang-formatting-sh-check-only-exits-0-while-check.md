---
title: "slang formatting.sh --check-only EXITS 0 WHILE CHECKING NOTHING when its tools are absent — and pip-installed clang-format vanishes across a container restart"
type: learning
topic: slang-compiler
source: learnings/1786424384200-slang-formatting-sh-check-only-exits-0-while-check.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786424384200-slang-formatting-sh-check-only-exits-0-while-check.md`_

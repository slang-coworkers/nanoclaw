---
title: "[approver/challenger-miss] A PR's stated failure MECHANISM is a claim about source — read the exit path, and prefer the run's own uploaded artifact over its narrative"
type: learning
topic: review-approval
source: learnings/1786374529551-approver-challenger-miss-a-pr-s-stated-failure-mec.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786374529551-approver-challenger-miss-a-pr-s-stated-failure-mec.md`_

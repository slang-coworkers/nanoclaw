---
title: "[approver/infra] The OneCLI GitHub proxy is an ALLOW-LIST of path prefixes — `repositories/`, `orgs/`, `user/`, `rate_limit` are all uncredentialed, not just paginated routes"
type: learning
topic: agent-ops
source: learnings/1786398787755-approver-infra-the-onecli-github-proxy-is-an-allow.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786398787755-approver-infra-the-onecli-github-proxy-is-an-allow.md`_

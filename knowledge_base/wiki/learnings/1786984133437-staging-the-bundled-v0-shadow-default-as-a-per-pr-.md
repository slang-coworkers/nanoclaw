---
title: "Staging the bundled v0-shadow default as a per-PR APPROVAL_POLICY silently flips fork PRs to false abstain"
type: learning
topic: review-approval
source: learnings/1786984133437-staging-the-bundled-v0-shadow-default-as-a-per-pr-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786984133437-staging-the-bundled-v0-shadow-default-as-a-per-pr-.md`_

---
title: "Triage trap: an issue scoping something OUT is not a certificate that it's correct — verify before asserting"
type: learning
topic: agent-ops
source: learnings/1786985585376-triage-trap-an-issue-scoping-something-out-is-not-.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786985585376-triage-trap-an-issue-scoping-something-out-is-not-.md`_

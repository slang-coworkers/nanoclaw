---
title: "[approver/clause-gap] Mid-chain policy tightening (v0-shadow-wide→v0-shadow) can flip a prior-eligible PR to CLAUSE_FAIL, overriding a found bug"
type: learning
topic: review-approval
source: learnings/1788200996555-approver-clause-gap-mid-chain-policy-tightening-v0.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788200996555-approver-clause-gap-mid-chain-policy-tightening-v0.md`_

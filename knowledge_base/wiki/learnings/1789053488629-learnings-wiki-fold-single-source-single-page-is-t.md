---
title: "learnings-wiki fold: single-source→single-page is the failure-robust unit; citation-superset gate makes deletes safe"
type: learning
topic: agent-ops
source: learnings/1789053488629-learnings-wiki-fold-single-source-single-page-is-t.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789053488629-learnings-wiki-fold-single-source-single-page-is-t.md`_

---
title: "[approver/infra-abstain] Devin-only tier commit_match passes by fiat — a STALE Devin analysis is only caught by cross-checking its cited line-numbers/findings against the head"
type: learning
topic: review-approval
source: learnings/1787072023468-approver-infra-abstain-devin-only-tier-commit-matc.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787072023468-approver-infra-abstain-devin-only-tier-commit-matc.md`_

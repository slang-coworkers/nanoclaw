---
title: "Slang CI runs Debug slang-test, so _DEBUG-only invariants are guarded by tests/ regressions"
type: learning
topic: slang-compiler
source: learnings/1790275762971-slang-ci-runs-debug-slang-test-so-debug-only-invar.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1790275762971-slang-ci-runs-debug-slang-test-so-debug-only-invar.md`_

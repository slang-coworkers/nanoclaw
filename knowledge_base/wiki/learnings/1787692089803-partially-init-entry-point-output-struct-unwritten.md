---
title: "Partially-init entry-point output struct: unwritten field gets a spurious store (fix in glsl-legalize, not emit)"
type: learning
topic: slang-compiler
source: learnings/1787692089803-partially-init-entry-point-output-struct-unwritten.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787692089803-partially-init-entry-point-output-struct-unwritten.md`_

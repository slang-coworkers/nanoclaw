---
title: "[approver/infra-abstain] Before debating an infra mechanism with a peer, grep your OWN work tree — the recorded host denial was there all along; and a silent log is not a clean run (test with a known-positive)"
type: learning
topic: review-approval
source: learnings/1786454516285-approver-infra-abstain-before-debating-an-infra-me.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786454516285-approver-infra-abstain-before-debating-an-infra-me.md`_

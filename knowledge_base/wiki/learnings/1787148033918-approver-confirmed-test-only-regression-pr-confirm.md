---
title: "[approver/confirmed] Test-only regression PR: confirm the NEW test ran green in the CI job that actually runs it, not just Devin-clean"
type: learning
topic: ci-tooling
source: learnings/1787148033918-approver-confirmed-test-only-regression-pr-confirm.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1787148033918-approver-confirmed-test-only-regression-pr-confirm.md`_

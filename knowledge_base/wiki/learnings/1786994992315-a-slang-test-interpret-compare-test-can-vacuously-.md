---
title: "A slang-test INTERPRET/COMPARE test can VACUOUSLY PASS when its CHECK token appears in the compiler's abort output"
type: learning
topic: slang-compiler
source: learnings/1786994992315-a-slang-test-interpret-compare-test-can-vacuously-.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786994992315-a-slang-test-interpret-compare-test-can-vacuously-.md`_

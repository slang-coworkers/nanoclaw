---
title: "Clarity-runner (Reviewer C) can lose its output to a tmp/ file — recover it from the Write tool call in stream.jsonl"
type: learning
topic: review-process
source: learnings/1789573892015-clarity-runner-reviewer-c-can-lose-its-output-to-a.md
---
...
---
_Topic: [Review & process](../topics/review-process.md) · [catalog](../index.md) · source: `sources/learnings/1789573892015-clarity-runner-reviewer-c-can-lose-its-output-to-a.md`_

---
title: "[approver/challenger-miss] Bot-authored (Devin-only) PR: check reviewDecision/mergeStateStatus, not just the newest review state"
type: learning
topic: review-process
source: learnings/1787880881103-approver-challenger-miss-bot-authored-devin-only-p.md
---
...
---
_Topic: [Review & process](../topics/review-process.md) · [catalog](../index.md) · source: `sources/learnings/1787880881103-approver-challenger-miss-bot-authored-devin-only-p.md`_

---
title: "FileCheck -NOT between positive matches has interval blind spots; use an absence-only prefix"
type: learning
topic: misc
source: learnings/1787699239962-filecheck-not-between-positive-matches-has-interva.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787699239962-filecheck-not-between-positive-matches-has-interva.md`_

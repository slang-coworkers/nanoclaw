---
title: "Slang lossy int→float warning: diagnostic-test annotation mechanics + unsigned-literal & warning-group pitfalls"
type: learning
topic: slang-compiler
source: learnings/1788797863864-slang-lossy-int-float-warning-diagnostic-test-anno.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788797863864-slang-lossy-int-float-warning-diagnostic-test-anno.md`_

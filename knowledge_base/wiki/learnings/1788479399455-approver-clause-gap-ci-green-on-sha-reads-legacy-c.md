---
title: "[approver/clause-gap] ci_green_on_sha reads legacy commit-status API, blind to Actions check-runs"
type: learning
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788479399455-approver-clause-gap-ci-green-on-sha-reads-legacy-c.md`_

---
title: ".claude-shared is agent-scoped despite the name; identical mtime+ctime proves a single write"
type: learning
topic: misc
source: learnings/1785849555097-claude-shared-is-agent-scoped-despite-the-name-ide.md
---

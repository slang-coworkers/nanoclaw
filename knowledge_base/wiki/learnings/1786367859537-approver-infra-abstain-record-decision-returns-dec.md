---
title: "[approver/infra-abstain] record_decision returns 'Decision recorded' even when the host DENIES the ledger append — the denial arrives afterward as a separate notification"
type: learning
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786367859537-approver-infra-abstain-record-decision-returns-dec.md`_

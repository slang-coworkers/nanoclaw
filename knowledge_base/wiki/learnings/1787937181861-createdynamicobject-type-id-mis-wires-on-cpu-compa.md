---
title: "createDynamicObject + type_id mis-wires on CPU COMPARE_COMPUTE value-checks — use a plain factory"
type: learning
topic: misc
source: learnings/1787937181861-createdynamicobject-type-id-mis-wires-on-cpu-compa.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787937181861-createdynamicobject-type-id-mis-wires-on-cpu-compa.md`_

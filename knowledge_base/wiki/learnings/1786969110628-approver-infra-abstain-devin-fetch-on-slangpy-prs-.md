---
title: "[approver/infra-abstain] Devin fetch on slangpy PRs frequently times out (~20m, exit 3) — do not let it gate a decision"
type: learning
topic: slang-compiler
source: learnings/1786969110628-approver-infra-abstain-devin-fetch-on-slangpy-prs-.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786969110628-approver-infra-abstain-devin-fetch-on-slangpy-prs-.md`_

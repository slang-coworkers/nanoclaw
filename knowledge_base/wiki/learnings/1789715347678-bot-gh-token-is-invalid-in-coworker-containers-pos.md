---
title: "Bot GH_TOKEN is invalid in coworker containers — post/edit GitHub comments via the onecli-gateway (curl to api.github.com), not gh"
type: learning
topic: agent-ops
source: learnings/1789715347678-bot-gh-token-is-invalid-in-coworker-containers-pos.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789715347678-bot-gh-token-is-invalid-in-coworker-containers-pos.md`_

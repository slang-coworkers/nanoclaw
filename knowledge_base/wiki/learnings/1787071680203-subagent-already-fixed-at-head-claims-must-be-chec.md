---
title: "Subagent 'already fixed at HEAD' claims must be checked with git merge-base --is-ancestor"
type: learning
topic: verification
source: learnings/1787071680203-subagent-already-fixed-at-head-claims-must-be-chec.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1787071680203-subagent-already-fixed-at-head-claims-must-be-chec.md`_

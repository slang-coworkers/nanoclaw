---
title: "Monitor for a claude-CLI reviewer run must not grep the stream for generic failure words"
type: learning
topic: review-process
source: learnings/1787869224351-monitor-for-a-claude-cli-reviewer-run-must-not-gre.md
---
...
---
_Topic: [Review & process](../topics/review-process.md) · [catalog](../index.md) · source: `sources/learnings/1787869224351-monitor-for-a-claude-cli-reviewer-run-must-not-gre.md`_

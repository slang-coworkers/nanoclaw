---
title: "Correction: re-authoring commits changes every SHA — `--is-ancestor false` is not evidence of a discarded head"
type: learning
topic: misc
source: learnings/1785968989554-correction-re-authoring-commits-changes-every-sha-.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1785968989554-correction-re-authoring-commits-changes-every-sha-.md`_

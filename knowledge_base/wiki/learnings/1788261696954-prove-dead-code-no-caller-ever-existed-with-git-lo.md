---
title: "Prove 'dead code / no caller ever existed' with git log --all -S, not brute grep"
type: learning
topic: misc
source: learnings/1788261696954-prove-dead-code-no-caller-ever-existed-with-git-lo.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788261696954-prove-dead-code-no-caller-ever-existed-with-git-lo.md`_

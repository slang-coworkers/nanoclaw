---
title: "__magic_type on user struct SIGSEGV — findSyntaxClass non-null fallback defeats the null-guard"
type: learning
topic: misc
source: learnings/1786483410365-magic-type-on-user-struct-sigsegv-findsyntaxclass-.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786483410365-magic-type-on-user-struct-sigsegv-findsyntaxclass-.md`_

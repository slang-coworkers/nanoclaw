---
title: "Slang: semicolon-less `throw` orphans a following `else` (parser omission has an un-obvious rejection side)"
type: learning
topic: slang-compiler
source: learnings/1785766261707-slang-semicolon-less-throw-orphans-a-following-els.md
---

---
title: "DescriptorKind is a coarse proxy for NV-bindless uint64 representation — gate on the IR type"
type: learning
topic: agent-ops
source: learnings/1789559398644-descriptorkind-is-a-coarse-proxy-for-nv-bindless-u.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789559398644-descriptorkind-is-a-coarse-proxy-for-nv-bindless-u.md`_

---
title: "Delivery-gate OUTPUT_REVIEW compares the POSTED PR vs your local tree — commit+push+update-body BEFORE running it"
type: learning
topic: agent-ops
source: learnings/1789402846129-delivery-gate-output-review-compares-the-posted-pr.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789402846129-delivery-gate-output-review-compares-the-posted-pr.md`_

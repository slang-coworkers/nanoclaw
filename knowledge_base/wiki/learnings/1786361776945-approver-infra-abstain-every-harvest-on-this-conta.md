---
title: "[approver/infra-abstain] Every harvest on this container was failing with `unknown flag: --slurp` (gh 2.46 < 2.47) → exit 21 → spurious ABSTAIN_INFRA; and collect-reviews.sh printed FETCH FAILED while exiting 0"
type: learning
topic: review-approval
source: learnings/1786361776945-approver-infra-abstain-every-harvest-on-this-conta.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786361776945-approver-infra-abstain-every-harvest-on-this-conta.md`_

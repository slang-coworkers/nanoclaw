---
title: "Falcor test-falcor DOES gate merge via check-ci needs (corrects earlier claim)"
type: learning
topic: agent-ops
source: learnings/1785979228844-falcor-test-falcor-does-gate-merge-via-check-ci-ne.md
---

---
title: "A grep of one repo cannot rule out behavior implemented in a reusable workflow it calls"
type: learning
topic: misc
source: learnings/1785853379329-a-grep-of-one-repo-cannot-rule-out-behavior-implem.md
---

---
title: "SlangPy build-pr job can hang ~2h with zero error emitted — no compile error, no timeout-minutes message"
type: learning
topic: slang-compiler
source: learnings/1787724952030-slangpy-build-pr-job-can-hang-2h-with-zero-error-e.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787724952030-slangpy-build-pr-job-can-hang-2h-with-zero-error-e.md`_

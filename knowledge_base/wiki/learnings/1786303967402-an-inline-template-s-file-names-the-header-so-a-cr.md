---
title: "An inline template's __FILE__ names the header, so a crash path's directory prefix attributes the TU, not the owner of the data"
type: learning
topic: misc
source: learnings/1786303967402-an-inline-template-s-file-names-the-header-so-a-cr.md
---

---
title: "[approver/critique-mustfix] A cited negative-test control must exercise the CHANGED code path, not just the same file area"
type: learning
topic: review-approval
source: learnings/1787369819615-approver-critique-mustfix-a-cited-negative-test-co.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787369819615-approver-critique-mustfix-a-cited-negative-test-co.md`_

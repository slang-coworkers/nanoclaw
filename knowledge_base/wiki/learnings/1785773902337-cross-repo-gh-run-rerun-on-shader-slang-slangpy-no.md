---
title: "Cross-repo gh run rerun on shader-slang/slangpy now WORKS — verify via run_attempt, not exit code"
type: learning
topic: slang-compiler
source: learnings/1785773902337-cross-repo-gh-run-rerun-on-shader-slang-slangpy-no.md
---

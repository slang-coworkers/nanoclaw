---
title: "A control whose hypotheses predict the same output is not a control — state the predictions before running it"
type: learning
topic: misc
source: learnings/1786240939835-a-control-whose-hypotheses-predict-the-same-output.md
---
...
---
_Topic: [Uncategorized](wiki/topics/misc.md) · [catalog](wiki/index.md) · source: `sources/learnings/1786240939835-a-control-whose-hypotheses-predict-the-same-output.md`_

---
title: "Slang SPIR-V opaque-handle local debug info: fix at leaf/creation gates, not recursive isDebuggableType; let-path + dead processDebugVar"
type: learning
topic: slang-compiler
source: learnings/1788748635093-slang-spir-v-opaque-handle-local-debug-info-fix-at.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788748635093-slang-spir-v-opaque-handle-local-debug-info-fix-at.md`_

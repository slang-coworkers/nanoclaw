---
title: "A delegated VERIFIED can be circular — check what source it landed on"
type: learning
topic: agent-ops
source: learnings/1786131129263-a-delegated-verified-can-be-circular-check-what-so.md
---

---
title: "Never forward webhook payload labels/assignees/milestone — delete the slot, don't stamp it"
type: learning
topic: agent-ops
source: learnings/1786442851025-never-forward-webhook-payload-labels-assignees-mil.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786442851025-never-forward-webhook-payload-labels-assignees-mil.md`_

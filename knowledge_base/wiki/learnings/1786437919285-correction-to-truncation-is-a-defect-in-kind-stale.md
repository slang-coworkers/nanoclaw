---
title: "CORRECTION to 'Truncation is a defect in KIND, staleness a defect in TIME' — the instance was VOID; the truncation half was never demonstrated, and a SELF-BLAMING claim got the same free pass a flattering one would"
type: learning
topic: verification
source: learnings/1786437919285-correction-to-truncation-is-a-defect-in-kind-stale.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1786437919285-correction-to-truncation-is-a-defect-in-kind-stale.md`_

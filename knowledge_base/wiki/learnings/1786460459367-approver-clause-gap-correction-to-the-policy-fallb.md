---
title: "[approver/clause-gap] CORRECTION to the policy-fallback leaf: allow_fork_head is present and explicitly false, NOT absent — jq's // is a falsy-coalesce, not a presence test"
type: learning
topic: review-approval
source: learnings/1786460459367-approver-clause-gap-correction-to-the-policy-fallb.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786460459367-approver-clause-gap-correction-to-the-policy-fallb.md`_

---
title: "Prebuilt slangc in the mounted checkout can be STALE vs git HEAD — check the commit before trusting emit"
type: learning
topic: slang-compiler
source: learnings/1787850489737-prebuilt-slangc-in-the-mounted-checkout-can-be-sta.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787850489737-prebuilt-slangc-in-the-mounted-checkout-can-be-sta.md`_

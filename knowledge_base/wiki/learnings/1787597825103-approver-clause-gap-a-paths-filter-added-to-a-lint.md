---
title: "[approver/clause-gap] A paths: filter added to a lint workflow can silently drop coverage its bare-linter had transitively (actionlint + composite actions)"
type: learning
topic: review-approval
source: learnings/1787597825103-approver-clause-gap-a-paths-filter-added-to-a-lint.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787597825103-approver-clause-gap-a-paths-filter-added-to-a-lint.md`_

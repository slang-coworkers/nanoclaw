---
title: "[approver/infra-abstain] collect-reviews.sh misses the pending review bot — its check-runs fetch reads only the default 30-item page (49 total), turning 'wait' into 'genuine skip'"
type: learning
topic: review-approval
source: learnings/1786382286523-approver-infra-abstain-collect-reviews-sh-misses-t.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786382286523-approver-infra-abstain-collect-reviews-sh-misses-t.md`_

---
title: "CI babysitter: classify-only subagent scope violation recurred (2nd time) — needs a structural fix, not just prose instructions"
type: learning
topic: ci-tooling
source: learnings/1788287467646-ci-babysitter-classify-only-subagent-scope-violati.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1788287467646-ci-babysitter-classify-only-subagent-scope-violati.md`_

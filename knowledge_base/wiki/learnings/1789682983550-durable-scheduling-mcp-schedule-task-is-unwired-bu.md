---
title: "Durable scheduling: mcp schedule_task is unwired, but `ncl tasks create` works (with --script guard)"
type: learning
topic: agent-ops
source: learnings/1789682983550-durable-scheduling-mcp-schedule-task-is-unwired-bu.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789682983550-durable-scheduling-mcp-schedule-task-is-unwired-bu.md`_

---
title: "[approver] A diff's invariant-claiming comment is a load-bearing claim — verify it across ALL sites, not just the touched one"
type: learning
topic: verification
source: learnings/1786801759746-approver-a-diff-s-invariant-claiming-comment-is-a-.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1786801759746-approver-a-diff-s-invariant-claiming-comment-is-a-.md`_

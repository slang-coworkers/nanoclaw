---
title: "Classify-only CI subagent fabricated a cross-repo finding, not just risked over-acting"
type: learning
topic: ci-tooling
source: learnings/1786969122532-classify-only-ci-subagent-fabricated-a-cross-repo-.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1786969122532-classify-only-ci-subagent-fabricated-a-cross-repo-.md`_

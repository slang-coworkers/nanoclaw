---
title: "Before reporting a write LANDED, ask if your tier can read the property back — else report the action, not the outcome"
type: learning
topic: misc
source: learnings/1785847159257-before-reporting-a-write-landed-ask-if-your-tier-c.md
---

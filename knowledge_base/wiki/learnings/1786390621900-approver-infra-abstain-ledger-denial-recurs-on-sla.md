---
title: "[approver/infra-abstain] Ledger denial recurs on slang#12452 (≥18th PR): record_decision returns 'Decision recorded' while the host denies — and the ABSTAIN relaxation path does not help"
type: learning
topic: review-approval
source: learnings/1786390621900-approver-infra-abstain-ledger-denial-recurs-on-sla.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786390621900-approver-infra-abstain-ledger-denial-recurs-on-sla.md`_

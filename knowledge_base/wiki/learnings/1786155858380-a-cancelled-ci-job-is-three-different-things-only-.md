---
title: "A `cancelled` CI job is three different things — only arithmetic tells them apart"
type: learning
topic: ci-tooling
source: learnings/1786155858380-a-cancelled-ci-job-is-three-different-things-only-.md
---

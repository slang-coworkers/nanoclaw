---
title: "gh CLI as nv-slang-bot: 'invalid token' / user 403 is normal for a GitHub App installation token — repo endpoints still work"
type: learning
topic: slang-compiler
source: learnings/1788298673378-gh-cli-as-nv-slang-bot-invalid-token-user-403-is-n.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788298673378-gh-cli-as-nv-slang-bot-invalid-token-user-403-is-n.md`_

---
title: "FileCheck CHECK-LABEL blocks must be in emit order, not source order"
type: learning
topic: misc
source: learnings/1787564174427-filecheck-check-label-blocks-must-be-in-emit-order.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787564174427-filecheck-check-label-blocks-must-be-in-emit-order.md`_

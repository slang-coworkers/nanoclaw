---
title: "[approver/infra-abstain] record_decision returns 'Decision recorded' even when the host DENIES the ledger append — the tool string is not proof of a write"
type: learning
topic: review-approval
source: learnings/1786436642533-approver-infra-abstain-record-decision-returns-dec.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786436642533-approver-infra-abstain-record-decision-returns-dec.md`_

---
title: "[approver/infra-abstain] A CodeRabbit RATE-LIMIT REFUSAL looks identical to 'no bot review' (harvest exit 20) — and combined /status reports it as SUCCESS"
type: learning
topic: review-approval
source: learnings/1786368903321-approver-infra-abstain-a-coderabbit-rate-limit-ref.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786368903321-approver-infra-abstain-a-coderabbit-rate-limit-ref.md`_

---
title: "CUDA texture element-vs-vector: $T0→$TR swap fixes Gather but NOT SampleLevel"
type: learning
topic: misc
source: learnings/1787219149444-cuda-texture-element-vs-vector-t0-tr-swap-fixes-ga.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787219149444-cuda-texture-element-vs-vector-t0-tr-swap-fixes-ga.md`_

---
title: "Slang: SLANG_ASSERT becomes SLANG_ASSUME in Release, so `SLANG_ASSERT(x); if (!x) return;` guards are DELETED from the binary"
type: learning
topic: slang-compiler
source: learnings/1786024053575-slang-slang-assert-becomes-slang-assume-in-release.md
---

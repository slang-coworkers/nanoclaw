---
title: "[approver/critique-mustfix] ABSTAIN decisions must ship via the send_message MCP TOOL, not a final-text &lt;message&gt; block — two gates, only the tool path has the abstain fast-path"
type: learning
topic: review-approval
source: learnings/1786479929909-approver-critique-mustfix-abstain-decisions-must-s.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786479929909-approver-critique-mustfix-abstain-decisions-must-s.md`_

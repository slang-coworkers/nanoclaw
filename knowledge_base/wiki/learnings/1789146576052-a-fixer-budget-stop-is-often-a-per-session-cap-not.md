---
title: "A fixer 'budget-stop' is often a per-session cap, not a funding gap — re-dispatch fresh on the canonical thread"
type: learning
topic: agent-ops
source: learnings/1789146576052-a-fixer-budget-stop-is-often-a-per-session-cap-not.md
superseded_by: 1789150203049-unblocking-a-budget-tapped-coworker-session-verify
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789146576052-a-fixer-budget-stop-is-often-a-per-session-cap-not.md`_

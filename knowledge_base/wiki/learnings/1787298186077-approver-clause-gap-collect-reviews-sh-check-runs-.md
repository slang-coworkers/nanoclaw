---
title: "[approver/clause-gap] collect-reviews.sh check-runs fetch is NOT paginated — false exit-20 skip on PRs with >30 check-runs"
type: learning
topic: review-approval
source: learnings/1787298186077-approver-clause-gap-collect-reviews-sh-check-runs-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787298186077-approver-clause-gap-collect-reviews-sh-check-runs-.md`_

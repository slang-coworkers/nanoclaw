---
title: "DCE scratchData epoch: safety comes from a local zero-baseline, not a high starting constant"
type: learning
topic: misc
source: learnings/1787073638302-dce-scratchdata-epoch-safety-comes-from-a-local-ze.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787073638302-dce-scratchdata-epoch-safety-comes-from-a-local-ze.md`_

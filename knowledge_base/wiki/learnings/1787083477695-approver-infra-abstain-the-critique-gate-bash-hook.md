---
title: "[approver/infra-abstain] The critique-gate Bash hook false-positives on read-only `gh api .../pulls` GETs — route PR/issue reads through MCP tools, never Bash gh api"
type: learning
topic: agent-ops
source: learnings/1787083477695-approver-infra-abstain-the-critique-gate-bash-hook.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787083477695-approver-infra-abstain-the-critique-gate-bash-hook.md`_

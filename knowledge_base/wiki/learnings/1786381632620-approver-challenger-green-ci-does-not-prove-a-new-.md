---
title: "[approver/challenger] Green CI does not prove a new conditional path ran — grep the job log for the test NAME"
type: learning
topic: review-approval
source: learnings/1786381632620-approver-challenger-green-ci-does-not-prove-a-new-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786381632620-approver-challenger-green-ci-does-not-prove-a-new-.md`_

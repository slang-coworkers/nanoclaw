---
title: "Numbers copied from build/test output are BRANCH-relative — converting them is a required step, not a nicety"
type: learning
topic: ci-tooling
source: learnings/1785942255479-numbers-copied-from-build-test-output-are-branch-r.md
---
...
---
_Topic: [CI, build & tooling](wiki/topics/ci-tooling.md) · [catalog](wiki/index.md) · source: `sources/learnings/1785942255479-numbers-copied-from-build-test-output-are-branch-r.md`_

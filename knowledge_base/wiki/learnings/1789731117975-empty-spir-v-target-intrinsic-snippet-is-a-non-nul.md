---
title: "Empty SPIR-V __target_intrinsic snippet is a non-null parse that slips past both the null-check and the error-count gate"
type: learning
topic: slang-compiler
source: learnings/1789731117975-empty-spir-v-target-intrinsic-snippet-is-a-non-nul.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789731117975-empty-spir-v-target-intrinsic-snippet-is-a-non-nul.md`_

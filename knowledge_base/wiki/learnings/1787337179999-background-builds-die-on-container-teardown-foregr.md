---
title: "Background builds die on container teardown — foreground chunking is the workaround (looks like a 16h hang)"
type: learning
topic: agent-ops
source: learnings/1787337179999-background-builds-die-on-container-teardown-foregr.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787337179999-background-builds-die-on-container-teardown-foregr.md`_

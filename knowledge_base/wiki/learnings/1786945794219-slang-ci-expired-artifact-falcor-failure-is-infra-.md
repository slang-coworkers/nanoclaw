---
title: "Slang CI: expired-artifact Falcor failure is infra, and `gh run rerun --failed` can't fix it (re-runs the consumer, not the producer)"
type: learning
topic: slang-compiler
source: learnings/1786945794219-slang-ci-expired-artifact-falcor-failure-is-infra-.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786945794219-slang-ci-expired-artifact-falcor-failure-is-infra-.md`_

---
title: "Bot workflows-permission guard is path-based: blocks even plain .md under .github/workflows"
type: learning
topic: misc
source: learnings/1787261003461-bot-workflows-permission-guard-is-path-based-block.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787261003461-bot-workflows-permission-guard-is-path-based-block.md`_

---
title: "[approver/clause-gap] Widened diagnostic message advertising an operand-kind the PR leaves broken is an OPEN_GAP, not a nit"
type: learning
topic: review-approval
source: learnings/1787769461370-approver-clause-gap-widened-diagnostic-message-adv.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787769461370-approver-clause-gap-widened-diagnostic-message-adv.md`_

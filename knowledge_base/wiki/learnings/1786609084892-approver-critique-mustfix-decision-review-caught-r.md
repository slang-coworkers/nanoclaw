---
title: "[approver/critique-mustfix] DECISION_REVIEW caught reviewers_complete=true set from a self-trace + green CI when no head review existed — the flattering-but-clean trace is the tell"
type: learning
topic: review-approval
source: learnings/1786609084892-approver-critique-mustfix-decision-review-caught-r.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786609084892-approver-critique-mustfix-decision-review-caught-r.md`_

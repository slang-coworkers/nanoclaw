---
title: "Bot content from a human account defeats non-bot detection — gate on authorship and ordering, not account type"
type: learning
topic: agent-ops
source: learnings/1786451957401-bot-content-from-a-human-account-defeats-non-bot-d.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786451957401-bot-content-from-a-human-account-defeats-non-bot-d.md`_

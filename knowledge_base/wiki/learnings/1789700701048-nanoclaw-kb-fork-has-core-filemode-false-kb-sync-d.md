---
title: "nanoclaw-kb fork has core.fileMode=false — KB-sync DATA-ONLY GATE control must use update-index --chmod"
type: learning
topic: agent-ops
source: learnings/1789700701048-nanoclaw-kb-fork-has-core-filemode-false-kb-sync-d.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789700701048-nanoclaw-kb-fork-has-core-filemode-false-kb-sync-d.md`_

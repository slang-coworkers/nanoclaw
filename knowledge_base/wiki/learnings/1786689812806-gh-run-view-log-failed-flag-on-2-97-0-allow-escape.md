---
title: "gh run view --log-failed flag on 2.97.0: --allow-escape-sequences doesn't exist on that subcommand"
type: learning
topic: misc
source: learnings/1786689812806-gh-run-view-log-failed-flag-on-2-97-0-allow-escape.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786689812806-gh-run-view-log-failed-flag-on-2-97-0-allow-escape.md`_

---
title: "gh search/code is DEAD on a fork — every query returns 0, and the two known blind spots do not explain it"
type: learning
topic: agent-ops
source: learnings/1786370596653-gh-search-code-is-dead-on-a-fork-every-query-retur.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786370596653-gh-search-code-is-dead-on-a-fork-every-query-retur.md`_

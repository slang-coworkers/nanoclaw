---
title: "[approver/challenger-miss] Re-verify a carried-over gap's MECHANISM at each new head after a rebase — 'the sites read byte-identical' is not 'the gap still holds'; and a documented release-assert on an unproven-reachable path is not a 🔴"
type: learning
topic: review-approval
source: learnings/1788294032596-approver-challenger-miss-re-verify-a-carried-over-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788294032596-approver-challenger-miss-re-verify-a-carried-over-.md`_

---
title: "A whole-file grep for a status token matches inner streaming content, not the terminal result"
type: learning
topic: misc
source: learnings/1787323802416-a-whole-file-grep-for-a-status-token-matches-inner.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787323802416-a-whole-file-grep-for-a-status-token-matches-inner.md`_

---
title: "Slang HAS opt-in default-off warnings (WarningLevel + -W&lt;name&gt;) — wiki 'disable-only' is stale"
type: learning
topic: slang-compiler
source: learnings/1788789285754-slang-has-opt-in-default-off-warnings-warninglevel.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788789285754-slang-has-opt-in-default-off-warnings-warninglevel.md`_

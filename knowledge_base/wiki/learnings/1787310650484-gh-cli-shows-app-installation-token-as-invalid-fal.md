---
title: "gh CLI shows App installation token as 'invalid' — false negative; gh api still works on repo/issue endpoints"
type: learning
topic: ci-tooling
source: learnings/1787310650484-gh-cli-shows-app-installation-token-as-invalid-fal.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1787310650484-gh-cli-shows-app-installation-token-as-invalid-fal.md`_

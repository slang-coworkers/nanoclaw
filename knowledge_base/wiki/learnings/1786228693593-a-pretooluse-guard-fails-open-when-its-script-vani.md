---
title: "A PreToolUse guard fails OPEN when its script vanishes — inline the fallback in the settings entry, and assert the property not the reference"
type: learning
topic: misc
source: learnings/1786228693593-a-pretooluse-guard-fails-open-when-its-script-vani.md
---

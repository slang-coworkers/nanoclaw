---
title: "[approver/critique-mustfix] 'Not acted on' needs the MERGE-QUEUE timeline, not thread state — and a bounded claim must be re-grepped as a CLASS, not patched at the cited lines"
type: learning
topic: review-approval
source: learnings/1786389600072-approver-critique-mustfix-not-acted-on-needs-the-m.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786389600072-approver-critique-mustfix-not-acted-on-needs-the-m.md`_

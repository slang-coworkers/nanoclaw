---
title: "[approver/clause-gap] A fix revision can flip WHICH Step-1 clause fails; verify the prior crash via CI-green on the exact test, and watch for a cascading new assert"
type: learning
topic: review-approval
source: learnings/1788131625046-approver-clause-gap-a-fix-revision-can-flip-which-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788131625046-approver-clause-gap-a-fix-revision-can-flip-which-.md`_

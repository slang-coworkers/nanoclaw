---
title: "critique-gate recorder only counts codex calls made via the exact /codex-critique template"
type: learning
topic: agent-ops
source: learnings/1790239797245-critique-gate-recorder-only-counts-codex-calls-mad.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1790239797245-critique-gate-recorder-only-counts-codex-calls-mad.md`_

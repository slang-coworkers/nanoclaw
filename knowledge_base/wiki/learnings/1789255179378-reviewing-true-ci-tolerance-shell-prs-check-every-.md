---
title: "Reviewing `|| true` CI-tolerance shell PRs: check every same-scope VAR=$(pipeline), and know errexit is OFF in command-substitution subshells"
type: learning
topic: ci-tooling
source: learnings/1789255179378-reviewing-true-ci-tolerance-shell-prs-check-every-.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1789255179378-reviewing-true-ci-tolerance-shell-prs-check-every-.md`_

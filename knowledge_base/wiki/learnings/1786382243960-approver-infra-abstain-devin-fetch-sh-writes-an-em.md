---
title: "[approver/infra-abstain] devin-fetch.sh writes an EMPTY Flags section when the page reports Bugs — a Flags-only read is a false clean"
type: learning
topic: review-approval
source: learnings/1786382243960-approver-infra-abstain-devin-fetch-sh-writes-an-em.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786382243960-approver-infra-abstain-devin-fetch-sh-writes-an-em.md`_

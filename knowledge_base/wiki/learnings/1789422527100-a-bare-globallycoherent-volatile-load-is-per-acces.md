---
title: "A bare globallycoherent/volatile LOAD is per-access visibility, NOT an acquire fence — safe to CSE/reorder around (memory-model soundness rule)"
type: learning
topic: misc
source: learnings/1789422527100-a-bare-globallycoherent-volatile-load-is-per-acces.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1789422527100-a-bare-globallycoherent-volatile-load-is-per-acces.md`_

---
title: "Read cli_scope with `ncl groups config get` (works bare in-container) — and its documented 'rejected' behavior is actually silent substitution"
type: learning
topic: agent-ops
source: learnings/1785980538648-read-cli-scope-with-ncl-groups-config-get-works-ba.md
---

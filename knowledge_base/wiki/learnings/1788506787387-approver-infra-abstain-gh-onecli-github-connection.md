---
title: "[approver/infra-abstain] gh/OneCLI GitHub connection dropping mid-session → HARNESS_FAIL (exit-21 reviews-fetch-fail + unevaluable clauses)"
type: learning
topic: review-approval
source: learnings/1788506787387-approver-infra-abstain-gh-onecli-github-connection.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788506787387-approver-infra-abstain-gh-onecli-github-connection.md`_

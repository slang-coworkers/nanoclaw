---
title: "slangpy create_slang_session include-path inheritance belongs in the binding, not the C++ core (#886/#1182)"
type: learning
topic: slang-compiler
source: learnings/1790111150088-slangpy-create-slang-session-include-path-inherita.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1790111150088-slangpy-create-slang-session-include-path-inherita.md`_

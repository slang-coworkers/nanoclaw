---
title: "Two agents independently reached the same WRONG slang-test exit-code conclusion via the same `| tail` idiom — independent reproduction is not corroboration when the plumbing is shared"
type: learning
topic: slang-compiler
source: learnings/1786051424553-two-agents-independently-reached-the-same-wrong-sl.md
---

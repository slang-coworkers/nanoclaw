---
title: "Critique-gate attestation treadmill: batch all edits, run OUTPUT_REVIEW last"
type: learning
topic: agent-ops
source: learnings/1788298159048-critique-gate-attestation-treadmill-batch-all-edit.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1788298159048-critique-gate-attestation-treadmill-batch-all-edit.md`_

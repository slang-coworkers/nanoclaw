---
title: "getEntryPointCode OOB entry-point index: one missing bounds check, two symptoms (abort vs segfault)"
type: learning
topic: misc
source: learnings/1786487521970-getentrypointcode-oob-entry-point-index-one-missin.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786487521970-getentrypointcode-oob-entry-point-index-one-missin.md`_

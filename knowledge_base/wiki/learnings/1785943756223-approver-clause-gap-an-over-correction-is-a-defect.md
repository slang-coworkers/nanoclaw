---
title: "[approver/clause-gap] An over-correction is a defect too — 'the gate wouldn't have prevented it' is false with CI_GATE_REQUIRED_SUITE set: the build suite is conclusion=failure, so the host parks the wake upstream of the waived clause"
type: learning
topic: agent-ops
source: learnings/1785943756223-approver-clause-gap-an-over-correction-is-a-defect.md
---

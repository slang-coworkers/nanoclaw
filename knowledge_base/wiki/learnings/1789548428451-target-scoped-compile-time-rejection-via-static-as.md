---
title: "Target-scoped compile-time rejection via static_assert in a __target_switch arm (and its emit-ordering limit)"
type: learning
topic: misc
source: learnings/1789548428451-target-scoped-compile-time-rejection-via-static-as.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1789548428451-target-scoped-compile-time-rejection-via-static-as.md`_

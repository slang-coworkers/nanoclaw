---
title: "Slang PR review: gh/api blocked by OneCLI but git-fetch + slang-mcp work — use --mode patch"
type: learning
topic: agent-ops
source: learnings/1788913121098-slang-pr-review-gh-api-blocked-by-onecli-but-git-f.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1788913121098-slang-pr-review-gh-api-blocked-by-onecli-but-git-f.md`_

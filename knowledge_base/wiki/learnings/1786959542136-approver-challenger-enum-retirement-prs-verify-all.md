---
title: "[approver/challenger] enum-retirement PRs — verify all consumers, incl. the untracked host that enforces the enum"
type: learning
topic: review-approval
source: learnings/1786959542136-approver-challenger-enum-retirement-prs-verify-all.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786959542136-approver-challenger-enum-retirement-prs-verify-all.md`_

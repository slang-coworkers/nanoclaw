---
title: "Slang API compiler-options: applySettingsToDiagnosticSink double-apply clobbers with defaults; API-path bugs need slang-unit-test not .slang"
type: learning
topic: slang-compiler
source: learnings/1782929205990-slang-api-compiler-options-applysettingstodiagnost.md
---

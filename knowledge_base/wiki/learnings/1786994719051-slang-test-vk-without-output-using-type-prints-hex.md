---
title: "slang test: -vk without -output-using-type prints HEX — do not misread as wrong values"
type: learning
topic: slang-compiler
source: learnings/1786994719051-slang-test-vk-without-output-using-type-prints-hex.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786994719051-slang-test-vk-without-output-using-type-prints-hex.md`_

---
title: "A removed POSIX include can compile clean on Linux yet break macOS/libc++"
type: learning
topic: agent-ops
source: learnings/1786516325450-a-removed-posix-include-can-compile-clean-on-linux.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786516325450-a-removed-posix-include-can-compile-clean-on-linux.md`_

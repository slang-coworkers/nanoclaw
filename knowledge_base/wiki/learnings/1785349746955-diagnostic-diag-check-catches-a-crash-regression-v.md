---
title: "DIAGNOSTIC diag=CHECK catches a crash-regression via empty stderr (checks parsed diagnostics, not exit code)"
type: learning
topic: misc
source: learnings/1785349746955-diagnostic-diag-check-catches-a-crash-regression-v.md
---

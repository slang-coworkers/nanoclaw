---
title: "Two independent channels launder a shell failure: 2>/dev/null kills the message, a pipe kills the exit status"
type: learning
topic: misc
source: learnings/1785867928996-two-independent-channels-launder-a-shell-failure-2.md
---

---
title: "[approver/infra-abstain] record_decision returned 'Decision recorded' while the host DENIED the append — 4th+ instance, APPROVAL_LEDGER_WRITERS unset; the success string is not the write"
type: learning
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786388048797-approver-infra-abstain-record-decision-returned-de.md`_

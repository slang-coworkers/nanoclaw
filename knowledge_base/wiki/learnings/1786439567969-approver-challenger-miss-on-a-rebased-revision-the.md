---
title: "[approver/challenger-miss] On a rebased revision the inter-head compare is mostly upstream noise — measure the PR's own diff vs base, and check ahead_by/behind_by to tell a rebase from a push"
type: learning
topic: review-approval
source: learnings/1786439567969-approver-challenger-miss-on-a-rebased-revision-the.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786439567969-approver-challenger-miss-on-a-rebased-revision-the.md`_

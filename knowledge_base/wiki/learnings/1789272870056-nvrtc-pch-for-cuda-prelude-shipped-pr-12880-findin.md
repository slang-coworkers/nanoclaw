---
title: "NVRTC -pch for CUDA prelude SHIPPED (PR #12880) — findings held up; provenance was reporter's numbers not a 12.9 fixer run"
type: learning
topic: agent-ops
source: learnings/1789272870056-nvrtc-pch-for-cuda-prelude-shipped-pr-12880-findin.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789272870056-nvrtc-pch-for-cuda-prelude-shipped-pr-12880-findin.md`_

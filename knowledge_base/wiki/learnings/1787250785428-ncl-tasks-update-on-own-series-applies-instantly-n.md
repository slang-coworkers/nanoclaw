---
title: "ncl tasks update on own series applies instantly, no approval gate"
type: learning
topic: agent-ops
source: learnings/1787250785428-ncl-tasks-update-on-own-series-applies-instantly-n.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787250785428-ncl-tasks-update-on-own-series-applies-instantly-n.md`_

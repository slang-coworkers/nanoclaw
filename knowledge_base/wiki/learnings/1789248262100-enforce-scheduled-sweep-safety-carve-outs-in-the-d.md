---
title: "Enforce scheduled-sweep safety carve-outs in the deterministic script gate, not in memory/prompt"
type: learning
topic: agent-ops
source: learnings/1789248262100-enforce-scheduled-sweep-safety-carve-outs-in-the-d.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789248262100-enforce-scheduled-sweep-safety-carve-outs-in-the-d.md`_

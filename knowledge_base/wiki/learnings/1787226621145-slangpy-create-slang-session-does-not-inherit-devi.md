---
title: "slangpy create_slang_session does NOT inherit device include paths (DeepWiki wrong)"
type: learning
topic: slang-compiler
source: learnings/1787226621145-slangpy-create-slang-session-does-not-inherit-devi.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787226621145-slangpy-create-slang-session-does-not-inherit-devi.md`_

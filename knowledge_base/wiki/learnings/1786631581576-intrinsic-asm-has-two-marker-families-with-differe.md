---
title: "intrinsic_asm has TWO marker families with different operand sources ($N=call, $[N]=own)"
type: learning
topic: slang-compiler
source: learnings/1786631581576-intrinsic-asm-has-two-marker-families-with-differe.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786631581576-intrinsic-asm-has-two-marker-families-with-differe.md`_

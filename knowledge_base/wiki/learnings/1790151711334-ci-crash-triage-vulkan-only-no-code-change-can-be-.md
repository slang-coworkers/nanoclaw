---
title: "CI crash triage: 'Vulkan-only + no code change' can be a nondeterministic compile-time spirv-opt UAF, not driver/env"
type: learning
topic: slang-compiler
source: learnings/1790151711334-ci-crash-triage-vulkan-only-no-code-change-can-be-.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1790151711334-ci-crash-triage-vulkan-only-no-code-change-can-be-.md`_

---
title: "[approver/calibration] CI sanitizer-infra PR that downloads an unverified external toolchain → OPEN_GAP unless checksum-pinned or owner-accepted (slangpy#1119)"
type: learning
topic: slang-compiler
source: learnings/1787210571422-approver-calibration-ci-sanitizer-infra-pr-that-do.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787210571422-approver-calibration-ci-sanitizer-infra-pr-that-do.md`_

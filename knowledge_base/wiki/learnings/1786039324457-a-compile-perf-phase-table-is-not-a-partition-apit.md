---
title: "A compile-perf phase table is not a partition: apiTotal encloses timers the workload never declares"
type: learning
topic: agent-ops
source: learnings/1786039324457-a-compile-perf-phase-table-is-not-a-partition-apit.md
---

---
title: "CORRECTION: bot CAN ship .github/workflows PRs via the coworkers fork (not patch-only)"
type: learning
topic: agent-ops
source: learnings/1787748419987-correction-bot-can-ship-github-workflows-prs-via-t.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787748419987-correction-bot-can-ship-github-workflows-prs-via-t.md`_

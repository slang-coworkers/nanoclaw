---
title: "Slang maintainer policy: no compiler-side workarounds (WAR) for downstream compiler bugs (NVRTC/NVCC etc.)"
type: learning
topic: slang-compiler
source: learnings/1789500967936-slang-maintainer-policy-no-compiler-side-workaroun.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789500967936-slang-maintainer-policy-no-compiler-side-workaroun.md`_

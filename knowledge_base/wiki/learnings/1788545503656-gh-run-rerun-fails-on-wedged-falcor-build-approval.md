---
title: "gh run rerun fails on wedged falcor-build-approval-gate even when the target job already failed"
type: learning
topic: agent-ops
source: learnings/1788545503656-gh-run-rerun-fails-on-wedged-falcor-build-approval.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1788545503656-gh-run-rerun-fails-on-wedged-falcor-build-approval.md`_

---
title: "On a draft PR, `statusCheckRollup` and `commits/<sha>/check-runs` expose DIFFERENT SETS — a manual-dispatch matrix can be fully green and invisible on the PR page"
type: learning
topic: misc
source: learnings/1786280978623-on-a-draft-pr-statuscheckrollup-and-commits-sha-ch.md
---

---
title: "[approver/infra-abstain] A critique-gate hook's 'escalation opened' is a LOCAL self-heal file, not a host escalation row — check forwarded_at before reporting one exists"
type: learning
topic: review-approval
source: learnings/1787552737647-approver-infra-abstain-a-critique-gate-hook-s-esca.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787552737647-approver-infra-abstain-a-critique-gate-hook-s-esca.md`_

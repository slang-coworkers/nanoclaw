---
title: "check-submodules can go red repo-wide when an upstream flips its default branch"
type: learning
topic: misc
source: learnings/1785983137542-check-submodules-can-go-red-repo-wide-when-an-upst.md
---

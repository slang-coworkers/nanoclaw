---
title: "Perf-infra epic sub-tasks (benchview/backtest) are non-actionable ops, not compiler triage"
type: learning
topic: slang-compiler
source: learnings/1788881515231-perf-infra-epic-sub-tasks-benchview-backtest-are-n.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788881515231-perf-infra-epic-sub-tasks-benchview-backtest-are-n.md`_

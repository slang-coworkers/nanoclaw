---
title: "[approver/critique-mustfix] Green CI on a coverage PR is necessary, NOT sufficient — the challenger must still trace the NEW code's public-API paths"
type: learning
topic: review-approval
source: learnings/1786485852581-approver-critique-mustfix-green-ci-on-a-coverage-p.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786485852581-approver-critique-mustfix-green-ci-on-a-coverage-p.md`_

---
title: "[approver/challenger-miss] A formatting/dispatch fix can redden the very CI check that runs the tool — verify the activated check, not the combined status"
type: learning
topic: review-approval
source: learnings/1787085931116-approver-challenger-miss-a-formatting-dispatch-fix.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787085931116-approver-challenger-miss-a-formatting-dispatch-fix.md`_

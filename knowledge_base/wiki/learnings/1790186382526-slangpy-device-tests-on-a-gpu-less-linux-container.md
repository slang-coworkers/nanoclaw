---
title: "SlangPy device tests on a GPU-less Linux container: DEFAULT_DEVICE_TYPES = [vulkan, cuda], no cpu"
type: learning
topic: slang-compiler
source: learnings/1790186382526-slangpy-device-tests-on-a-gpu-less-linux-container.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1790186382526-slangpy-device-tests-on-a-gpu-less-linux-container.md`_

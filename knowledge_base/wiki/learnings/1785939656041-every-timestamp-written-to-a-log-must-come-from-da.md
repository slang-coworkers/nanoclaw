---
title: "Every timestamp written to a log must come from date -u at write time, never retyped"
type: learning
topic: misc
source: learnings/1785939656041-every-timestamp-written-to-a-log-must-come-from-da.md
---

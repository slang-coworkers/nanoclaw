---
title: "Bodyless-kernel SIGSEGV fix must gate before ALL pytorch/cuda passes, not per-site — sink has no dedup"
type: learning
topic: agent-ops
source: learnings/1786714887238-bodyless-kernel-sigsegv-fix-must-gate-before-all-p.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786714887238-bodyless-kernel-sigsegv-fix-must-gate-before-all-p.md`_

---
title: "Slang build: never run two ninja builds in the same build/ dir — objcopy 'input file is empty' race"
type: learning
topic: slang-compiler
source: learnings/1787615532680-slang-build-never-run-two-ninja-builds-in-the-same.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787615532680-slang-build-never-run-two-ninja-builds-in-the-same.md`_

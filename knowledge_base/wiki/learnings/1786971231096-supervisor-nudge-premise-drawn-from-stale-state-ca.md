---
title: "supervisor nudge premise drawn from stale state can inject a wrong chain's disposition"
type: learning
topic: agent-ops
source: learnings/1786971231096-supervisor-nudge-premise-drawn-from-stale-state-ca.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786971231096-supervisor-nudge-premise-drawn-from-stale-state-ca.md`_

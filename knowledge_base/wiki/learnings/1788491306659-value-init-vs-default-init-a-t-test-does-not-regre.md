---
title: "Value-init vs default-init: a `T{}` test does not regress a new default-member-initializer"
type: learning
topic: misc
source: learnings/1788491306659-value-init-vs-default-init-a-t-test-does-not-regre.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788491306659-value-init-vs-default-init-a-t-test-does-not-regre.md`_

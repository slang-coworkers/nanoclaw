---
title: "GitHub baseRefOid is the base-branch tip, not the PR fork point — and the MatrixLayoutMode base-skew signature"
type: learning
topic: agent-ops
source: learnings/1789436666000-github-baserefoid-is-the-base-branch-tip-not-the-p.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789436666000-github-baserefoid-is-the-base-branch-tip-not-the-p.md`_

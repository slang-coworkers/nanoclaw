---
title: "Manually dispatching ci.yml on a DRAFT slang PR produces a spurious test-falcor failure (missing build artifact)"
type: learning
topic: ci-tooling
source: learnings/1789147576274-manually-dispatching-ci-yml-on-a-draft-slang-pr-pr.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1789147576274-manually-dispatching-ci-yml-on-a-draft-slang-pr-pr.md`_

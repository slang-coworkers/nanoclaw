---
title: "Arch-only miscompile: refute the triage root cause with a poison test, then let whole-process valgrind find the real uninitialized read"
type: learning
topic: agent-ops
source: learnings/1788340267545-arch-only-miscompile-refute-the-triage-root-cause-.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1788340267545-arch-only-miscompile-refute-the-triage-root-cause-.md`_

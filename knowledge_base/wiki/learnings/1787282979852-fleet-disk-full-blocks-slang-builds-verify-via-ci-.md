---
title: "Fleet disk-full blocks Slang builds; verify via CI, and FIDDLE line-shift breaks single-file syntax checks"
type: learning
topic: ci-tooling
source: learnings/1787282979852-fleet-disk-full-blocks-slang-builds-verify-via-ci-.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1787282979852-fleet-disk-full-blocks-slang-builds-verify-via-ci-.md`_

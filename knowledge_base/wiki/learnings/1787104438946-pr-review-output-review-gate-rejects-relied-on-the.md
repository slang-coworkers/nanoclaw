---
title: "PR-review OUTPUT_REVIEW gate rejects 'relied on the fixer's test run' — build+run it yourself in a detached worktree"
type: learning
topic: agent-ops
source: learnings/1787104438946-pr-review-output-review-gate-rejects-relied-on-the.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787104438946-pr-review-output-review-gate-rejects-relied-on-the.md`_

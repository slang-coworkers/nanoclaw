---
title: "[approver/challenger] A comment-only revision does NOT resolve a prior revision's correctness flag; and a re-run primary '0 bugs' never rounds up over persistent independent secondary correctness flags on the core purpose"
type: learning
topic: review-approval
source: learnings/1788348283179-approver-challenger-a-comment-only-revision-does-n.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788348283179-approver-challenger-a-comment-only-revision-does-n.md`_

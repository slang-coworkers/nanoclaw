---
title: "SPIR-V compile-only tests are render-API tagged; verify with direct slangc, not slang-test"
type: learning
topic: slang-compiler
source: learnings/1790009629117-spir-v-compile-only-tests-are-render-api-tagged-ve.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1790009629117-spir-v-compile-only-tests-are-render-api-tagged-ve.md`_

---
title: "slang formatting.sh does NOT check markdown in CI's run_all path"
type: learning
topic: slang-compiler
source: learnings/1786614164763-slang-formatting-sh-does-not-check-markdown-in-ci-.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786614164763-slang-formatting-sh-does-not-check-markdown-in-ci-.md`_

---
title: "[approver/clause-gap] Resolved policy_version can flip a PR's decision across sessions — log it and diff it per PR"
type: learning
topic: review-approval
source: learnings/1788220724120-approver-clause-gap-resolved-policy-version-can-fl.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788220724120-approver-clause-gap-resolved-policy-version-can-fl.md`_

---
title: "[approver/human-agreement] Human CHANGES_REQUESTED confirmed a prior OPEN_GAP on the exact residual — a synchronize that only merges master doesn't move the decision"
type: learning
topic: review-approval
source: learnings/1787580499467-approver-human-agreement-human-changes-requested-c.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787580499467-approver-human-agreement-human-changes-requested-c.md`_

---
title: "gh api has no --arg flag: --jq --arg silently yields zero rows on every loop iteration"
type: learning
topic: misc
source: learnings/1785868475644-gh-api-has-no-arg-flag-jq-arg-silently-yields-zero.md
---

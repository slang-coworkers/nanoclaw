---
title: "github.pr_merged webhook head_sha is the PR BRANCH TIP, not the squash-merge commit — resolve the real master SHA before citing it"
type: learning
topic: agent-ops
source: learnings/1787138985818-github-pr-merged-webhook-head-sha-is-the-pr-branch.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787138985818-github-pr-merged-webhook-head-sha-is-the-pr-branch.md`_

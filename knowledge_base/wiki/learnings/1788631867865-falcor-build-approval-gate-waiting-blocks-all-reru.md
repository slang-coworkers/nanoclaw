---
title: "falcor-build-approval-gate 'waiting' blocks ALL reruns in that run, not just Falcor jobs"
type: learning
topic: agent-ops
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1788631867865-falcor-build-approval-gate-waiting-blocks-all-reru.md`_

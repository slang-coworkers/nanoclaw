---
title: "Copy the command from their text — never retype it from their description"
type: learning
topic: slang-compiler
source: learnings/1786268741453-copy-the-command-from-their-text-never-retype-it-f.md
---
...
---
_Topic: [Slang compiler & language](wiki/topics/slang-compiler.md) · [catalog](wiki/index.md) · source: `sources/learnings/1786268741453-copy-the-command-from-their-text-never-retype-it-f.md`_

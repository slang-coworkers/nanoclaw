---
title: "A checker needs its own adversary, not its own control — three ways my verifier reported PASS when it should have failed"
type: learning
topic: misc
source: learnings/1786003403473-a-checker-needs-its-own-adversary-not-its-own-cont.md
---

---
title: "A closing-sum assert guards completeness, never correctness — and a sabotage that FAILS to trip a guard maps its real edge"
type: learning
topic: misc
source: learnings/1785992933827-a-closing-sum-assert-guards-completeness-never-cor.md
---

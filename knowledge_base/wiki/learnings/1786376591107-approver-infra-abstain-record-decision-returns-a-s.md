---
title: "[approver/infra-abstain] record_decision returns a success string even when the host DENIES the ledger append"
type: learning
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786376591107-approver-infra-abstain-record-decision-returns-a-s.md`_

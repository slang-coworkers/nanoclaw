---
title: "Implementation gap in WIP draft-PR code is not a Bug — don't set Issue Type=Bug on dev tracking issues"
type: learning
topic: misc
source: learnings/1788367478397-implementation-gap-in-wip-draft-pr-code-is-not-a-b.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788367478397-implementation-gap-in-wip-draft-pr-code-is-not-a-b.md`_

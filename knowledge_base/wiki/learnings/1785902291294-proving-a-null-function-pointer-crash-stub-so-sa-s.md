---
title: "Proving a null-function-pointer crash: stub .so + SA_SIGINFO, and why a truncated backtrace IS the signature"
type: learning
topic: misc
source: learnings/1785902291294-proving-a-null-function-pointer-crash-stub-so-sa-s.md
---

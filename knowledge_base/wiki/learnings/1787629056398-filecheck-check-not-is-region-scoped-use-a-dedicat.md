---
title: "FileCheck CHECK-NOT is region-scoped — use a dedicated NOT-only prefix for a whole-output 'never appears' scan"
type: learning
topic: misc
source: learnings/1787629056398-filecheck-check-not-is-region-scoped-use-a-dedicat.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787629056398-filecheck-check-not-is-region-scoped-use-a-dedicat.md`_

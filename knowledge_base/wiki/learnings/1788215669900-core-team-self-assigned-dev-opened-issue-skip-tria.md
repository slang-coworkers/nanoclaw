---
title: "Core-team self-assigned 'Dev Opened' issue → skip triage even when it looks juicy"
type: learning
topic: agent-ops
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1788215669900-core-team-self-assigned-dev-opened-issue-skip-tria.md`_

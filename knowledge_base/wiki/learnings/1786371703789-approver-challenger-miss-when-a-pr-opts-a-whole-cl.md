---
title: "[approver/challenger-miss] When a PR opts a whole class into concurrency, audit the guard's scope against EVERY sibling entry point that touches the same shared state"
type: learning
topic: review-approval
source: learnings/1786371703789-approver-challenger-miss-when-a-pr-opts-a-whole-cl.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786371703789-approver-challenger-miss-when-a-pr-opts-a-whole-cl.md`_

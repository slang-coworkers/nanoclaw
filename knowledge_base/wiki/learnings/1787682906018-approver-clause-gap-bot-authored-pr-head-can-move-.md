---
title: "[approver/clause-gap] Bot-authored PR head can move mid-decision — the critique gate can surface a fix the author ships next"
type: learning
topic: review-approval
source: learnings/1787682906018-approver-clause-gap-bot-authored-pr-head-can-move-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787682906018-approver-clause-gap-bot-authored-pr-head-can-move-.md`_

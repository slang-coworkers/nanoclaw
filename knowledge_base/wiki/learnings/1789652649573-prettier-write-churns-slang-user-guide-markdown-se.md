---
title: "prettier --write churns Slang user-guide markdown (setext→ATX) — never blanket-format a doc"
type: learning
topic: slang-compiler
source: learnings/1789652649573-prettier-write-churns-slang-user-guide-markdown-se.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789652649573-prettier-write-churns-slang-user-guide-markdown-se.md`_

---
title: "okf-synth finalize: run it exactly once per pass, and the root triage-memo population grows faster than a 4-item fold"
type: learning
topic: agent-ops
source: learnings/1787285821812-okf-synth-finalize-run-it-exactly-once-per-pass-an.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787285821812-okf-synth-finalize-run-it-exactly-once-per-pass-an.md`_

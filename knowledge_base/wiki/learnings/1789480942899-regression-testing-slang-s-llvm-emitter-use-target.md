---
title: "Regression-testing Slang's LLVM emitter: use -target llvm-host-ir -o -, not host-callable"
type: learning
topic: slang-compiler
source: learnings/1789480942899-regression-testing-slang-s-llvm-emitter-use-target.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789480942899-regression-testing-slang-s-llvm-emitter-use-target.md`_

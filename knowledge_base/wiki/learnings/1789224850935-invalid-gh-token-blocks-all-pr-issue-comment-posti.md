---
title: "Invalid GH_TOKEN blocks all PR/issue-comment posting — delegate or refresh, don't spin"
type: learning
topic: agent-ops
source: learnings/1789224850935-invalid-gh-token-blocks-all-pr-issue-comment-posti.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789224850935-invalid-gh-token-blocks-all-pr-issue-comment-posti.md`_

---
title: "[approver/infra-abstain] A production review check-run can go GREEN having posted NOTHING — every step succeeds while the agent ends its turn waiting for subagents"
type: learning
topic: review-approval
source: learnings/1786400661803-approver-infra-abstain-a-production-review-check-r.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786400661803-approver-infra-abstain-a-production-review-check-r.md`_

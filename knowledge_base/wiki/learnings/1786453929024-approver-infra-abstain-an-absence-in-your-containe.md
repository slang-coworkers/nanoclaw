---
title: "[approver/infra-abstain] An absence in YOUR container is not evidence about a HOST-OWNED store — and `record_decision` returns 'Decision recorded' after a bare enqueue"
type: learning
topic: review-approval
source: learnings/1786453929024-approver-infra-abstain-an-absence-in-your-containe.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786453929024-approver-infra-abstain-an-absence-in-your-containe.md`_

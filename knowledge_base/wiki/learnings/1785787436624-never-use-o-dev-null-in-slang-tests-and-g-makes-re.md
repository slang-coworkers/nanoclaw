---
title: "Never use `-o /dev/null` in slang tests — and `-g` makes `result code` assertions self-match"
type: learning
topic: slang-compiler
source: learnings/1785787436624-never-use-o-dev-null-in-slang-tests-and-g-makes-re.md
---

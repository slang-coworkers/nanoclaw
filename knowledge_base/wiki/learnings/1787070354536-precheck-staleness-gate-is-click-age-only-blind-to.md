---
title: "Precheck staleness gate is click-age-only, blind to existing replies"
type: learning
topic: agent-ops
source: learnings/1787070354536-precheck-staleness-gate-is-click-age-only-blind-to.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787070354536-precheck-staleness-gate-is-click-age-only-blind-to.md`_

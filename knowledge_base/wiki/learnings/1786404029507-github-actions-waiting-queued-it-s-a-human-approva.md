---
title: "GitHub Actions `waiting` ≠ queued — it's a human approval gate, and it can jam a fleet's CI retry mechanism indefinitely"
type: learning
topic: agent-ops
source: learnings/1786404029507-github-actions-waiting-queued-it-s-a-human-approva.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1786404029507-github-actions-waiting-queued-it-s-a-human-approva.md`_

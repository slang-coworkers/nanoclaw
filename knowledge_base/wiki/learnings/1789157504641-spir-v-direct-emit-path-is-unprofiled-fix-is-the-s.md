---
title: "SPIR-V direct-emit path is unprofiled — fix is the symmetric SLANG_PROFILE mirror of the text path (issue #13016)"
type: learning
topic: slang-compiler
source: learnings/1789157504641-spir-v-direct-emit-path-is-unprofiled-fix-is-the-s.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789157504641-spir-v-direct-emit-path-is-unprofiled-fix-is-the-s.md`_

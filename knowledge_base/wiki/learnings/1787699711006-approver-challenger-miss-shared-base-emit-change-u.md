---
title: "[approver/challenger-miss] 'Shared-base emit change untested on target X' is not an OPEN_GAP if X inherits the base and already has a valid emit path + existing test"
type: learning
topic: review-approval
source: learnings/1787699711006-approver-challenger-miss-shared-base-emit-change-u.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1787699711006-approver-challenger-miss-shared-base-emit-change-u.md`_

---
title: "Approver policy mount source missing → all approvals fall back to bundled default"
type: learning
topic: review-approval
source: learnings/1788380182368-approver-policy-mount-source-missing-all-approvals.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1788380182368-approver-policy-mount-source-missing-all-approvals.md`_

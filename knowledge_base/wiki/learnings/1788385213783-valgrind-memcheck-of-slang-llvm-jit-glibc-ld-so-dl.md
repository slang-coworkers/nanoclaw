---
title: "valgrind memcheck of slang-llvm JIT: glibc ld.so/dlopen $ORIGIN errors are false positives — filter to slang frames"
type: learning
topic: slang-compiler
source: learnings/1788385213783-valgrind-memcheck-of-slang-llvm-jit-glibc-ld-so-dl.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1788385213783-valgrind-memcheck-of-slang-llvm-jit-glibc-ld-so-dl.md`_

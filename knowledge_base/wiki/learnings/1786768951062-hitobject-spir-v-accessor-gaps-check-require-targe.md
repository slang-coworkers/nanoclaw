---
title: "HitObject SPIR-V accessor gaps: check [require] target set AND __target_switch cases together"
type: learning
topic: slang-compiler
source: learnings/1786768951062-hitobject-spir-v-accessor-gaps-check-require-targe.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786768951062-hitobject-spir-v-accessor-gaps-check-require-targe.md`_

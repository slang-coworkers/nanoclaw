---
title: "[approver/challenger-pattern] Reused flat-only helper at a new call site — verify it flattens first"
type: learning
topic: review-approval
source: learnings/1789078899092-approver-challenger-pattern-reused-flat-only-helpe.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1789078899092-approver-challenger-pattern-reused-flat-only-helpe.md`_

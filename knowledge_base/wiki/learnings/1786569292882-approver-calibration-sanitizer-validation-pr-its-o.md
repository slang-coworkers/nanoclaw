---
title: "[approver/calibration] sanitizer-validation PR — its own control red + author-declared WIP = ABSTAIN, not BLOCK (verified UB in pre-existing code is not a change-defect)"
type: learning
topic: review-approval
source: learnings/1786569292882-approver-calibration-sanitizer-validation-pr-its-o.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786569292882-approver-calibration-sanitizer-validation-pr-its-o.md`_

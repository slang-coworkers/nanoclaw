---
title: "Clearing mergeStateStatus=BEHIND on an approved PR: merge master in (don't rebase) — preserves approval, no force-push, auto-reruns CI"
type: learning
topic: ci-tooling
source: learnings/1789535383508-clearing-mergestatestatus-behind-on-an-approved-pr.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1789535383508-clearing-mergestatestatus-behind-on-an-approved-pr.md`_

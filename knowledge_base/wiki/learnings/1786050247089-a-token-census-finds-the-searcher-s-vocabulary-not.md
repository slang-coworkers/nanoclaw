---
title: "A token census finds the searcher's vocabulary, not the finding — so 'neither party authored this' is usually a query bug"
type: learning
topic: misc
source: learnings/1786050247089-a-token-census-finds-the-searcher-s-vocabulary-not.md
---

---
title: "[approver/clause-gap] The approval policy silently falls back to the STRICT bundled default when its mount is absent — measured 12/279 runs, and clauses.json makes it auditable"
type: learning
topic: review-approval
source: learnings/1786459972267-approver-clause-gap-the-approval-policy-silently-f.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786459972267-approver-clause-gap-the-approval-policy-silently-f.md`_

---
title: "Reducing a PR to test-only after the source fix merged elsewhere: rebase mechanic + FileCheck whitespace trap"
type: learning
topic: ci-tooling
source: learnings/1787552911744-reducing-a-pr-to-test-only-after-the-source-fix-me.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1787552911744-reducing-a-pr-to-test-only-after-the-source-fix-me.md`_

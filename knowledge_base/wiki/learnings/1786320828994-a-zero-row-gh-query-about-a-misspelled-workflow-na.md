---
title: "A zero-row gh query about a misspelled workflow name is an instrument failure, not a dead workflow"
type: learning
topic: misc
source: learnings/1786320828994-a-zero-row-gh-query-about-a-misspelled-workflow-na.md
---

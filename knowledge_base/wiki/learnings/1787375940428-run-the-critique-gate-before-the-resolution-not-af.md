---
title: "Run the critique gate BEFORE the [Resolution], not after — and it catches your own specs"
type: learning
topic: agent-ops
source: learnings/1787375940428-run-the-critique-gate-before-the-resolution-not-af.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787375940428-run-the-critique-gate-before-the-resolution-not-af.md`_

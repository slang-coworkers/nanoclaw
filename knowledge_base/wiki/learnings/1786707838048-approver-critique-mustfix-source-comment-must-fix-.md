---
title: "[approver/critique-mustfix] Source-comment must-fix a read-only approver can't clear → ABSTAIN_POLICY:ESCALATED, not WOULD_APPROVE"
type: learning
topic: review-approval
source: learnings/1786707838048-approver-critique-mustfix-source-comment-must-fix-.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786707838048-approver-critique-mustfix-source-comment-must-fix-.md`_

---
title: "gh CLI works for repo-scoped writes despite 'invalid token' — GH_TOKEN is a OneCLI routing sentinel"
type: learning
topic: agent-ops
source: learnings/1789099182120-gh-cli-works-for-repo-scoped-writes-despite-invali.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789099182120-gh-cli-works-for-repo-scoped-writes-despite-invali.md`_

---
title: "[approver/infra-abstain] Scope a gate claim to the LAYER, not just the edge — a PreToolUse hook is invisible to a peer grepping the host source, so both 'blocked' and 'works fine' are true at once"
type: learning
topic: review-approval
source: learnings/1786386936182-approver-infra-abstain-scope-a-gate-claim-to-the-l.md
---
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786386936182-approver-infra-abstain-scope-a-gate-claim-to-the-l.md`_

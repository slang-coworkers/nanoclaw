---
title: "Assert-comment that claims impossibility contradicts a documented fail-loud case — clarity flag, not a bug"
type: learning
topic: verification
source: learnings/1789022104970-assert-comment-that-claims-impossibility-contradic.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1789022104970-assert-comment-that-claims-impossibility-contradic.md`_

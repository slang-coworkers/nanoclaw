---
title: "slangpy#1167 — bwds() hang on runtime-loop IDiffTensor load is a SlangPy-codegen-specific Slang autodiff regression (not pure-Slang reproducible)"
type: learning
topic: slang-compiler
source: learnings/1789715066934-slangpy-1167-bwds-hang-on-runtime-loop-idifftensor.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1789715066934-slangpy-1167-bwds-hang-on-runtime-loop-idifftensor.md`_

---
title: "A one-shot time-gated nudge needs a durable 'already-fired' latch, not just data conditions + live re-verification"
type: learning
topic: agent-ops
source: learnings/1788102208361-a-one-shot-time-gated-nudge-needs-a-durable-alread.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1788102208361-a-one-shot-time-gated-nudge-needs-a-durable-alread.md`_

---
title: "CI evidence in this repo: tests are STEPS inside build jobs, and three ways a scan lies about them"
type: learning
topic: ci-tooling
source: learnings/1785961540178-ci-evidence-in-this-repo-tests-are-steps-inside-bu.md
---

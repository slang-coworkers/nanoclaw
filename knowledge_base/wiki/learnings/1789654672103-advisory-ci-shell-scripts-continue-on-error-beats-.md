---
title: "Advisory CI shell scripts: continue-on-error beats per-probe || true; and the bot can't edit .github/workflows"
type: learning
topic: ci-tooling
source: learnings/1789654672103-advisory-ci-shell-scripts-continue-on-error-beats-.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1789654672103-advisory-ci-shell-scripts-continue-on-error-beats-.md`_

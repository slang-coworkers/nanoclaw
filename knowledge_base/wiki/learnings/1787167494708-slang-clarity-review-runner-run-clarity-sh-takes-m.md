---
title: "slang-clarity-review-runner run-clarity.sh takes --mode directly, not a run-clarity subcommand"
type: learning
topic: slang-compiler
source: learnings/1787167494708-slang-clarity-review-runner-run-clarity-sh-takes-m.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787167494708-slang-clarity-review-runner-run-clarity-sh-takes-m.md`_

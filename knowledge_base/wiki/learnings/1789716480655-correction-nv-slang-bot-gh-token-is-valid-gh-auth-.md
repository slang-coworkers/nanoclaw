---
title: "CORRECTION: nv-slang-bot GH_TOKEN is VALID — `gh auth status` is cosmetically wrong; use `gh api` (not `gh issue create`) or the onecli-gateway"
type: learning
topic: agent-ops
source: learnings/1789716480655-correction-nv-slang-bot-gh-token-is-valid-gh-auth-.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1789716480655-correction-nv-slang-bot-gh-token-is-valid-gh-auth-.md`_

---
title: "Testing CUDA fp-mode-fast redirect: -target ptx approx-op FileCheck is confounded by NVRTC --use_fast_math"
type: learning
topic: misc
source: learnings/1788296956279-testing-cuda-fp-mode-fast-redirect-target-ptx-appr.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788296956279-testing-cuda-fp-mode-fast-redirect-target-ptx-appr.md`_

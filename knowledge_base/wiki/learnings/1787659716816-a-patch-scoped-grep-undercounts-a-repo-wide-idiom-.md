---
title: "A patch-scoped grep undercounts a repo-wide idiom's blast radius; host-conditional guards need per-platform blast-radius checks"
type: learning
topic: misc
source: learnings/1787659716816-a-patch-scoped-grep-undercounts-a-repo-wide-idiom-.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1787659716816-a-patch-scoped-grep-undercounts-a-repo-wide-idiom-.md`_

---
title: "The receipt for 'I routed X' is a session row on X's edge, not a memory note"
type: learning
topic: agent-ops
source: learnings/1787068230691-the-receipt-for-i-routed-x-is-a-session-row-on-x-s.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1787068230691-the-receipt-for-i-routed-x-is-a-session-row-on-x-s.md`_

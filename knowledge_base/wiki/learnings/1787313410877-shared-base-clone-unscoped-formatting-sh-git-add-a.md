---
title: "Shared base clone: unscoped formatting.sh + git add -A absorbs sibling files; verify with three-dot / HEAD^..HEAD"
type: learning
topic: verification
source: learnings/1787313410877-shared-base-clone-unscoped-formatting-sh-git-add-a.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1787313410877-shared-base-clone-unscoped-formatting-sh-git-add-a.md`_

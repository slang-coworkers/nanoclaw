---
title: "Investigation-only deliverables stay in the analysis tier — don't add a fixer handoff for a read-only comment"
type: learning
topic: agent-ops
source: learnings/1788542147628-investigation-only-deliverables-stay-in-the-analys.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1788542147628-investigation-only-deliverables-stay-in-the-analys.md`_

---
title: "gh run view --log outside a git repo writes zero-byte logs, and a same-source control also reads 0"
type: learning
topic: misc
source: learnings/1786459337890-gh-run-view-log-outside-a-git-repo-writes-zero-byt.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1786459337890-gh-run-view-log-outside-a-git-repo-writes-zero-byt.md`_

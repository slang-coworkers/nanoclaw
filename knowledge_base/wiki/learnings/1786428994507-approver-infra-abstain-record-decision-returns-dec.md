---
title: "[approver/infra-abstain] record_decision returns 'Decision recorded' while the host denies it — verify APPROVAL_LEDGER_WRITERS, not the return string"
type: learning
...
---
_Topic: [PR review, approval & calibration](../topics/review-approval.md) · [catalog](../index.md) · source: `sources/learnings/1786428994507-approver-infra-abstain-record-decision-returns-dec.md`_

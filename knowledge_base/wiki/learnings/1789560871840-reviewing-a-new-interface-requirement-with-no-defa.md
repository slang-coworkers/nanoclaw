---
title: "Reviewing a new interface requirement with no default: build-green answers 'any conformer missed?'"
type: learning
topic: ci-tooling
source: learnings/1789560871840-reviewing-a-new-interface-requirement-with-no-defa.md
---
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1789560871840-reviewing-a-new-interface-requirement-with-no-defa.md`_

---
title: "slang-rhi ConstantBufferPool is per-command-buffer, duplicated across 5 backends, and reset() frees pages only on CUDA"
type: learning
topic: slang-compiler
source: learnings/1787809893009-slang-rhi-constantbufferpool-is-per-command-buffer.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1787809893009-slang-rhi-constantbufferpool-is-per-command-buffer.md`_

---
title: "Slang HLSL float atomic-add is NVAPI-only and emitted silently; autodiff is not the producer"
type: learning
topic: slang-compiler
source: learnings/1786551719062-slang-hlsl-float-atomic-add-is-nvapi-only-and-emit.md
---
...
---
_Topic: [Slang compiler & language](../topics/slang-compiler.md) · [catalog](../index.md) · source: `sources/learnings/1786551719062-slang-hlsl-float-atomic-add-is-nvapi-only-and-emit.md`_

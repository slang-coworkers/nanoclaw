---
title: "Verify language-version atoms at current HEAD before claiming 'only in PR #N'"
type: learning
topic: verification
source: learnings/1787047001356-verify-language-version-atoms-at-current-head-befo.md
---
...
---
_Topic: [Verification & evidence discipline](../topics/verification.md) · [catalog](../index.md) · source: `sources/learnings/1787047001356-verify-language-version-atoms-at-current-head-befo.md`_

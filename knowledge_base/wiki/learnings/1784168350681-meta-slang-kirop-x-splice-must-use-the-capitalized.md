---
title: "meta.slang $(kIROp_X) splice must use the CAPITALIZED enum name, not the lua key"
type: learning
topic: slang-compiler
source: learnings/1784168350681-meta-slang-kirop-x-splice-must-use-the-capitalized.md
---

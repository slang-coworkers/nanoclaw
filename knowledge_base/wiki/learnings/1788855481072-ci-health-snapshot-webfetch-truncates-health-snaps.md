---
title: "CI health snapshot: WebFetch truncates health_snapshots.jsonl — fetch the tail directly"
type: learning
topic: ci-tooling
...
---
_Topic: [CI, build & tooling](../topics/ci-tooling.md) · [catalog](../index.md) · source: `sources/learnings/1788855481072-ci-health-snapshot-webfetch-truncates-health-snaps.md`_

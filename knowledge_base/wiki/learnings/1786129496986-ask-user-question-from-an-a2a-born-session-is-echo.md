---
title: "ask_user_question from an a2a-born session is echo-dropped as a noop — the card is emitted, counted, and arrives payload-less"
type: learning
topic: agent-ops
source: learnings/1786129496986-ask-user-question-from-an-a2a-born-session-is-echo.md
---

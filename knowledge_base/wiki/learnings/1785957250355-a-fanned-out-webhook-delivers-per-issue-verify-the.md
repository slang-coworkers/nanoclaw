---
title: "A fanned-out webhook delivers per-issue — verify the whole set, not your own arrival"
type: learning
topic: agent-ops
source: learnings/1785957250355-a-fanned-out-webhook-delivers-per-issue-verify-the.md
---

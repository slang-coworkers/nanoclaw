---
title: "FileCheck: assert 'X never appears' robustly with a CHECK-DAG/CHECK-NOT/CHECK-DAG barrier; -g2 quote-escaping discriminates negatives"
type: learning
topic: misc
source: learnings/1788754022134-filecheck-assert-x-never-appears-robustly-with-a-c.md
---
...
---
_Topic: [Uncategorized](../topics/misc.md) · [catalog](../index.md) · source: `sources/learnings/1788754022134-filecheck-assert-x-never-appears-robustly-with-a-c.md`_

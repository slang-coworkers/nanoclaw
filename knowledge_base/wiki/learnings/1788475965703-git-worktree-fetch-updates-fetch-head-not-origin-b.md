---
title: "Git worktree: fetch updates FETCH_HEAD not origin/<branch> → force-with-lease fails 'stale info'; codex-critique can't read /tmp"
type: learning
topic: agent-ops
source: learnings/1788475965703-git-worktree-fetch-updates-fetch-head-not-origin-b.md
---
...
---
_Topic: [NanoClaw / agent operations](../topics/agent-ops.md) · [catalog](../index.md) · source: `sources/learnings/1788475965703-git-worktree-fetch-updates-fetch-head-not-origin-b.md`_

...
- [Approved PR can still be merge-BLOCKED by an unresolved human review thread (require-conversation-resolution)](../learnings/1789499918969-approved-pr-can-still-be-merge-blocked-by-an-unres.md)
...
- [gh auth status is misleading in the reviewer container — pr-mode reviews work](../learnings/1789463556885-gh-auth-status-is-misleading-in-the-reviewer-conta.md)
...
- [Round-2 PR review: delta-verify instead of full pipeline re-run when fix logic is unchanged](../learnings/1789491455857-round-2-pr-review-delta-verify-instead-of-full-pip.md)
...
- [Verify a PR's actual review state before framing it as idle-mergeable](../learnings/1790310304171-verify-a-pr-s-actual-review-state-before-framing-i.md)

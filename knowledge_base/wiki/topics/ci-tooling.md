...
- [[approver/calibration] CI workflow that merges+builds an untrusted PR: CWE-522 persist-credentials is blocking only under specific factors](../learnings/1788905666798-approver-calibration-ci-workflow-that-merges-build.md)
...
- [[approver/challenger-miss] An in-process before/after split refutes the "bad CI runner" confound that a base-vs-head comparison alone cannot](../learnings/1786386011669-approver-challenger-miss-an-in-process-before-afte.md)
- [[approver/challenger-miss] Release PR bumping a just-published dep tag: check the BUILD CI, not tag existence](../learnings/1787953794879-approver-challenger-miss-release-pr-bumping-a-just.md)
...
- [[approver/clause-gap] ci_green_on_sha FALSE-PASSES on slang-rhi when a trivial status-poster is green while build check-runs are red](../learnings/1788374870675-approver-clause-gap-ci-green-on-sha-false-passes-o.md)
- [[approver/clause-gap] ci_green_on_sha folds commits/SHA/status — GREEN over the wrong object set; every compiled build is a check-run it cannot see](../learnings/1786437258677-approver-clause-gap-ci-green-on-sha-folds-commits-.md)
...
- [[approver/clause-gap] ci_green_on_sha reads combined status, blind to build check-runs](../learnings/1787214497184-approver-clause-gap-ci-green-on-sha-reads-combined.md)
- [[approver/clause-gap] ci_green_on_sha reads combined-status only — blind to GitHub Actions check-runs (the real build matrix)](../learnings/1787045208678-approver-clause-gap-ci-green-on-sha-reads-combined.md)
- [[approver/clause-gap] ci_green_on_sha reads legacy combined-status, not the build check-runs — false-green risk](../learnings/1788518242912-approver-clause-gap-ci-green-on-sha-reads-legacy-c.md)
...
- [[approver/confirmed-safe] JOIN confirmed: interim CUDA half-texture SampleLevel diagnostic guard merged unchanged at my decided commit](../learnings/1787623007634-approver-confirmed-safe-join-confirmed-interim-cud.md)
- [[approver/confirmed] Test-only regression PR: confirm the NEW test ran green in the CI job that actually runs it, not just Devin-clean](../learnings/1787148033918-approver-confirmed-test-only-regression-pr-confirm.md)
- [[approver/dispatch] Maintainer re-request on an already-decided unchanged head: re-verify, don't no-op or blind-trust](../learnings/1787294720097-approver-dispatch-maintainer-re-request-on-an-alre.md)
- [[approver/false-safe] Disclosing that your decision is outcome-contaminated is itself a claim about your own artifacts — measure the mtimes, don't narrate them](../learnings/1786412553806-approver-false-safe-disclosing-that-your-decision-.md)
...
- [[approver/infra] slangpy PR CI never runs root setup.py (CMake build); + CodeRabbit re-reviews in-place — read coveredCommitId, and settle-watch head storms](../learnings/1788518272934-approver-infra-slangpy-pr-ci-never-runs-root-setup.md)
...
- [A 3h runner-fleet outage stayed BELOW the queue-depth alarm — alarm on age and fleet size](../learnings/1786395185201-a-3h-runner-fleet-outage-stayed-below-the-queue-de.md)
...
- [A build launched inside an Agent subagent dies with it — and ninja reports it as "interrupted by user"](../learnings/1786384310274-a-build-launched-inside-an-agent-subagent-dies-wit.md)
...
- [A burst of bounced handoffs is one incident with N victims — re-drive all, diagnose once](../learnings/1786388767272-a-burst-of-bounced-handoffs-is-one-incident-with-n.md)
...
- [A cited error line number that doesn't match the file is usually a format offset, not a bad citation](../learnings/1786381124227-a-cited-error-line-number-that-doesn-t-match-the-f.md)
...
- [A closure that cites feature removal is scoped to the versions that removed it — check the DEFAULT path before treating it as a dedup](../learnings/1786412442845-a-closure-that-cites-feature-removal-is-scoped-to-.md)
...
- [A constant position-independent delta refutes both fp-precision and direction·t](../learnings/1786562304678-a-constant-position-independent-delta-refutes-both.md)
- [A correct general rule launders a wrong specific instance — re-run the command before asserting what it returned](../learnings/1786365239236-a-correct-general-rule-launders-a-wrong-specific-i.md)
...
- [A family-specific capability case in __target_switch needs an explicit base-family arm (else E41012)](../learnings/1789575168359-a-family-specific-capability-case-in-target-switch.md)
...
- [A generated doc checked byte-exact by CI must NOT be run through prettier — and CI's formatting.sh never reaches markdown](../learnings/1786409326017-a-generated-doc-checked-byte-exact-by-ci-must-not-.md)
...
- [A hash identifies a representation, not a resource: two authentic gh paths give different md5s for one CI log](../learnings/1786364370792-a-hash-identifies-a-representation-not-a-resource-.md)
...
- [A live_late approval decision on an already-merged PR has no publisher](../learnings/1786386627465-a-live-late-approval-decision-on-an-already-merged.md)
...
- [A PR can reach its terminal state while your decision is still running — re-read state/mergedAt immediately before writing any join line](../learnings/1786388078044-a-pr-can-reach-its-terminal-state-while-your-decis.md)
...
- [A pre-checkout runner-death probe must require runner_name non-null (dur<60s alone manufactures a fake pool trend)](../learnings/1786357018657-a-pre-checkout-runner-death-probe-must-require-run.md)
...
- [A prefix-requiring grep recipe undercounts an id union the source text writes bare](../learnings/1786402949849-a-prefix-requiring-grep-recipe-undercounts-an-id-u.md)
...
- [A red external-CI lane on a frozen PR head can be an expired-artifact infra flake — prove it with a master control before treating it as a blocker](../learnings/1787100709269-a-red-external-ci-lane-on-a-frozen-pr-head-can-be-.md)
...
- [A true description of the cells you ran is not a rule: build the cell where your two candidate criteria DISAGREE](../learnings/1786382599427-a-true-description-of-the-cells-you-ran-is-not-a-r.md)
...
- [A wrong diagnostic-emission-site cite is not stale, it was wrong when written — and -skip-codegen is the discriminator](../learnings/1786454619306-a-wrong-diagnostic-emission-site-cite-is-not-stale.md)
...
- [A zero-capacity alarm needs the CONJUNCTION with demand, not the zero](../learnings/1786438759188-a-zero-capacity-alarm-needs-the-conjunction-with-d.md)
...
- [An expired CI job log still has its run artifact — and it can invert your premise](../learnings/1786396604746-an-expired-ci-job-log-still-has-its-run-artifact-a.md)
...
- [Anticipatory-guard issues: verify the invariant against ToT, not the issue's premise](../learnings/1787818183441-anticipatory-guard-issues-verify-the-invariant-aga.md)
- [approver-human-reviews-are-not-a-decision-input-tier](../learnings/1787712111448-approver-human-reviews-are-not-a-decision-input-ti.md)
...
- [Bot auto-filing an adjacent P3 follow-up issue can read as noise to maintainers — prefer surfacing over filing unless the finding is standalone-actionable](../learnings/1788204809444-bot-auto-filing-an-adjacent-p3-follow-up-issue-can.md)
- [Bot commits must use the account-associated noreply email or CLA-assistant blocks merge](../learnings/1789476879264-bot-commits-must-use-the-account-associated-norepl.md)
- [Bot follow-up issues can cite a prerequisite PR that isn't merged yet — verify the base exists in master](../learnings/1787077394524-bot-follow-up-issues-can-cite-a-prerequisite-pr-th.md)
...
- [Class identity cast (C)c / C(c) regresses when ClassDecl excluded from ResolveInvoke coercion fast-path](../learnings/1786589858732-class-identity-cast-c-c-c-c-regresses-when-classde.md)
- [Classify-only CI subagent fabricated a cross-repo finding, not just risked over-acting](../learnings/1786969122532-classify-only-ci-subagent-fabricated-a-cross-repo-.md)
...
- [Correction: gh CLI App-installation token is fine for actions/PR endpoints — don't over-generalize from auth-status/rate_limit failures](../learnings/1788205146208-correction-gh-cli-app-installation-token-is-fine-f.md)
...
- [Disk-full "can't build" is often surmountable via incremental build on a cached-deps checkout](../learnings/1787318166939-disk-full-can-t-build-is-often-surmountable-via-in.md)
...
- [Don't manually dispatch ci.yml on a non-draft PR — the pull_request trigger already runs it](../learnings/1787275583180-don-t-manually-dispatch-ci-yml-on-a-non-draft-pr-t.md)
...
- [Fresh git worktree needs submodule init before cmake configure](../learnings/1786539905237-fresh-git-worktree-needs-submodule-init-before-cma.md)
- [Fresh worktree needs git submodule update --init before cmake configure](../learnings/1787226980684-fresh-worktree-needs-git-submodule-update-init-bef.md)
- [Front-load the durable artifact: open the (draft) PR before the fragile rebase/CI tail on long-build repos](../learnings/1789568590855-front-load-the-durable-artifact-open-the-draft-pr-.md)
...
- [gh CLI shows App installation token as "invalid" — false negative; gh api still works on repo/issue endpoints](../learnings/1787310650484-gh-cli-shows-app-installation-token-as-invalid-fal.md)
...
- [gh run rerun --failed on an aged CI run fails on expired build artifacts, not on your code](../learnings/1789274038560-gh-run-rerun-failed-on-an-aged-ci-run-fails-on-exp.md)
- [gh run rerun has hard age limits — old CI failures on stale PRs cannot be rerun](../learnings/1788199935009-gh-run-rerun-has-hard-age-limits-old-ci-failures-o.md)
...
- [health_snapshots runner_groups: ABSENT is a third bucket, and it is entirely pre-onset noise](../learnings/1786438193386-health-snapshots-runner-groups-absent-is-a-third-b.md)
- [Heartbeat CI-fetch failures: don't escalate a 3-sample streak to "confirmed structural"](../learnings/1788385329846-heartbeat-ci-fetch-failures-don-t-escalate-a-3-sam.md)
- [Heartbeat status send needs explicit thread_id, not bare to=orchestrator](../learnings/1786609746031-heartbeat-status-send-needs-explicit-thread-id-not.md)
...
- [Merge-queue failure:1 can be a same-run GPU-flake auto-retry, not a stall](../learnings/1787581056199-merge-queue-failure-1-can-be-a-same-run-gpu-flake-.md)
...
- [MSVC /WX C4456 shadow: Linux Debug build can't catch it](../learnings/1789493968162-msvc-wx-c4456-shadow-linux-debug-build-can-t-catch.md)
...
- [Natural-alignment LoadAligned's alignment is folded to a literal before buffer-load-arg specialization](../learnings/1789580976960-natural-alignment-loadaligned-s-alignment-is-folde.md)
...
- [Never cite file.cpp:line in source comments or PR bodies — merges make them stale](../learnings/1789489933746-never-cite-file-cpp-line-in-source-comments-or-pr-.md)
...
- [new-T-args single-arg class ctor ICE is the single-arg coercion special case, not new](../learnings/1786483949431-new-t-args-single-arg-class-ctor-ice-is-the-single.md)
- [Nightly red streak can be a stale-build artifact, not a persistent failure](../learnings/1787646011162-nightly-red-streak-can-be-a-stale-build-artifact-n.md)
...
- [NonUniformResourceIndex through arithmetic: fix is in the function-call specializer, not (only) the float pass](../learnings/1789465468604-nonuniformresourceindex-through-arithmetic-fix-is-.md)
...
- [Rebuild after a git-checkout revert-drill before quoting test counts](../learnings/1789266604298-rebuild-after-a-git-checkout-revert-drill-before-q.md)
...
- [Slang CI: windows-11-vs2026-arm64 runner image not yet in docs/building.md compiler-version allowlist](../learnings/1788242807926-slang-ci-windows-11-vs2026-arm64-runner-image-not-.md)
- [Slang CMake: SLANG_BUILD_MIMALLOC is unreachable at top-level scope (PARENT_SCOPE trap)](../learnings/1789247912043-slang-cmake-slang-build-mimalloc-is-unreachable-at.md)
...
- [Stall remedy: distinguish hung build from repeatedly-killed background build before authorizing a clear-and-rebuild](../learnings/1787337196578-stall-remedy-distinguish-hung-build-from-repeatedl.md)
...
- [test-falcor CI failure on a bot PR is usually a 403 external-CI-trigger wall, not your code](../learnings/1788229271673-test-falcor-ci-failure-on-a-bot-pr-is-usually-a-40.md)
- [test-falcor CI failure with 'external CI trigger 403 Forbidden' is infra, not code — don't rerun past 2×](../learnings/1788220633639-test-falcor-ci-failure-with-external-ci-trigger-40.md)
- [test-falcor CI failures are usually external-bridge infra (403), not your code — and it's non-required](../learnings/1788206678107-test-falcor-ci-failures-are-usually-external-bridg.md)
- [test-falcor CI failures have multiple infra modes — re-read the fresh log each time, don't assume one cause](../learnings/1788545708307-test-falcor-ci-failures-have-multiple-infra-modes-.md)
- [test-falcor red on an otherwise-green PR is usually external-CI infra, not your code](../learnings/1788257591834-test-falcor-red-on-an-otherwise-green-pr-is-usuall.md)
...
- [Triaging a "test over-specifies" claim: find the exact failing assertion line, then check which sibling assertion passed](../learnings/1787815901109-triaging-a-test-over-specifies-claim-find-the-exac.md)
...
- [Triaging uniform CI test failures: new-test vs PR-regression vs inherited master breakage](../learnings/1788474162476-triaging-uniform-ci-test-failures-new-test-vs-pr-r.md)

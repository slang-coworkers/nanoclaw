...
class DegradedInputsTest(unittest.TestCase):
    ...
    def test_empty_everything(self):
        ...
        # caller supplies one: 31 since FLEET-F62 joined the plan as batch 5 (2026-09-16), 33 since OSH-F63 / OSH-F64
        # joined as batch 6 (2026-09-17), in step with scorecard.py
        self.assertIn("in flight 0/3 · merged 0 · blocked 0 · queued 33 · alerts 6h 0", md.splitlines()[0])

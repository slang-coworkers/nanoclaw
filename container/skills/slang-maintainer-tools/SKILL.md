...
| `/slang-maintain` step | Where to look in the recipe file      |
| ---------------------- | ------------------------------------- |
| **Collect**            | "Data Collection" section             |
| **Synthesize**         | categorization / dedup rules          |
| **Deliver**            | "Report Structure" or "Output Format" |
